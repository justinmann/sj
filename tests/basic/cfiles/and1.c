...
const char* sjg_string1 = "should not get here";
const char* sjg_string2 = "should get here";
const char* sjg_string3 = "end";
...
#line 9
    ...
    if (false) {
        ...
        sjf_func(&sjt_capture3);
#line 6 "and1.sj"
        sjt_capture1 = sjt_capture3;
    } else {
#line 6 "and1.sj"
        sjt_capture1 = false;
    }
