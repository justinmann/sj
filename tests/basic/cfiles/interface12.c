...
void sjf_foo_getclasstype(sjs_object* _this, int* _return);
...
int main(int argc, char** argv) {
    ...
    sjs_foo_bar_vtbl.getclasstype = (void(*)(sjs_object*,int*))sjf_foo_getclasstype;
...
#line 9
    g_a = (sjs_foo*)malloc(sizeof(sjs_foo));
#line 9
    g_a->_refCount = 1;
#line 9
    sjf_foo_heap(g_a);
#line 11 "interface12.sj"
    sjt_cast2 = g_a;
#line 2
    sjf_foo_as_sji_bar(sjt_cast2, &g_b);
    if (g_b._parent != 0) {
