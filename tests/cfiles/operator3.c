...
sji_foo sjt_functionParam5 = { 0 };
int32_t sjt_functionParam6;
sji_foo sjt_functionParam7 = { 0 };
...
#line 10 "operator3.sj"
    sjt_parent4 = y;
#line 11
    sjt_parent4._vtbl->getx(sjt_parent4._parent, &sjt_capture3);
#line 11
    (*_return) = x + sjt_capture3;
}
...
#line 14
    sjt_cast2 = &sjt_call1;
#line 1
    sjf_class_as_sji_foo(sjt_cast2, &sjt_functionParam5);
#line 1
    sjf_i32_add_hash_foo(sjt_functionParam4, sjt_functionParam5, &g_a);
#line 15
...
#line 15
    sjt_cast3 = &sjt_call2;
#line 1
    sjf_class_as_sji_foo(sjt_cast3, &sjt_functionParam7);
#line 1
    sjf_i32_add_hash_foo(sjt_functionParam6, sjt_functionParam7, &g_b);
    main_destroy();
    return 0;
}
