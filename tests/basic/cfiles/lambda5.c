...
#define cb_i32_i32_typeId 29
#define cb_i32_i32_heap_typeId 29
#define sjs_lambda2_typeId 30
...
void sjf_lambda2_invoke(sjs_lambda2* _parent, int32_t _1, int32_t* _return);
...
void sjf_do(void) {
    int32_t a;
    int32_t c;
    sjs_lambda2 sjt_call1 = { -1 };
    sjs_string sjt_call2 = { -1 };
    int32_t sjt_functionParam5;
    cb_i32_i32 sjt_functionParam6;
...
#line 10
    sjf_lambda2(&sjt_call1);
#line 10
    lambainit1 = &sjt_call1;
#line 10
    sjt_functionParam6._parent = (sjs_object*)lambainit1;
#line 10
    sjt_functionParam6._cb = (void(*)(sjs_object*,int32_t, int32_t*))sjf_lambda2_invoke;
#line 10
    sjf_func(sjt_functionParam5, sjt_functionParam6, &a);
#line 11
...
#line 11
    ...
    if (sjt_call1._refCount == 1) { sjf_lambda2_destroy(&sjt_call1); }
;
...
#line 4 "lambda5.sj"
    sjt_functionParam4 = start;
#line 4
    cb._cb(cb._parent, sjt_functionParam4, _return);
}
