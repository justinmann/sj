...
#line 15
    sjt_parent1._vtbl->test(sjt_parent1._parent, sjt_interfaceParam1, &g_b);
#line 3
    sjt_parent2 = g_a;
#line 16
    sjt_interfaceParam2 = 1;
#line 16
    sjt_parent2._vtbl->test_heap(sjt_parent2._parent, sjt_interfaceParam2, &g_c);
    main_destroy();
    return 0;
}
