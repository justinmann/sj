...
int32_t result1;
bool sjt_functionParam1;
bool sjt_functionParam2;
bool sjt_functionParam3;
...
void sjf_func(bool v, sjs_class* _return);
void sjf_func_heap(bool v, sjs_class** _return);
...
#line 6 "heap20.sj"
        sjf_class_copy(&sjt_value2, &c);
#line 6
        sjs_class* copyoption14 = &sjt_value2;
        if (copyoption14 != 0) {
            _return->_refCount = 1;
#line 6 "heap20.sj"
            sjf_class_copy(_return, copyoption14);
        } else {
            _return->_refCount = -1;
        }
    } else {
...
#line 12 "heap20.sj"
    sjt_functionParam1 = true;
#line 12
    sjf_func(sjt_functionParam1, &g_a);
#line 13
    sjt_functionParam2 = false;
#line 13
    sjf_func(sjt_functionParam2, &g_b);
#line 14
    sjt_functionParam3 = true;
#line 14
    sjf_func_heap(sjt_functionParam3, &g_c);
#line 15
    sjt_functionParam4 = false;
#line 15
    sjf_func_heap(sjt_functionParam4, &g_d);
    main_destroy();
    return 0;
}
