...
#line 10
    sjf_test_getat(sjt_parent1, sjt_functionParam1, &sjt_call1);
    if ((sjt_call1._refCount != -1 ? &sjt_call1 : 0) != 0) {
        int32_t sjt_functionParam2;
        int32_t sjt_functionParam3;
        sjs_test* sjt_parent2 = 0;
...
#line 10
        sjf_test_getat(sjt_parent3, sjt_functionParam2, &sjt_call2);
#line 10
        sjt_parent2 = (sjt_call2._refCount != -1 ? &sjt_call2 : 0);
#line 10
        sjt_functionParam3 = 1;
#line 10
        sjf_test_getat(sjt_parent2, sjt_functionParam3, &g_a);
    } else {
#line 10 "option6.sj"
        g_a._refCount = -1;
    }
...
#line 11
    sjf_test_getat(sjt_parent4, sjt_functionParam4, &sjt_call3);
...
#line 11
        sjf_test_getat(sjt_parent6, sjt_functionParam5, &sjt_call4);
#line 11
        sjt_parent5 = (sjt_call4._refCount != -1 ? &sjt_call4 : 0);
#line 11
        sjt_functionParam6 = 1;
#line 11
        sjf_test_getat(sjt_parent5, sjt_functionParam6, &g_b);
    } else {
#line 11 "option6.sj"
        g_b._refCount = -1;
    }
