...
#define sjs_class_i32_typeId 23
#define sji_bar_typeId 25
#define sji_foo_i32_typeId 24
...
#line 21 "interface5.sj"
    sjt_cast2 = &sjt_call1;
#line 2
    sjf_class_i32_as_sji_foo_i32(sjt_cast2, &sjv_a);
#line 3
    sjt_parent1 = sjv_a;
#line 22
...
#line 23
    sjt_cast3 = sjv_a;
#line 7
    sjt_cast3._vtbl->asinterface(sjt_cast3._parent, sji_bar_typeId, (sjs_interface*)&sjv_b);
    if (sjv_b._parent != 0) {
...
#line 8 "interface5.sj"
        sjt_parent2 = sjv_b;
#line 24
        sjt_parent2._vtbl->test2(sjt_parent2._parent, &sjt_value2);
    } else {
    }
    main_destroy();
    return 0;
