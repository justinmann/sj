...
#define sjs_consolewriter2_typeId 28
#define sji_writer2_typeId 29

typedef struct td_sjs_hash_type_bool sjs_hash_type_bool;
typedef struct td_sjs_log sjs_log;
typedef struct td_sjs_array_char sjs_array_char;
typedef struct td_sjs_string sjs_string;
typedef struct td_sjs_consolewriter2 sjs_consolewriter2;
typedef struct td_sji_writer2_vtbl sji_writer2_vtbl;
typedef struct td_sji_writer2 sji_writer2;
...
struct td_sjs_consolewriter2 {
    int _refCount;
};

struct td_sji_writer2_vtbl {
...
struct td_sji_writer2 {
    sjs_object* _parent;
    sji_writer2_vtbl* _vtbl;
};

sji_writer2_vtbl sjs_consolewriter2_writer2_vtbl;
...
int32_t result1;
sjs_consolewriter2 sjt_call1 = { -1 };
sjs_string sjt_call2 = { -1 };
sjs_consolewriter2* sjt_cast2 = 0;
sjs_string* sjt_interfaceParam1 = 0;
sji_writer2 sjt_parent4 = { 0 };
...
void sjf_consolewriter2(sjs_consolewriter2* _this);
void sjf_consolewriter2_as_sji_writer2(sjs_consolewriter2* _this, sji_writer2* _return);
void sjf_consolewriter2_asinterface(sjs_consolewriter2* _this, int typeId, sjs_interface* _return);
void sjf_consolewriter2_copy(sjs_consolewriter2* _this, sjs_consolewriter2* _from);
void sjf_consolewriter2_destroy(sjs_consolewriter2* _this);
void sjf_consolewriter2_getclasstype(sjs_object* _this, int* _return);
void sjf_consolewriter2_heap(sjs_consolewriter2* _this);
void sjf_consolewriter2_write(sjs_consolewriter2* _parent, sjs_string* s);
...
void sjf_consolewriter2_as_sji_writer2(sjs_consolewriter2* _this, sji_writer2* _return) {
    ...
    _return->_vtbl = &sjs_consolewriter2_writer2_vtbl;
}

void sjf_consolewriter2_asinterface(sjs_consolewriter2* _this, int typeId, sjs_interface* _return) {
    switch (typeId) {
        case sji_writer2_typeId:  {
            sjf_consolewriter2_as_sji_writer2(_this, (sji_writer2*)_return);
            break;
        }
...
int main(int argc, char** argv) {
    sjs_consolewriter2_writer2_vtbl.destroy = (void(*)(void*))sjf_consolewriter2_destroy;
    sjs_consolewriter2_writer2_vtbl.asinterface = (void(*)(sjs_object*,int,sjs_interface*))sjf_consolewriter2_asinterface;
    sjs_consolewriter2_writer2_vtbl.getclasstype = (void(*)(sjs_object*,int*))sjf_consolewriter2_getclasstype;
    sjs_consolewriter2_writer2_vtbl.write = (void(*)(sjs_object*,sjs_string*))sjf_consolewriter2_write;
...
#line 9
    sjf_consolewriter2(&sjt_call1);
#line 12 "package3.sj"
    sjt_cast2 = &sjt_call1;
#line 1
    sjf_consolewriter2_as_sji_writer2(sjt_cast2, &g_c);
#line 2
    sjt_parent4 = g_c;
#line 2
...
#line 13
    sjt_parent4._vtbl->write(sjt_parent4._parent, sjt_interfaceParam1);
    main_destroy();
    return 0;
}
...
;
    if (sjt_call1._refCount == 1) { sjf_consolewriter2_destroy(&sjt_call1); }
;
