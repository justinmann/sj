...
struct td_sjs_namespace1_class_heap {
    intptr_t _refCount;
};
...
struct td_sjs_namespace2_class_heap {
    intptr_t _refCount;
};
...
sjs_namespace1_class_heap* sjt_cast1;
sjs_namespace2_class_heap* sjt_cast2;
...
void sjf_namespace1_class_heap(sjs_namespace1_class_heap* _this);
sjs_object* sjf_namespace1_class_heap_asInterface(sjs_namespace1_class_heap* _this, int typeId);
sji_namespace1_foo* sjf_namespace1_class_heap_as_sji_namespace1_foo(sjs_namespace1_class_heap* _this);
...
void sjf_namespace2_class_heap(sjs_namespace2_class_heap* _this);
sjs_object* sjf_namespace2_class_heap_asInterface(sjs_namespace2_class_heap* _this, int typeId);
sji_namespace2_foo* sjf_namespace2_class_heap_as_sji_namespace2_foo(sjs_namespace2_class_heap* _this);
...
int main(int argc, char** argv) {
    sjt_cast1 = (sjs_namespace1_class_heap*)malloc(sizeof(sjs_namespace1_class_heap));
    sjt_cast1->_refCount = 1;
    sjf_namespace1_class_heap(sjt_cast1);
#line 2 "interface1.sj"
    sjv_a = (sji_namespace1_foo*)sjf_namespace1_class_heap_as_sji_namespace1_foo(sjt_cast1);
#line 2
    sjt_cast2 = (sjs_namespace2_class_heap*)malloc(sizeof(sjs_namespace2_class_heap));
#line 2
...
void main_destroy() {
    ...
    if (sjt_cast1->_refCount <= 0) {
        sjf_namespace1_class_destroy((sjs_namespace1_class*)(((char*)sjt_cast1) + sizeof(intptr_t)));
    }
    sjt_cast2->_refCount--;
    if (sjt_cast2->_refCount <= 0) {
        sjf_namespace2_class_destroy((sjs_namespace2_class*)(((char*)sjt_cast2) + sizeof(intptr_t)));
    }
    sjv_a->_refCount--;
