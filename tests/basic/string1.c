...
void sjf_global(sjs_global* _this, bool* _return);
...
void sjf_global(sjs_global* _this, bool* _return) {
    ...
    sjf_anon3(sjv_temp1, &result2);
    random = result2;
    random->_refCount++;
    sjv_temp2 = &sjd_temp2;
    sjv_temp2->_refCount = 1;
    sjf_anon2(sjv_temp2, &result3);
    parse = result3;
    parse->_refCount++;
    result5 = (uintptr_t)0;
    sjv_temp3 = &sjd_temp3;
    ...
    sjf_array_char(sjv_temp8, &result11);
    sjv_temp9 = &sjd_temp6;
    sjv_temp9->_refCount = 1;
    sjv_temp9->count = 4;
    sjv_temp9->data = result11;
    sjv_temp9->data->_refCount++;
    sjf_string(sjv_temp9, &result10);
    f = result10;
    f->_refCount++;
    sjf_string_getAt(a, 0, &result12);
    h = result12;
    result14 = h == 'h';
    i = result14;
    sjf_string_isEqual(f, a, &result15);
    j = result15;
    sjf_string_isLessOrEqual(f, a, &result17);
    k = result17;
    result19 = f == a;
    l = result19;
...
void sjf_string_getAt(sjs_string* _parent, int32_t index, char* _return) {
    ...
    temp1 = _parent->data;
    sjf_array_char_getAt(temp1, index, &result13);
...
void sjf_string_isEqual(sjs_string* _parent, sjs_string* test, bool* _return) {
    ...
    temp2 = _parent->data;
    temp3 = test->data;
    sjf_array_char_isEqual(temp2, temp3, &result16);
...
void sjf_string_isLessOrEqual(sjs_string* _parent, sjs_string* test, bool* _return) {
    ...
    temp4 = _parent->data;
    temp5 = test->data;
    sjf_array_char_isLessOrEqual(temp4, temp5, &result18);
