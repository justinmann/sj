...
sjs_array sjg_string1 = { 1, 3, 3, "foo"};
sjs_array sjg_string2 = { 1, 3, 3, "bob"};
sjs_array sjg_string3 = { 1, 9, 9, "not found"};
...
#define sjs_hash_string_heap_iface_interface_typeId 27
#define sjs_class_typeId 34
...
#line 2
    sjf_hash_string_heap_iface_interface_setat(sjt_parent3, sjt_functionParam4, sjt_functionParam5);
...
#line 12
    sjf_hash_string_heap_iface_interface_getat_heap(sjt_parent4, sjt_functionParam6, &g_b);
    if (g_b._parent != 0) {
...
#line 3 "hash3.sj"
        sjt_parent5 = g_b;
#line 13
        sjt_parent5._vtbl->bob(sjt_parent5._parent, &sjt_call4);
#line 13
...
#line 3 "hash3.sj"
            sjt_parent6 = g_b;
#line 13
            sjt_parent6._vtbl->bob(sjt_parent6._parent, &sjt_call5);
#line 13
