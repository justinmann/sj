...
#line 2 "option2.sj"
            sjt_capture4 = (g_c._refCount != -1 ? &g_c : 0);
#line 8
...
#line 10
    sjt_functionParam4 = (g_c._refCount != -1 ? &g_c : 0);
#line 10
    sjf_func(sjt_functionParam4, &sjt_void1);
    main_destroy();
    return 0;
}
