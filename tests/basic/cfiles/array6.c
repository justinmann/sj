...
#line 107
        ...
        if (sjt_capture1) {
#line 109 "lib/common/array.sj"
            float* p = (float*)newdata;
#line 110
            #line 108 "lib/common/array.sj"
p[newcount] = item;
;
#line 112
            newcount = newcount + 1;
