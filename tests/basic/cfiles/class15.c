...
#line 13
        sjf_math_sub(sjt_parent4, sjt_functionParam6, sjt_functionParam7, &sjt_functionParam5);
#line 13
...
#line 24
    sjf_class_foo(sjt_parent5, sjt_functionParam8, &sjt_void1);
    main_destroy();
    return 0;
}
