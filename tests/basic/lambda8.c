...
#define cb_i32_typeId 19
#define cb_i32_heap_typeId 19
#define sjs_lambda1_typeId 20
#define sjs_lambda2_typeId 22
...
void sjf_do(void) {
    ...
    sjt_functionParam7 = (&sjv_c)->x;
    sjt_functionParam8 = 10;
    sjf_i32_asstring(sjt_functionParam7, sjt_functionParam8, &sjt_call4);
...
void sjf_string_nullterminate(sjs_string* _parent) {
    ...
    if (result2 || result3) {
        ...
        if ((_parent->count + 1) > (&_parent->data)->datasize) {
            ...
            sjf_array_char_grow(sjt_parent1, sjt_functionParam3, &sjt_call3);
