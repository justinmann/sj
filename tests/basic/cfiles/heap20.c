...
#line 13
    sjf_func(sjt_functionParam5, &g_b);
#line 14
    sjt_functionParam6 = true;
#line 14
    sjf_func_heap(sjt_functionParam6, &g_c);
#line 15
    sjt_functionParam7 = false;
#line 15
    sjf_func_heap(sjt_functionParam7, &g_d);
    main_destroy();
    return 0;
}
