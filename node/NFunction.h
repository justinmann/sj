...
public:
    ...
    void dumpBody(Compiler* compiler, CResult& result, shared_ptr<CThisVar> thisVar, CTypeMode returnTypeMode, map<shared_ptr<CBaseFunction>, string>& functions, stringstream& ss, int level);
