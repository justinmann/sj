...
public:
    ...
    pair<shared_ptr<CVar>, shared_ptr<CVar>> getReturnVars(Compiler* compiler, CResult& result, CTypeReturnMode returnMode);
    void getVarBody(Compiler *compiler, CResult& result, shared_ptr<CVar> thisVar, CTypeReturnMode returnMode);
    void transpileDefinition(Compiler* compiler, CResult& result, TrOutput* trOutput, CTypeReturnMode returnMode);
