...
void sjf_lambda3_invoke(sjs_lambda3* _parent, int32_t* _return);
...
#line 10
    sjt_functionParam4._parent = (sjs_object*)lambainit1;
#line 10
    sjt_functionParam4._cb = (void(*)(sjs_object*, int32_t*))sjf_lambda2_invoke;
#line 10
...
void sjf_lambda2_invoke(sjs_lambda2* _parent, int32_t* _return) {
    sjs_lambda3 sjt_call2 = { -1 };
    cb_i32 sjt_functionParam5;
...
#line 12
    sjf_lambda3(&sjt_call2);
#line 12
    lambainit2 = &sjt_call2;
#line 12
    sjt_functionParam5._parent = (sjs_object*)lambainit2;
#line 12
    sjt_functionParam5._cb = (void(*)(sjs_object*, int32_t*))sjf_lambda3_invoke;
#line 12
    sjf_func(sjt_functionParam5, _return);

    if (sjt_call2._refCount == 1) { sjf_lambda3_destroy(&sjt_call2); }
;
}
