...
#line 14
    sjt_cast2 = &sjt_call1;
#line 1
    sjf_class_as_sji_foo(sjt_cast2, &sjt_functionParam2);
#line 1
    sjf_i32_add_hash_foo(sjt_functionParam1, sjt_functionParam2, &g_a);
#line 15
...
#line 15
    sjt_cast3 = &sjt_call2;
#line 1
    sjf_class_as_sji_foo(sjt_cast3, &sjt_functionParam4);
#line 1
    sjf_i32_add_hash_foo(sjt_functionParam3, sjt_functionParam4, &g_b);
    main_destroy();
    return 0;
}
