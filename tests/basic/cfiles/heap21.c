...
void sjf_func_string(bool a, sjs_string* _return);
void sjf_func_string_heap(bool a, sjs_string** _return);
...
#line 3
    s.data._refCount = 1;
#line 3
    s.data.v = &sjg_string1;
#line 3
    sjf_array_char(&s.data);
#line 16 "lib/sj-lib-common/string.sj"
    s._isnullterminated = false;
#line 16
    sjf_string(&s);
    if (a) {
        sjt_value2._refCount = 1;
#line 5 "heap21.sj"
        sjf_string_copy(&sjt_value2, &s);
#line 5
...
#line 7 "heap21.sj"
    ...
    if (s._refCount == 1) { sjf_string_destroy(&s); }
;
...
#line 16
    ...
    if (a) {
        ...
        sjt_value3 = (sjs_string*)malloc(sizeof(sjs_string));
        sjt_value3->_refCount = 1;
#line 5 "heap21.sj"
        sjf_string_copy(sjt_value3, (&s));
#line 5
        (*_return) = sjt_value3;
        if ((*_return) != 0) {
            (*_return)->_refCount++;
...
#line 11 "heap21.sj"
    sjt_functionParam4 = true;
#line 11
    sjf_func_string_heap(sjt_functionParam4, &g_a);
#line 12
    sjt_functionParam5 = false;
#line 12
    sjf_func_string_heap(sjt_functionParam5, &g_b);
    main_destroy();
    return 0;
}
