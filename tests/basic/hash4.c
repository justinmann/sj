...
#define sji_interface_typeId 16
#define sjs_hash_heap_iface_interface_i32_typeId 17
#define sjs_class_typeId 22
#define cb_heap_iface_interface_i32_void_typeId 27
#define cb_heap_iface_interface_i32_void_heap_typeId 27
#define cb_local_iface_interface_i32_void_typeId 39
#define cb_local_iface_interface_i32_void_heap_typeId 39
...
void sjf_print(sji_interface k, int32_t v) {
    ...
    sjf_i32_asstring(sjt_functionParam18, sjt_functionParam19, &sjt_call6);
    sjt_parent16 = &sjt_call6;
    ...
    sjf_string_add(sjt_parent16, sjt_functionParam20, &sjt_call5);
    sjt_parent15 = &sjt_call5;
    sjt_functionParam22 = v;
    sjt_functionParam23 = 10;
    sjf_i32_asstring(sjt_functionParam22, sjt_functionParam23, &sjt_call8);
    sjt_functionParam21 = &sjt_call8;
    sjf_string_add(sjt_parent15, sjt_functionParam21, &sjt_call4);
...
void sjf_string_nullterminate(sjs_string* _parent) {
    ...
    if (result2 || result3) {
        ...
        if ((_parent->count + 1) > (&_parent->data)->datasize) {
            ...
            sjf_array_char_grow(sjt_parent5, sjt_functionParam5, &sjt_call3);
            if (_parent->data._refCount == 1) { sjf_array_char_destroy(&_parent->data); }
;
            _parent->data._refCount = 1;
            sjf_array_char_copy(&_parent->data, (&sjt_call3));
        }
    ...
    if (sjt_call3._refCount == 1) { sjf_array_char_destroy(&sjt_call3); }
;
}
...
int main(int argc, char** argv) {
    ...
    sjf_i32_asstring(sjt_functionParam25, sjt_functionParam26, &sjt_call9);
    sjt_functionParam24 = &sjt_call9;
