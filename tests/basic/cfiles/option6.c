...
int32_t result1;
sjs_test sjt_call1 = { -1 };
sjs_test sjt_call2 = { -1 };
sjs_test sjt_call3 = { -1 };
sjs_test sjt_call4 = { -1 };
int32_t sjt_functionParam4;
int32_t sjt_functionParam7;
sjs_test* sjt_parent3 = 0;
sjs_test* sjt_parent6 = 0;
...
void sjf_test_getat(sjs_test* _parent, int32_t x, sjs_test* _return);
void sjf_test_getat_heap(sjs_test* _parent, int32_t x, sjs_test** _return);
...
#line 4
    sjf_test(&sjt_value2);
#line 5
    sjs_test* copyoption14 = &sjt_value2;
    if (copyoption14 != 0) {
        _return->_refCount = 1;
#line 5 "option6.sj"
        sjf_test_copy(_return, copyoption14);
    } else {
        _return->_refCount = -1;
    }

    if (sjt_value2._refCount == 1) { sjf_test_destroy(&sjt_value2); }
;
}

void sjf_test_getat_heap(sjs_test* _parent, int32_t x, sjs_test** _return) {
    sjs_test* sjt_value3 = 0;

    sjt_value3 = (sjs_test*)malloc(sizeof(sjs_test));
    sjt_value3->_refCount = 1;
#line 4 "option6.sj"
    sjt_value3->x = x;
#line 4
    sjf_test_heap(sjt_value3);
#line 5
    (*_return) = sjt_value3;
    if ((*_return) != 0) {
        (*_return)->_refCount++;
...
#line 10
    sjf_test_getat(sjt_parent3, sjt_functionParam4, &sjt_call1);
    if ((sjt_call1._refCount != -1 ? &sjt_call1 : 0) != 0) {
        int32_t sjt_functionParam5;
        int32_t sjt_functionParam6;
        sjs_test* sjt_parent4 = 0;
        sjs_test* sjt_parent5 = 0;
...
#line 10
        sjf_test_getat(sjt_parent5, sjt_functionParam5, &sjt_call2);
#line 10
        sjt_parent4 = (sjt_call2._refCount != -1 ? &sjt_call2 : 0);
#line 10
        sjt_functionParam6 = 1;
#line 10
        sjf_test_getat(sjt_parent4, sjt_functionParam6, &g_a);
    } else {
#line 10 "option6.sj"
        g_a._refCount = -1;
    }
...
#line 11
    sjf_test_getat(sjt_parent6, sjt_functionParam7, &sjt_call3);
    if ((sjt_call3._refCount != -1 ? &sjt_call3 : 0) != 0) {
        int32_t sjt_functionParam8;
        int32_t sjt_functionParam9;
        sjs_test* sjt_parent7 = 0;
        sjs_test* sjt_parent8 = 0;
...
#line 11
        sjf_test_getat(sjt_parent8, sjt_functionParam8, &sjt_call4);
#line 11
        sjt_parent7 = (sjt_call4._refCount != -1 ? &sjt_call4 : 0);
#line 11
        sjt_functionParam9 = 1;
#line 11
        sjf_test_getat(sjt_parent7, sjt_functionParam9, &g_b);
    } else {
#line 11 "option6.sj"
        g_b._refCount = -1;
    }
...
void main_destroy() {
    ...
    if (g_a._refCount == 1) { sjf_test_destroy(&g_a); }
;
    if (g_b._refCount == 1) { sjf_test_destroy(&g_b); }
;
...
;
    if (g_t._refCount == 1) { sjf_test_destroy(&g_t); }
;
    if (sjt_call1._refCount == 1) { sjf_test_destroy(&sjt_call1); }
;
    if (sjt_call2._refCount == 1) { sjf_test_destroy(&sjt_call2); }
;
    if (sjt_call3._refCount == 1) { sjf_test_destroy(&sjt_call3); }
;
    if (sjt_call4._refCount == 1) { sjf_test_destroy(&sjt_call4); }
;
