...
#line 10
    sjt_functionParam4._destroy = (void(*)(sjs_object*))sjf_lambda1_destroy;
#line 10
    sjt_functionParam4.inner._cb = (void(*)(sjs_object*, int32_t*))sjf_lambda1_invoke;
#line 10
