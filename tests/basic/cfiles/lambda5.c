...
#define cb_i32_i32_typeId 23
#define cb_i32_i32_heap_typeId 23
...
typedef struct td_cb_i32_i32 cb_i32_i32;
typedef struct td_cb_i32_i32_heap cb_i32_i32_heap;
...
struct td_cb_i32_i32 {
    sjs_object* _parent;
    void (*_cb)(sjs_object* _parent, int32_t, int32_t* _return);
};

struct td_cb_i32_i32_heap {
    cb_i32_i32 inner;
...
void sjf_do(void);
void sjf_func(int32_t start, cb_i32_i32 cb, int32_t* _return);
...
void sjf_lambda1_invoke(sjs_lambda1* _parent, int32_t _1, int32_t* _return);
...
#line 10
    sjt_functionParam3._parent = (sjs_object*)lambainit1;
#line 10
    sjt_functionParam3._cb = (void(*)(sjs_object*,int32_t, int32_t*))sjf_lambda1_invoke;
#line 10
    sjf_func(sjt_functionParam2, sjt_functionParam3, &a);
#line 11
    sjt_functionParam8 = c;
...
#line 4 "lambda5.sj"
    sjt_functionParam1 = start;
#line 4
    cb._cb(cb._parent, sjt_functionParam1, _return);
}
...
void sjf_lambda1_invoke(sjs_lambda1* _parent, int32_t _1, int32_t* _return) {
#line 10 "lambda5.sj"
    *_parent->lambdaparam1 = *_parent->lambdaparam1 + _1;
#line 10
...
#line 75 "lib/sj-lib-common/string.sj"
            sjt_functionParam4 = _parent->count + 1;
#line 75
            sjf_array_char_grow(sjt_parent1, sjt_functionParam4, &sjt_funcold1);
#line 75
...
#line 77 "lib/sj-lib-common/string.sj"
        sjt_functionParam5 = _parent->count;
#line 77
        sjt_functionParam6 = '\0';
#line 77
        sjf_array_char_initat(sjt_parent2, sjt_functionParam5, sjt_functionParam6);
#line 78
