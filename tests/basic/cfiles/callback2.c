...
#define sjs_sum_typeId 26
#define sjs_class_i32_typeId 27
#define cb_i32_void_typeId 29
#define cb_i32_void_heap_typeId 29
...
cb_i32_void sjt_functionParam13;
cb_i32_void_heap sjt_functionParam6;
int32_t sjt_functionParam7;
int32_t sjt_functionParam8;
int32_t sjt_functionParam9;
sjs_class_i32* sjt_parent3 = 0;
...
#line 105
        sjf_array_i32_getat(_parent, sjt_functionParam12, &sjt_functionParam11);
#line 105
        cb._cb(cb._parent, sjt_functionParam11);
#line 105
        i++;
    }
}
...
#line 6 "callback2.sj"
    sjt_functionParam4 = _parent->item1;
#line 6
    cb.inner._cb(cb.inner._parent, sjt_functionParam4);
#line 7
    sjt_functionParam5 = _parent->item2;
#line 7
    cb.inner._cb(cb.inner._parent, sjt_functionParam5);
}
...
#line 5
    sjt_parent3 = &g_c;
#line 23
    sjt_functionParam6.inner._parent = (sjs_object*)g_s;
#line 23
    sjt_functionParam6.inner._parent->_refCount++;
#line 23
    sjt_functionParam6._destroy = (void(*)(sjs_object*))sjf_sum_destroy;
#line 23
    sjt_functionParam6.inner._cb = (void(*)(sjs_object*,int32_t))sjf_sum_invoke;
#line 23
    sjf_class_i32_each(sjt_parent3, sjt_functionParam6);
#line 23
    g_a._refCount = 1;
#line 25
    g_a.v = createarray(2 * sizeof(int32_t));
#line 25
    sjf_array_i32(&g_a);
#line 25
...
#line 25
    sjf_array_i32_initat(sjt_parent4, sjt_functionParam7, sjt_functionParam8);
#line 25
    sjt_parent5 = array1;
#line 25
...
#line 25
    sjf_array_i32_initat(sjt_parent5, sjt_functionParam9, sjt_functionParam10);
#line 104 "lib/sj-lib-common/array.sj"
    sjt_parent6 = &g_a;
#line 26 "callback2.sj"
    sjt_functionParam13._parent = (sjs_object*)g_s;
#line 26
    sjt_functionParam13._cb = (void(*)(sjs_object*,int32_t))sjf_sum_invoke;
#line 26
    sjf_array_i32_each(sjt_parent6, sjt_functionParam13);
    main_destroy();
    return 0;
}
...
void main_destroy() {
    ...
    if ((uintptr_t)sjt_functionParam6.inner._parent > 1) {
        sjt_functionParam6.inner._parent->_refCount--;
        if (sjt_functionParam6.inner._parent->_refCount <= 0) {
            sjt_functionParam6._destroy(sjt_functionParam6.inner._parent);
            free(sjt_functionParam6.inner._parent);
        }
    }
