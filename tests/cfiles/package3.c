...
#define sjs_consolewriter2_typeId 29
#define sji_writer2_typeId 30
...
#line 13
    sjt_parent5._vtbl->write(sjt_parent5._parent, sjt_interfaceParam1);
    main_destroy();
    return 0;
}
