...
#define cb_i32_typeId 29
#define cb_i32_heap_typeId 29
...
void sjf_do(void) {
    int32_t a;
    sjs_class c = { -1 };
    sjs_lambda2* sjt_call1 = 0;
    sjs_string sjt_call2 = { -1 };
    cb_i32_heap sjt_functionParam4;
...
#line 10
    sjt_call1 = (sjs_lambda2*)malloc(sizeof(sjs_lambda2));
#line 10
    sjt_call1->_refCount = 1;
#line 10
    sjt_call1->lambdaparam1._refCount = 1;
#line 10
    sjf_class_copy(&sjt_call1->lambdaparam1, &c);
#line 10
    sjf_lambda2_heap(sjt_call1);
#line 10
    lambainit1 = sjt_call1;
#line 10
    sjt_functionParam4.inner._parent = (sjs_object*)lambainit1;
#line 10
    sjt_functionParam4.inner._parent->_refCount++;
#line 10
    sjt_functionParam4._destroy = (void(*)(sjs_object*))sjf_lambda2_destroy;
#line 10
    sjt_functionParam4.inner._cb = (void(*)(sjs_object*, int32_t*))sjf_lambda2_invoke;
#line 10
    sjf_func(sjt_functionParam4, &a);
#line 11
    sjt_functionParam6 = (&c)->x;
...
#line 11
    ...
    if (sjt_call1->_refCount <= 0) {
        ...
        sjf_lambda2_destroy(sjt_call1);
        free(sjt_call1);
    }
    if ((uintptr_t)sjt_functionParam4.inner._parent > 1) {
        sjt_functionParam4.inner._parent->_refCount--;
        if (sjt_functionParam4.inner._parent->_refCount <= 0) {
            sjt_functionParam4._destroy(sjt_functionParam4.inner._parent);
            free(sjt_functionParam4.inner._parent);
        }
    }
