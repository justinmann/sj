...
#line 18 "callback3.sj"
    sjt_functionParam6.inner._parent = (sjs_object*)_parent;
#line 18
    sjt_functionParam6.inner._parent->_refCount++;
#line 18
    sjt_functionParam6._destroy = (void(*)(sjs_object*))sjf_class_destroy;
#line 18
    sjt_functionParam6.inner._cb = (void(*)(sjs_object*,int32_t))sjf_class_func;
#line 18
    sjf_domath(sjt_functionParam6);
#line 17
...
#line 17
    sjf_class_run(sjt_parent3, &sjt_void1);
    main_destroy();
    return 0;
}
