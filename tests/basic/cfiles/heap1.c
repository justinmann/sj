...
void sjf_func(sjs_class* _return) {
    sjs_class a = { -1 };
    sjs_class sjt_funcold2 = { -1 };

    a._refCount = 1;
    sjf_class(&a);
    sjt_funcold2._refCount = 1;
#line 1 "heap1.sj"
    sjf_class_copy(&sjt_funcold2, &a);
#line 1
    sjt_funcold2._refCount = 1;
#line 1
    sjf_class(&sjt_funcold2);
#line 1
    if (a._refCount == 1) { sjf_class_destroy(&a); }
;
#line 1
    sjf_class_copy(&a, &sjt_funcold2);
#line 1
    _return->_refCount = 1;
#line 3
    sjf_class_copy(_return, &a);

    if (a._refCount == 1) { sjf_class_destroy(&a); }
;
    if (sjt_funcold2._refCount == 1) { sjf_class_destroy(&sjt_funcold2); }
;
}

void sjf_func_heap(sjs_class** _return) {
    sjs_class a = { -1 };
    sjs_class sjt_funcold3 = { -1 };

    a._refCount = 1;
    sjf_class(&a);
    sjt_funcold3._refCount = 1;
#line 1 "heap1.sj"
    sjf_class_copy(&sjt_funcold3, &a);
#line 1
    sjt_funcold3._refCount = 1;
#line 1
    sjf_class(&sjt_funcold3);
#line 1
    if (a._refCount == 1) { sjf_class_destroy(&a); }
;
#line 1
    sjf_class_copy(&a, &sjt_funcold3);
#line 1
...
#line 3
    ...
    if (a._refCount == 1) { sjf_class_destroy(&a); }
;
    if (sjt_funcold3._refCount == 1) { sjf_class_destroy(&sjt_funcold3); }
;
}
