...
public:
    ...
    NCompare(CLoc loc, shared_ptr<NBase> leftSide, NCompareOp op, shared_ptr<NBase> rightSide) : NBase(NodeType_Compare, loc), op(op), leftSide(leftSide), rightSide(rightSide) { }
