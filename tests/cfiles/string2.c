...
#line 4
    sjf_string_add(sjt_parent22, sjt_functionParam26, _return);
...
#line 4
    sjf_string_add_heap(sjt_parent23, sjt_functionParam31, _return);
...
#line 27
                sjf_string_getat(sjt_parent9, sjt_functionParam8, &sjt_functionParam6);
#line 27
                sjf_array_char_initat(sjt_parent7, sjt_functionParam5, sjt_functionParam6);
#line 29
                newcount = newcount + 1;
#line 27
                i++;
...
#line 34
            sjf_array_char_clone(sjt_parent10, sjt_functionParam9, sjt_functionParam10, sjt_functionParam11, &newdata);
#line 29 "lib/sj-lib-common/array.sj"
...
#line 37
                sjf_string_getat(sjt_parent13, sjt_functionParam14, &sjt_functionParam13);
#line 37
                sjf_array_char_initat(sjt_parent12, sjt_functionParam12, sjt_functionParam13);
#line 39
                newcount = newcount + 1;
#line 37
                i++;
...
#line 27
                sjf_string_getat(sjt_parent17, sjt_functionParam17, &sjt_functionParam16);
#line 27
                sjf_array_char_initat(sjt_parent16, sjt_functionParam15, sjt_functionParam16);
#line 29
                newcount = newcount + 1;
#line 27
                i++;
...
#line 34
            sjf_array_char_clone(sjt_parent18, sjt_functionParam18, sjt_functionParam19, sjt_functionParam20, &newdata);
#line 29 "lib/sj-lib-common/array.sj"
...
#line 37
                sjf_string_getat(sjt_parent21, sjt_functionParam23, &sjt_functionParam22);
#line 37
                sjf_array_char_initat(sjt_parent20, sjt_functionParam21, sjt_functionParam22);
#line 39
                newcount = newcount + 1;
#line 37
                i++;
...
#line 64
    sjf_array_char_getat(sjt_parent8, sjt_functionParam7, _return);
}
