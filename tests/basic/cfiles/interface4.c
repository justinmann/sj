...
#line 9
    sjf_class(&sjt_call1);
#line 12 "interface4.sj"
    sjt_cast2 = &sjt_call1;
#line 2
    sjf_class_as_sji_foo_i32(sjt_cast2, &g_a);
#line 3
    sjt_parent3 = g_a;
#line 13
    sjt_parent3._vtbl->test(sjt_parent3._parent, &sjt_void1);
    main_destroy();
    return 0;
}
