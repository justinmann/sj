...
#define sjs_array_class_typeId 29
...
void sjf_array_create_class(int32_t size, sjs_class* item, sjs_array_class* _return);
void sjf_array_create_class_heap(int32_t size, sjs_class* item, sjs_array_class** _return);
...
#line 3 "lib/sj-lib-common/array.sj"
    v = 0;
#line 5
    sjs_array* arr = createarray(sizeof(sjs_class), size);
#line 6
    sjs_class* p = (sjs_class*)arr->data;
#line 7
...
#line 11
    v = arr;
#line 11
    (*_return) = (sjs_array_class*)malloc(sizeof(sjs_array_class));
#line 11
    (*_return)->_refCount = 1;
#line 13
    (*_return)->v = v;
#line 13
    sjf_array_class_heap((*_return));
}
...
#line 3
    sjf_array_create_class(sjt_functionParam4, sjt_functionParam5, &g_a);
#line 68 "lib/sj-lib-common/array.sj"
    sjt_parent4 = &g_a;
#line 4 "array4.sj"
...
#line 4
    sjf_array_class_setat(sjt_parent4, sjt_functionParam6, sjt_functionParam7);
#line 41 "lib/sj-lib-common/array.sj"
    sjt_parent5 = &g_a;
#line 5 "array4.sj"
    sjt_functionParam8 = 0;
#line 5
    sjf_array_class_getat(sjt_parent5, sjt_functionParam8, &g_b);
#line 6
    g_c = (&g_b)->x;
    main_destroy();
    return 0;
...
;
    if (g_b._refCount == 1) { sjf_class_destroy(&g_b); }
;
