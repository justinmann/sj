...
void sjf_lambda2_invoke(sjs_lambda2* _parent, int32_t _1);
...
#line 106
    g_intarray2.v = createarray(sizeof(int32_t), 3);
#line 106
...
#line 111
    g_objarray.v = createarray(sizeof(sjs_obj), 2);
#line 111
...
#line 216
    g_foolist.v = createarray(sizeof(int32_t), 9);
#line 216
...
;
    if (sjt_call92._refCount == 1) { sjf_lambda2_destroy(&sjt_call92); }
;
