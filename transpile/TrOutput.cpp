...
void TrOutput::writeToStream(ostream& stream, bool hasMainLoop) {
    ...
    stream << "};\n";
    stream << "const int32_option int32_empty = { false };\n";
    stream << "\n";
    ...
    stream << "};\n";
    stream << "const uint32_option uint32_empty = { false };\n";
    stream << "\n";
    ...
    stream << "};\n";
    stream << "const int64_option int64_empty = { false };\n";
    stream << "\n";
    ...
    stream << "};\n";
    stream << "const uint64_option uint64_empty = { false };\n";
    stream << "\n";
    ...
    stream << "    void* value;\n";
    stream << "};\n";
    stream << "const void_option void_empty = { false };\n";
    stream << "\n";
    ...
    stream << "    char value;\n";
    stream << "};\n";
    stream << "const char_option char_empty = { false };\n";
    stream << "\n";
    ...
    stream << "    float value;\n";
    stream << "};\n";
    stream << "const float_option float_empty = { false };\n";
    stream << "\n";
    ...
    stream << "    double value;\n";
    stream << "};\n";
    stream << "const double_option double_empty = { false };\n";
    stream << "\n";
