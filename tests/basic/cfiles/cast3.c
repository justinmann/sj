...
sjs_array sjg_string1 = { 1, 5, 5, "hello"};
...
#define sjs_array_i32_typeId 31
#define sjs_bob_typeId 38
#define sji_iface_typeId 35
...
sji_iface_vtbl sjs_bob_iface_vtbl;
...
sjs_array_i32 sjt_call5 = { -1 };
sjs_string sjt_call6 = { -1 };
sji_iface sjt_call7 = { 0 };
...
void sjf_bob_as_sji_iface(sjs_bob* _this, sji_iface* _return);
void sjf_bob_asinterface(sjs_bob* _this, int typeId, sjs_interface* _return);
void sjf_bob_copy(sjs_bob* _this, sjs_bob* _from);
void sjf_bob_destroy(sjs_bob* _this);
void sjf_bob_getclasstype(sjs_object* _this, int* _return);
void sjf_bob_getx(sjs_bob* _parent, int32_t* _return);
void sjf_bob_heap(sjs_bob* _this);
void sjf_class(sjs_class* _this);
void sjf_class_as_hash_iface_heap(sjs_class* _parent, sji_iface* _return);
void sjf_class_asarray_bang_i32(sjs_class* _parent, sjs_array_i32* _return);
void sjf_class_asarray_bang_i32_heap(sjs_class* _parent, sjs_array_i32** _return);
void sjf_class_asi32(sjs_class* _parent, int32_t* _return);
...
void sjf_bob_as_sji_iface(sjs_bob* _this, sji_iface* _return) {
    ...
    _return->_vtbl = &sjs_bob_iface_vtbl;
}

void sjf_bob_asinterface(sjs_bob* _this, int typeId, sjs_interface* _return) {
    switch (typeId) {
        case sji_iface_typeId:  {
            sjf_bob_as_sji_iface(_this, (sji_iface*)_return);
            break;
        }
...
void sjf_class_as_hash_iface_heap(sjs_class* _parent, sji_iface* _return) {
    ...
    sjt_call8 = (sjs_bob*)malloc(sizeof(sjs_bob));
    sjt_call8->_refCount = 1;
    sjf_bob_heap(sjt_call8);
#line 13 "cast3.sj"
    sjt_cast2 = sjt_call8;
#line 1
    sjf_bob_as_sji_iface(sjt_cast2, &(*_return));
...
void sjf_class_asarray_bang_i32(sjs_class* _parent, sjs_array_i32* _return) {
    ...
    _return->_refCount = 1;
#line 12 "cast3.sj"
    _return->v = createarray(1 * sizeof(int32_t));
#line 12
...
#line 12
    sjt_functionParam14 = 12;
#line 12
    sjf_array_i32_initat(sjt_parent6, sjt_functionParam13, sjt_functionParam14);
}
...
#line 12
    sjt_functionParam16 = 12;
#line 12
    sjf_array_i32_initat(sjt_parent7, sjt_functionParam15, sjt_functionParam16);
}
...
int main(int argc, char** argv) {
    sjs_bob_iface_vtbl.destroy = (void(*)(void*))sjf_bob_destroy;
    sjs_bob_iface_vtbl.asinterface = (void(*)(sjs_object*,int,sjs_interface*))sjf_bob_asinterface;
    sjs_bob_iface_vtbl.getclasstype = (void(*)(sjs_object*,int*))sjf_bob_getclasstype;
    sjs_bob_iface_vtbl.getx = (void(*)(sjs_object*, int32_t*))sjf_bob_getx;
...
#line 11
    sjt_parent4 = &g_c;
#line 11
    sjf_class_asi32(sjt_parent4, &sjt_functionParam9);
#line 22 "lib/sj-lib-common/i32.sj"
    sjt_functionParam10 = 10;
#line 22
    sjf_i32_asstring(sjt_functionParam9, sjt_functionParam10, &sjt_call3);
#line 19 "cast3.sj"
...
#line 12
    sjt_parent8 = &g_c;
#line 12
    sjf_class_asarray_bang_i32(sjt_parent8, &sjt_call5);
#line 20
    sjt_parent5 = &sjt_call5;
#line 20
    sjt_functionParam17 = 0;
#line 20
    sjf_array_i32_getat(sjt_parent5, sjt_functionParam17, &sjt_functionParam12);
#line 22 "lib/sj-lib-common/i32.sj"
    sjt_functionParam18 = 10;
#line 22
    sjf_i32_asstring(sjt_functionParam12, sjt_functionParam18, &sjt_call4);
#line 20 "cast3.sj"
...
#line 13
    sjt_parent10 = &g_c;
#line 13
    sjf_class_as_hash_iface_heap(sjt_parent10, &sjt_call7);
#line 21
    sjt_parent9 = sjt_call7;
#line 21
    sjt_parent9._vtbl->getx(sjt_parent9._parent, &sjt_functionParam20);
#line 22 "lib/sj-lib-common/i32.sj"
    sjt_functionParam21 = 10;
#line 22
    sjf_i32_asstring(sjt_functionParam20, sjt_functionParam21, &sjt_call6);
#line 21 "cast3.sj"
    sjt_functionParam19 = &sjt_call6;
#line 21
    sjf_debug_writeline(sjt_functionParam19);
    main_destroy();
    return 0;
}
...
void main_destroy() {
    ...
    if (sjt_call7._parent != 0) {
        sjt_call7._parent->_refCount--;
        if (sjt_call7._parent->_refCount <= 0) {
            sjt_call7._vtbl->destroy(sjt_call7._parent);
            free(sjt_call7._parent);
        }
    }
...
;
    if (sjt_call5._refCount == 1) { sjf_array_i32_destroy(&sjt_call5); }
;
