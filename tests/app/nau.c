...
#define sjs_color_heap_typeId 51
#define sjs_light_typeId 52
#define sjs_light_heap_typeId 53
...
#define sjs_nauScene3dElement_typeId 57
#define sjs_nauScene3dElement_heap_typeId 58
#define sjs_vec2_typeId 59
#define sjs_vec2_heap_typeId 60
#define sjs_vertex_location_texture_normal_typeId 61
#define sjs_vertex_location_texture_normal_heap_typeId 62
#define sjs_array_i32_typeId 63
#define sjs_array_i32_heap_typeId 64
#define sjs_array_vertex_location_texture_normal_typeId 65
#define sjs_array_vertex_location_texture_normal_heap_typeId 66
#define sjs_vertexBuffer_vertex_location_texture_normal_typeId 67
#define sjs_vertexBuffer_vertex_location_texture_normal_heap_typeId 68
#define sjs_texture_typeId 69
#define sjs_texture_heap_typeId 70
#define sjs_model_typeId 71
#define sjs_model_heap_typeId 72
#define cb_texture_heap_model_typeId 73
#define cb_texture_heap_model_heap_typeId 74
...
struct td_sji_nauScene3dElement_model {
    ...
    void (*render)(void* _parent, sjs_mat4* projection, sjs_mat4* view, sjs_light* light);
...
sjs_leafPanel_heap* sjt_cast17;
sjs_fillElement_heap* sjt_cast2;
int32_t sjt_cast23;
int32_t sjt_cast24;
sjs_panel3d_heap* sjt_cast25;
int32_t sjt_cast26;
...
sjs_crossHairsElement_heap* sjt_cast37;
sjs_nauScene3dElement_heap* sjt_cast4;
...
void sjf_leafPanel_render(sjs_leafPanel* _parent, sjs_mat4* projection, sjs_mat4* view, sjs_light* light);
...
void sjf_model_render(sjs_model* _parent, sjs_mat4* projection, sjs_mat4* view, sjs_light* light);
...
void sjf_panel3d_render(sjs_panel3d* _parent, sjs_mat4* projection, sjs_mat4* view, sjs_light* light);
...
void sjf_anon5_nextFrame(sjs_anon5* _parent, int32_t time) {
    ...
    sjs_anon5* sjt_dot1265;
    sjs_anon5* sjt_dot1268;
    bool sjt_ifElse14;
...
#line 31 "lib/ui/animation.sj"
    sjt_dot1265 = _parent;
#line 31
    sjt_dot1265->current = time;
#line 31
    sjt_dot1268 = _parent;
#line 4 "lib/common/list.sj"
    sjt_parent113 = &(sjt_dot1268)->animations;
#line 4
...
#line 35 "lib/ui/animation.sj"
        ...
        while (i < sjt_forEnd15) {
            ...
            sji_anon5_animation* sjt_parent118;
...
#line 31 "lib/ui/animation.sj"
            sjt_dot1270 = _parent;
#line 4 "lib/common/list.sj"
            sjt_parent115 = &(sjt_dot1270)->animations;
#line 4
...
#line 8 "lib/common/list.sj"
            sjt_parent117 = &(sjt_dot1272)->animations;
...
#line 2
            sjt_parent118 = sjv_a;
#line 31
            sjt_interfaceParam32 = time;
#line 38
            sjt_parent118->nextFrame((void*)(((char*)sjt_parent118->_parent) + sizeof(intptr_t)), sjt_interfaceParam32, &sjt_ifElse15);
            if (sjt_ifElse15) {
                sjs_anon5* sjt_dot1273;
...
#line 45 "lib/common/list.sj"
                sjt_parent119 = &(sjt_dot1273)->animations;
...
#line 64 "lib/common/array.sj"
    sjt_cast19 = 0;
#line 64
    sjv_newData = (uintptr_t)sjt_cast19;
#line 65
...
#line 63
    sjt_dot1191 = _parent;
#line 75
    _return->dataSize = (sjt_dot1191)->count;
#line 75
...
#line 63
    sjt_dot1192 = _parent;
#line 75
    _return->count = (sjt_dot1192)->count;
#line 75
...
#line 63
    sjt_dot1194 = _parent;
#line 75
    (*_return)->dataSize = (sjt_dot1194)->count;
#line 75
    (*_return)->data = sjv_newData;
#line 4
    (*_return)->_isGlobal = false;
#line 63
    sjt_dot1195 = _parent;
#line 75
    (*_return)->count = (sjt_dot1195)->count;
#line 75
...
void sjf_crossHairsElement_fireMouseEvent(sjs_crossHairsElement* _parent, sjs_point* point, int32_t eventId) {
    sjs_crossHairsElement* sjt_dot1261;
...
#line 11 "lib/ui/rect.sj"
    sjt_parent111 = &(sjt_dot1261)->_rect;
#line 44 "lib/ui/crossHairsElement.sj"
...
#line 44 "lib/ui/crossHairsElement.sj"
            sjt_dot1262 = _parent;
#line 44
            sjf_point_copy(&sjt_dot1262->_point, point);
#line 44
            sjt_dot1263 = _parent;
            if (sjt_dot1263->_topDownRenderer != 0) {
                sjt_dot1263->_topDownRenderer->_refCount--;
                if (sjt_dot1263->_topDownRenderer->_refCount <= 0) {
                    sjf_boxRenderer_destroy((sjs_boxRenderer*)(((char*)sjt_dot1263->_topDownRenderer) + sizeof(intptr_t)));
                }
            }

#line 48
            sjt_dot1263->_topDownRenderer = 0;
            if (sjt_dot1263->_topDownRenderer != 0) {
                sjt_dot1263->_topDownRenderer->_refCount++;
            }
...
#line 44
            sjt_dot1264 = _parent;
            if (sjt_dot1264->_leftRightRenderer != 0) {
                sjt_dot1264->_leftRightRenderer->_refCount--;
                if (sjt_dot1264->_leftRightRenderer->_refCount <= 0) {
                    sjf_boxRenderer_destroy((sjs_boxRenderer*)(((char*)sjt_dot1264->_leftRightRenderer) + sizeof(intptr_t)));
                }
            }

#line 49
            sjt_dot1264->_leftRightRenderer = 0;
            if (sjt_dot1264->_leftRightRenderer != 0) {
                sjt_dot1264->_leftRightRenderer->_refCount++;
            }
        }
...
void sjf_crossHairsElement_getRect(sjs_crossHairsElement* _parent, sjs_rect** _return) {
    sjs_crossHairsElement* sjt_dot1224;

#line 12 "lib/ui/crossHairsElement.sj"
    sjt_dot1224 = _parent;
#line 12
    (*_return) = &(sjt_dot1224)->_rect;
}

void sjf_crossHairsElement_getSize(sjs_crossHairsElement* _parent, sjs_size* maxSize, sjs_size* _return) {
    sjs_size* sjt_dot1220;
    sjs_size* sjt_dot1221;

#line 8 "lib/ui/crossHairsElement.sj"
    sjt_dot1220 = maxSize;
#line 9
    _return->w = (sjt_dot1220)->w;
#line 8
    sjt_dot1221 = maxSize;
#line 9
    _return->h = (sjt_dot1221)->h;
#line 9
    sjf_size(_return);
}
...
#line 8 "lib/ui/crossHairsElement.sj"
    sjt_dot1222 = maxSize;
#line 9
    (*_return)->w = (sjt_dot1222)->w;
#line 8
    sjt_dot1223 = maxSize;
#line 9
    (*_return)->h = (sjt_dot1223)->h;
#line 9
...
#line 23 "lib/ui/crossHairsElement.sj"
    sjt_dot1229 = _parent;
#line 24
    sjt_isEmpty1 = (sjt_dot1229)->_topDownRenderer;
    if (sjt_isEmpty1 != 0) {
...
#line 24
    ...
    if (sjt_ifElse8) {
        ...
        sjs_crossHairsElement* sjt_dot1232;
        sjs_rect* sjt_dot1233;
        sjs_crossHairsElement* sjt_dot1234;
        sjs_rect* sjt_dot1235;
...
#line 1 "lib/ui/point.sj"
        sjt_dot1231 = &(sjt_dot1232)->_point;
#line 26 "lib/ui/crossHairsElement.sj"
        sjt_value1->rect.x = (sjt_dot1231)->x;
#line 23
        sjt_dot1234 = _parent;
#line 1 "lib/ui/rect.sj"
        sjt_dot1233 = &(sjt_dot1234)->_rect;
#line 26 "lib/ui/crossHairsElement.sj"
        sjt_value1->rect.y = (sjt_dot1233)->y;
#line 26
        sjt_value1->rect.w = 1;
#line 23
        sjt_dot1236 = _parent;
#line 1 "lib/ui/rect.sj"
        sjt_dot1235 = &(sjt_dot1236)->_rect;
#line 26 "lib/ui/crossHairsElement.sj"
        sjt_value1->rect.h = (sjt_dot1235)->h;
#line 26
        sjf_rect(&sjt_value1->rect);
#line 23
        sjt_dot1237 = _parent;
#line 25
        sjf_color_copy(&sjt_value1->color, &(sjt_dot1237)->color);
#line 25
        sjf_boxRenderer_heap(sjt_value1);
        if (sjt_dot1230->_topDownRenderer != 0) {
            sjt_dot1230->_topDownRenderer->_refCount--;
            if (sjt_dot1230->_topDownRenderer->_refCount <= 0) {
                sjf_boxRenderer_destroy((sjs_boxRenderer*)(((char*)sjt_dot1230->_topDownRenderer) + sizeof(intptr_t)));
            }
        }

#line 25
        sjt_dot1230->_topDownRenderer = sjt_value1;
        if (sjt_dot1230->_topDownRenderer != 0) {
            sjt_dot1230->_topDownRenderer->_refCount++;
        }
...
#line 23
    sjt_dot1238 = _parent;
#line 30
    sjt_isEmpty2 = (sjt_dot1238)->_leftRightRenderer;
    if (sjt_isEmpty2 != 0) {
...
#line 30
    ...
    if (sjt_ifElse9) {
        ...
        sjs_rect* sjt_dot1240;
        sjs_crossHairsElement* sjt_dot1241;
        sjs_point* sjt_dot1242;
        sjs_crossHairsElement* sjt_dot1243;
        sjs_rect* sjt_dot1244;
        sjs_crossHairsElement* sjt_dot1245;
...
#line 23
        sjt_dot1241 = _parent;
#line 1 "lib/ui/rect.sj"
        sjt_dot1240 = &(sjt_dot1241)->_rect;
#line 32 "lib/ui/crossHairsElement.sj"
        sjt_value2->rect.x = (sjt_dot1240)->x;
#line 23
        sjt_dot1243 = _parent;
#line 1 "lib/ui/point.sj"
        sjt_dot1242 = &(sjt_dot1243)->_point;
#line 32 "lib/ui/crossHairsElement.sj"
        sjt_value2->rect.y = (sjt_dot1242)->y;
#line 23
        sjt_dot1245 = _parent;
#line 1 "lib/ui/rect.sj"
        sjt_dot1244 = &(sjt_dot1245)->_rect;
#line 32 "lib/ui/crossHairsElement.sj"
        sjt_value2->rect.w = (sjt_dot1244)->w;
#line 32
        sjt_value2->rect.h = 1;
#line 32
...
#line 23
        sjt_dot1246 = _parent;
#line 31
        sjf_color_copy(&sjt_value2->color, &(sjt_dot1246)->color);
#line 31
        sjf_boxRenderer_heap(sjt_value2);
        if (sjt_dot1239->_leftRightRenderer != 0) {
            sjt_dot1239->_leftRightRenderer->_refCount--;
            if (sjt_dot1239->_leftRightRenderer->_refCount <= 0) {
                sjf_boxRenderer_destroy((sjs_boxRenderer*)(((char*)sjt_dot1239->_leftRightRenderer) + sizeof(intptr_t)));
            }
        }

#line 31
        sjt_dot1239->_leftRightRenderer = sjt_value2;
        if (sjt_dot1239->_leftRightRenderer != 0) {
            sjt_dot1239->_leftRightRenderer->_refCount++;
        }
...
#line 23
    sjt_dot1247 = _parent;
#line 36
    sjt_isEmpty3 = (sjt_dot1247)->_topDownRenderer;
    if (sjt_isEmpty3 != 0) {
...
#line 23 "lib/ui/crossHairsElement.sj"
        sjt_dot1248 = _parent;
#line 36
        sjt_getValue1 = (sjt_dot1248)->_topDownRenderer;
        if (sjt_getValue1 != 0) {
...
#line 23
    sjt_dot1249 = _parent;
#line 37
    sjt_isEmpty4 = (sjt_dot1249)->_leftRightRenderer;
    if (sjt_isEmpty4 != 0) {
...
#line 23 "lib/ui/crossHairsElement.sj"
        sjt_dot1250 = _parent;
#line 37
        sjt_getValue2 = (sjt_dot1250)->_leftRightRenderer;
        if (sjt_getValue2 != 0) {
...
#line 15 "lib/ui/rect.sj"
    sjt_parent108 = &(sjt_dot1225)->_rect;
#line 14 "lib/ui/crossHairsElement.sj"
...
#line 14 "lib/ui/crossHairsElement.sj"
        sjt_dot1226 = _parent;
#line 14
        sjf_rect_copy(&sjt_dot1226->_rect, rect_);
#line 14
        sjt_dot1227 = _parent;
        if (sjt_dot1227->_topDownRenderer != 0) {
            sjt_dot1227->_topDownRenderer->_refCount--;
            if (sjt_dot1227->_topDownRenderer->_refCount <= 0) {
                sjf_boxRenderer_destroy((sjs_boxRenderer*)(((char*)sjt_dot1227->_topDownRenderer) + sizeof(intptr_t)));
            }
        }

#line 17
        sjt_dot1227->_topDownRenderer = 0;
        if (sjt_dot1227->_topDownRenderer != 0) {
            sjt_dot1227->_topDownRenderer->_refCount++;
        }
...
#line 14
        sjt_dot1228 = _parent;
        if (sjt_dot1228->_leftRightRenderer != 0) {
            sjt_dot1228->_leftRightRenderer->_refCount--;
            if (sjt_dot1228->_leftRightRenderer->_refCount <= 0) {
                sjf_boxRenderer_destroy((sjs_boxRenderer*)(((char*)sjt_dot1228->_leftRightRenderer) + sizeof(intptr_t)));
            }
        }

#line 18
        sjt_dot1228->_leftRightRenderer = 0;
        if (sjt_dot1228->_leftRightRenderer != 0) {
            sjt_dot1228->_leftRightRenderer->_refCount++;
        }
    }
...
#line 1 "nau/leafPanel.sj"
    sjt_dot1189 = &_this->textures;
#line 44
    sjt_cast18 = (sjt_dot1189)->count;
#line 44
    sjt_math1967 = (float)sjt_cast18;
#line 44
    sjt_math1968 = 0.8f;
#line 44
...
sji_nauScene3dElement_model* sjf_leafPanel_as_sji_nauScene3dElement_model(sjs_leafPanel* _this) {
    ...
    _interface->render = (void(*)(void*,sjs_mat4*,sjs_mat4*,sjs_light*))sjf_leafPanel_render;
...
void sjf_leafPanel_fireMouseEvent(sjs_leafPanel* _parent, sjs_rect* sceneRect, sjs_mat4* projection, sjs_mat4* view, sjs_point* point, int32_t eventId) {
    int32_t i;
    sjs_array_heap_model* sjt_dot1206;
    sjs_leafPanel* sjt_dot1207;
...
#line 20
    sjt_dot1207 = _parent;
#line 1 "lib/common/array.sj"
    sjt_dot1206 = &(sjt_dot1207)->children;
#line 21 "nau/leafPanel.sj"
    sjt_forEnd11 = (sjt_dot1206)->count;
#line 21
    i = sjt_forStart11;
...
#line 20 "nau/leafPanel.sj"
        sjt_dot1208 = _parent;
#line 7 "lib/common/array.sj"
        sjt_parent68 = &(sjt_dot1208)->children;
#line 21 "nau/leafPanel.sj"
...
#line 20
        sjt_interfaceParam22 = eventId;
#line 23
        sjt_parent69->fireMouseEvent((void*)(((char*)sjt_parent69->_parent) + sizeof(intptr_t)), sjt_interfaceParam18, sjt_interfaceParam19, sjt_interfaceParam20, sjt_interfaceParam21, sjt_interfaceParam22);
#line 21
        i++;
...
#line 1 "lib/common/array.sj"
    sjt_dot1209 = &_this->textures;
#line 44 "nau/leafPanel.sj"
    sjt_cast22 = (sjt_dot1209)->count;
#line 44
    sjt_math1989 = (float)sjt_cast22;
#line 44
    sjt_math1990 = 0.8f;
#line 44
...
void sjf_leafPanel_render(sjs_leafPanel* _parent, sjs_mat4* projection, sjs_mat4* view, sjs_light* light) {
    int32_t i;
    sjs_array_heap_model* sjt_dot1203;
    sjs_leafPanel* sjt_dot1204;
...
#line 13
    sjt_dot1204 = _parent;
#line 1 "lib/common/array.sj"
    sjt_dot1203 = &(sjt_dot1204)->children;
#line 14 "nau/leafPanel.sj"
    sjt_forEnd10 = (sjt_dot1203)->count;
#line 14
    i = sjt_forStart10;
...
#line 13 "nau/leafPanel.sj"
        sjt_dot1205 = _parent;
#line 7 "lib/common/array.sj"
        sjt_parent66 = &(sjt_dot1205)->children;
#line 14 "nau/leafPanel.sj"
...
#line 3 "lib/ui/model.sj"
        sjt_parent67 = sjv_c;
#line 13 "nau/leafPanel.sj"
        sjt_interfaceParam15 = projection;
#line 13
        sjt_interfaceParam16 = view;
#line 13
        sjt_interfaceParam17 = light;
#line 16
        sjt_parent67->render((void*)(((char*)sjt_parent67->_parent) + sizeof(intptr_t)), sjt_interfaceParam15, sjt_interfaceParam16, sjt_interfaceParam17);
#line 14
        i++;
...
void sjf_leafPanel_setWorld(sjs_leafPanel* _parent, sjs_mat4* world_) {
    int32_t i;
    sjs_array_heap_model* sjt_dot1200;
    sjs_leafPanel* sjt_dot1201;
    int32_t sjt_forEnd9;
...
#line 5
    sjt_dot1201 = _parent;
#line 1 "lib/common/array.sj"
    sjt_dot1200 = &(sjt_dot1201)->children;
#line 6 "nau/leafPanel.sj"
    sjt_forEnd9 = (sjt_dot1200)->count;
#line 6
    i = sjt_forStart9;
    while (i < sjt_forEnd9) {
...
#line 5 "nau/leafPanel.sj"
        sjt_dot1202 = _parent;
#line 7 "lib/common/array.sj"
        sjt_parent64 = &(sjt_dot1202)->children;
#line 6 "nau/leafPanel.sj"
...
#line 2 "lib/ui/model.sj"
        sjt_parent65 = sjv_c;
#line 5 "nau/leafPanel.sj"
        sjt_interfaceParam14 = world_;
#line 8
        sjt_parent65->setWorld((void*)(((char*)sjt_parent65->_parent) + sizeof(intptr_t)), sjt_interfaceParam14);
#line 6
        i++;
...
#line 29
    sjt_dot1196 = _parent;
#line 31
    sjt_math1973 = (sjt_dot1196)->_angle;
#line 31
    sjt_math1974 = 2.0f;
#line 31
...
#line 29
    sjt_dot1197 = _parent;
#line 33
    sjt_math1981 = (sjt_dot1197)->_angle;
#line 33
...
#line 29
    sjt_dot1199 = _parent;
#line 34
    sjt_math1985 = (sjt_dot1199)->_angle;
#line 34
    sjt_math1986 = 0.8f;
#line 34
    sjt_dot1198->_angle = sjt_math1985 + sjt_math1986;
#line 34
...
#line 74
    sjf_planeVertexBuffer(sjt_functionParam134, sjt_functionParam135, sjt_functionParam136, sjt_functionParam137, sjt_functionParam138, sjt_functionParam139, sjt_functionParam140, sjt_functionParam141, sjt_functionParam142, &sjt_cast21->vertexBuffer);
#line 36 "nau/leafPanel.sj"
    sjf_shader_copy(&sjt_cast21->shader, &sjv_phongTextureShader);
#line 29
    sjf_texture_copy(&sjt_cast21->texture, texture);
#line 11 "lib/ui/model.sj"
    sjt_cast21->scale = 1.0f;
...
#line 39
    sjf_mat4_translate(sjt_functionParam143, sjt_functionParam144, sjt_functionParam145, &sjt_cast21->world);
#line 2 "lib/ui/mat4.sj"
    sjt_cast21->_parentWorld.m00 = 0.0f;
#line 3
    sjt_cast21->_parentWorld.m01 = 0.0f;
#line 4
    sjt_cast21->_parentWorld.m02 = 0.0f;
#line 5
    sjt_cast21->_parentWorld.m03 = 0.0f;
#line 6
    sjt_cast21->_parentWorld.m10 = 0.0f;
#line 7
    sjt_cast21->_parentWorld.m11 = 0.0f;
#line 8
    sjt_cast21->_parentWorld.m12 = 0.0f;
#line 9
    sjt_cast21->_parentWorld.m13 = 0.0f;
#line 10
    sjt_cast21->_parentWorld.m20 = 0.0f;
#line 11
    sjt_cast21->_parentWorld.m21 = 0.0f;
#line 12
    sjt_cast21->_parentWorld.m22 = 0.0f;
#line 13
    sjt_cast21->_parentWorld.m23 = 0.0f;
#line 14
    sjt_cast21->_parentWorld.m30 = 0.0f;
#line 15
    sjt_cast21->_parentWorld.m31 = 0.0f;
#line 16
    sjt_cast21->_parentWorld.m32 = 0.0f;
#line 17
    sjt_cast21->_parentWorld.m33 = 0.0f;
#line 17
    sjf_mat4(&sjt_cast21->_parentWorld);
#line 17
    sjf_model_heap(sjt_cast21);
#line 1 "lib/ui/model.sj"
    (*_return) = (sji_nauScene3dElement_model*)sjf_model_heap_as_sji_nauScene3dElement_model(sjt_cast21);
...
void sjf_list_heap_animation_getAt_heap(sjs_list_heap_animation* _parent, int32_t index, sji_anon5_animation** _return) {
    sjs_list_heap_animation* sjt_dot1271;
...
#line 8 "lib/common/list.sj"
    sjt_dot1271 = _parent;
#line 7 "lib/common/array.sj"
    sjt_parent116 = &(sjt_dot1271)->array;
#line 8 "lib/common/list.sj"
...
void sjf_list_heap_animation_getCount(sjs_list_heap_animation* _parent, int32_t* _return) {
    sjs_array_heap_animation* sjt_dot1266;
    sjs_list_heap_animation* sjt_dot1267;

#line 4 "lib/common/list.sj"
    sjt_dot1267 = _parent;
#line 1 "lib/common/array.sj"
    sjt_dot1266 = &(sjt_dot1267)->array;
#line 4 "lib/common/list.sj"
    (*_return) = (sjt_dot1266)->count;
}
...
void sjf_mainLoop(void) {
    ...
    sjs_scene2d* sjt_interfaceParam34;
...
#line 10
    sjf_anon5_nextFrame(sjt_parent120, sjt_functionParam385);
...
#line 15 "lib/ui/loop.sj"
    sjv_rect.w = (sjt_dot1287)->w;
#line 1 "lib/ui/size.sj"
    sjt_dot1288 = &sjv_size;
#line 15 "lib/ui/loop.sj"
    sjv_rect.h = (sjt_dot1288)->h;
#line 15
    sjf_rect(&sjv_rect);
#line 4 "lib/ui/element.sj"
...
#line 16 "lib/ui/loop.sj"
    sjt_parent125->setRect((void*)(((char*)sjt_parent125->_parent) + sizeof(intptr_t)), sjt_interfaceParam33);
#line 5 "lib/ui/element.sj"
    sjt_parent126 = sjv_root;
#line 5
    sjt_interfaceParam34 = &sjv_rootScene;
#line 17 "lib/ui/loop.sj"
    sjt_parent126->render((void*)(((char*)sjt_parent126->_parent) + sizeof(intptr_t)), sjt_interfaceParam34);
...
#line 53
        sjt_interfaceParam35 = &sjt_call71;
#line 6 "lib/ui/element.sj"
        sjt_interfaceParam36 = sjv_mouseEvent;
#line 53 "lib/ui/loop.sj"
        sjt_parent128->fireMouseEvent((void*)(((char*)sjt_parent128->_parent) + sizeof(intptr_t)), sjt_interfaceParam35, sjt_interfaceParam36);
...
#line 84 "lib/ui/mat4.sj"
    sjt_dot804 = _parent;
#line 85
    sjt_math1279 = (sjt_dot804)->m03;
#line 84
    sjt_dot805 = _parent;
#line 85
    sjt_math1280 = (sjt_dot805)->m12;
#line 85
    sjt_math1277 = sjt_math1279 * sjt_math1280;
#line 84
    sjt_dot806 = _parent;
#line 85
    sjt_math1278 = (sjt_dot806)->m21;
#line 85
    sjt_math1275 = sjt_math1277 * sjt_math1278;
#line 84
    sjt_dot807 = _parent;
#line 85
    sjt_math1276 = (sjt_dot807)->m30;
#line 85
...
#line 84
    sjt_dot809 = _parent;
#line 85
    sjt_math1286 = (sjt_dot809)->m13;
#line 85
    sjt_math1283 = sjt_math1285 * sjt_math1286;
#line 84
    sjt_dot810 = _parent;
#line 85
    sjt_math1284 = (sjt_dot810)->m21;
#line 85
    sjt_math1281 = sjt_math1283 * sjt_math1284;
#line 84
    sjt_dot811 = _parent;
#line 85
    sjt_math1282 = (sjt_dot811)->m30;
#line 85
...
#line 84
    sjt_dot812 = _parent;
#line 85
    sjt_math1291 = (sjt_dot812)->m03;
#line 84
    sjt_dot813 = _parent;
#line 85
    sjt_math1292 = (sjt_dot813)->m11;
#line 85
    sjt_math1289 = sjt_math1291 * sjt_math1292;
#line 84
    sjt_dot814 = _parent;
#line 85
    sjt_math1290 = (sjt_dot814)->m22;
#line 85
    sjt_math1287 = sjt_math1289 * sjt_math1290;
#line 84
    sjt_dot815 = _parent;
#line 85
    sjt_math1288 = (sjt_dot815)->m30;
#line 85
...
#line 84
    sjt_dot816 = _parent;
#line 85
    sjt_math1297 = (sjt_dot816)->m01;
#line 84
    sjt_dot817 = _parent;
#line 85
    sjt_math1298 = (sjt_dot817)->m13;
#line 85
    sjt_math1295 = sjt_math1297 * sjt_math1298;
#line 84
    sjt_dot818 = _parent;
#line 85
    sjt_math1296 = (sjt_dot818)->m22;
#line 85
    sjt_math1293 = sjt_math1295 * sjt_math1296;
#line 84
    sjt_dot819 = _parent;
#line 85
    sjt_math1294 = (sjt_dot819)->m30;
#line 85
...
#line 84
    sjt_dot820 = _parent;
#line 85
    sjt_math1303 = (sjt_dot820)->m02;
#line 84
    sjt_dot821 = _parent;
#line 85
    sjt_math1304 = (sjt_dot821)->m11;
#line 85
    sjt_math1301 = sjt_math1303 * sjt_math1304;
#line 84
    sjt_dot822 = _parent;
#line 85
    sjt_math1302 = (sjt_dot822)->m23;
#line 85
    sjt_math1299 = sjt_math1301 * sjt_math1302;
#line 84
    sjt_dot823 = _parent;
#line 85
    sjt_math1300 = (sjt_dot823)->m30;
#line 85
...
#line 84
    sjt_dot824 = _parent;
#line 85
    sjt_math1309 = (sjt_dot824)->m01;
#line 84
    sjt_dot825 = _parent;
#line 85
    sjt_math1310 = (sjt_dot825)->m12;
#line 85
    sjt_math1307 = sjt_math1309 * sjt_math1310;
#line 84
    sjt_dot826 = _parent;
#line 85
    sjt_math1308 = (sjt_dot826)->m23;
#line 85
    sjt_math1305 = sjt_math1307 * sjt_math1308;
#line 84
    sjt_dot827 = _parent;
#line 85
    sjt_math1306 = (sjt_dot827)->m30;
#line 85
...
#line 84
    sjt_dot828 = _parent;
#line 85
    sjt_math1315 = (sjt_dot828)->m03;
#line 84
    sjt_dot829 = _parent;
#line 85
    sjt_math1316 = (sjt_dot829)->m12;
#line 85
    sjt_math1313 = sjt_math1315 * sjt_math1316;
#line 84
    sjt_dot830 = _parent;
#line 85
    sjt_math1314 = (sjt_dot830)->m20;
#line 85
    sjt_math1311 = sjt_math1313 * sjt_math1314;
#line 84
    sjt_dot831 = _parent;
#line 85
    sjt_math1312 = (sjt_dot831)->m31;
#line 85
...
#line 84
    sjt_dot832 = _parent;
#line 85
    sjt_math1321 = (sjt_dot832)->m02;
#line 84
    sjt_dot833 = _parent;
#line 85
    sjt_math1322 = (sjt_dot833)->m13;
#line 85
    sjt_math1319 = sjt_math1321 * sjt_math1322;
#line 84
    sjt_dot834 = _parent;
#line 85
    sjt_math1320 = (sjt_dot834)->m20;
#line 85
    sjt_math1317 = sjt_math1319 * sjt_math1320;
#line 84
    sjt_dot835 = _parent;
#line 85
    sjt_math1318 = (sjt_dot835)->m31;
#line 85
...
#line 84
    sjt_dot836 = _parent;
#line 85
    sjt_math1327 = (sjt_dot836)->m03;
#line 84
    sjt_dot837 = _parent;
#line 85
    sjt_math1328 = (sjt_dot837)->m10;
#line 85
    sjt_math1325 = sjt_math1327 * sjt_math1328;
#line 84
    sjt_dot838 = _parent;
#line 85
    sjt_math1326 = (sjt_dot838)->m22;
#line 85
    sjt_math1323 = sjt_math1325 * sjt_math1326;
#line 84
    sjt_dot839 = _parent;
#line 85
    sjt_math1324 = (sjt_dot839)->m31;
#line 85
...
#line 84
    sjt_dot840 = _parent;
#line 85
    sjt_math1333 = (sjt_dot840)->m00;
#line 84
    sjt_dot841 = _parent;
#line 85
    sjt_math1334 = (sjt_dot841)->m13;
#line 85
    sjt_math1331 = sjt_math1333 * sjt_math1334;
#line 84
    sjt_dot842 = _parent;
#line 85
    sjt_math1332 = (sjt_dot842)->m22;
#line 85
    sjt_math1329 = sjt_math1331 * sjt_math1332;
#line 84
    sjt_dot843 = _parent;
#line 85
    sjt_math1330 = (sjt_dot843)->m31;
#line 85
...
#line 84
    sjt_dot844 = _parent;
#line 85
    sjt_math1339 = (sjt_dot844)->m02;
#line 84
    sjt_dot845 = _parent;
#line 85
    sjt_math1340 = (sjt_dot845)->m10;
#line 85
    sjt_math1337 = sjt_math1339 * sjt_math1340;
#line 84
    sjt_dot846 = _parent;
#line 85
    sjt_math1338 = (sjt_dot846)->m23;
#line 85
    sjt_math1335 = sjt_math1337 * sjt_math1338;
#line 84
    sjt_dot847 = _parent;
#line 85
    sjt_math1336 = (sjt_dot847)->m31;
#line 85
...
#line 84
    sjt_dot848 = _parent;
#line 85
    sjt_math1345 = (sjt_dot848)->m00;
#line 84
    sjt_dot849 = _parent;
#line 85
    sjt_math1346 = (sjt_dot849)->m12;
#line 85
    sjt_math1343 = sjt_math1345 * sjt_math1346;
#line 84
    sjt_dot850 = _parent;
#line 85
    sjt_math1344 = (sjt_dot850)->m23;
#line 85
    sjt_math1341 = sjt_math1343 * sjt_math1344;
#line 84
    sjt_dot851 = _parent;
#line 85
    sjt_math1342 = (sjt_dot851)->m31;
#line 85
...
#line 84
    sjt_dot852 = _parent;
#line 85
    sjt_math1351 = (sjt_dot852)->m03;
#line 84
    sjt_dot853 = _parent;
#line 85
    sjt_math1352 = (sjt_dot853)->m11;
#line 85
    sjt_math1349 = sjt_math1351 * sjt_math1352;
#line 84
    sjt_dot854 = _parent;
#line 85
    sjt_math1350 = (sjt_dot854)->m20;
#line 85
    sjt_math1347 = sjt_math1349 * sjt_math1350;
#line 84
    sjt_dot855 = _parent;
#line 85
    sjt_math1348 = (sjt_dot855)->m32;
#line 85
...
#line 84
    sjt_dot856 = _parent;
#line 85
    sjt_math1357 = (sjt_dot856)->m01;
#line 84
    sjt_dot857 = _parent;
#line 85
    sjt_math1358 = (sjt_dot857)->m13;
#line 85
    sjt_math1355 = sjt_math1357 * sjt_math1358;
#line 84
    sjt_dot858 = _parent;
#line 85
    sjt_math1356 = (sjt_dot858)->m20;
#line 85
    sjt_math1353 = sjt_math1355 * sjt_math1356;
#line 84
    sjt_dot859 = _parent;
#line 85
    sjt_math1354 = (sjt_dot859)->m32;
#line 85
...
#line 84
    sjt_dot860 = _parent;
#line 85
    sjt_math1363 = (sjt_dot860)->m03;
#line 84
    sjt_dot861 = _parent;
#line 85
    sjt_math1364 = (sjt_dot861)->m10;
#line 85
    sjt_math1361 = sjt_math1363 * sjt_math1364;
#line 84
    sjt_dot862 = _parent;
#line 85
    sjt_math1362 = (sjt_dot862)->m21;
#line 85
    sjt_math1359 = sjt_math1361 * sjt_math1362;
#line 84
    sjt_dot863 = _parent;
#line 85
    sjt_math1360 = (sjt_dot863)->m32;
#line 85
...
#line 84
    sjt_dot864 = _parent;
#line 85
    sjt_math1369 = (sjt_dot864)->m00;
#line 84
    sjt_dot865 = _parent;
#line 85
    sjt_math1370 = (sjt_dot865)->m13;
#line 85
    sjt_math1367 = sjt_math1369 * sjt_math1370;
#line 84
    sjt_dot866 = _parent;
#line 85
    sjt_math1368 = (sjt_dot866)->m21;
#line 85
    sjt_math1365 = sjt_math1367 * sjt_math1368;
#line 84
    sjt_dot867 = _parent;
#line 85
    sjt_math1366 = (sjt_dot867)->m32;
#line 85
...
#line 84
    sjt_dot868 = _parent;
#line 85
    sjt_math1375 = (sjt_dot868)->m01;
#line 84
    sjt_dot869 = _parent;
#line 85
    sjt_math1376 = (sjt_dot869)->m10;
#line 85
    sjt_math1373 = sjt_math1375 * sjt_math1376;
#line 84
    sjt_dot870 = _parent;
#line 85
    sjt_math1374 = (sjt_dot870)->m23;
#line 85
    sjt_math1371 = sjt_math1373 * sjt_math1374;
#line 84
    sjt_dot871 = _parent;
#line 85
    sjt_math1372 = (sjt_dot871)->m32;
#line 85
...
#line 84
    sjt_dot872 = _parent;
#line 85
    sjt_math1381 = (sjt_dot872)->m00;
#line 84
    sjt_dot873 = _parent;
#line 85
    sjt_math1382 = (sjt_dot873)->m11;
#line 85
    sjt_math1379 = sjt_math1381 * sjt_math1382;
#line 84
    sjt_dot874 = _parent;
#line 85
    sjt_math1380 = (sjt_dot874)->m23;
#line 85
    sjt_math1377 = sjt_math1379 * sjt_math1380;
#line 84
    sjt_dot875 = _parent;
#line 85
    sjt_math1378 = (sjt_dot875)->m32;
#line 85
...
#line 84
    sjt_dot876 = _parent;
#line 85
    sjt_math1387 = (sjt_dot876)->m02;
#line 84
    sjt_dot877 = _parent;
#line 85
    sjt_math1388 = (sjt_dot877)->m11;
#line 85
    sjt_math1385 = sjt_math1387 * sjt_math1388;
#line 84
    sjt_dot878 = _parent;
#line 85
    sjt_math1386 = (sjt_dot878)->m20;
#line 85
    sjt_math1383 = sjt_math1385 * sjt_math1386;
#line 84
    sjt_dot879 = _parent;
#line 85
    sjt_math1384 = (sjt_dot879)->m33;
#line 85
...
#line 84
    sjt_dot880 = _parent;
#line 85
    sjt_math1393 = (sjt_dot880)->m01;
#line 84
    sjt_dot881 = _parent;
#line 85
    sjt_math1394 = (sjt_dot881)->m12;
#line 85
    sjt_math1391 = sjt_math1393 * sjt_math1394;
#line 84
    sjt_dot882 = _parent;
#line 85
    sjt_math1392 = (sjt_dot882)->m20;
#line 85
    sjt_math1389 = sjt_math1391 * sjt_math1392;
#line 84
    sjt_dot883 = _parent;
#line 85
    sjt_math1390 = (sjt_dot883)->m33;
#line 85
...
#line 84
    sjt_dot884 = _parent;
#line 85
    sjt_math1399 = (sjt_dot884)->m02;
#line 84
    sjt_dot885 = _parent;
#line 85
    sjt_math1400 = (sjt_dot885)->m10;
#line 85
    sjt_math1397 = sjt_math1399 * sjt_math1400;
#line 84
    sjt_dot886 = _parent;
#line 85
    sjt_math1398 = (sjt_dot886)->m21;
#line 85
    sjt_math1395 = sjt_math1397 * sjt_math1398;
#line 84
    sjt_dot887 = _parent;
#line 85
    sjt_math1396 = (sjt_dot887)->m33;
#line 85
...
#line 84
    sjt_dot888 = _parent;
#line 85
    sjt_math1405 = (sjt_dot888)->m00;
#line 84
    sjt_dot889 = _parent;
#line 85
    sjt_math1406 = (sjt_dot889)->m12;
#line 85
    sjt_math1403 = sjt_math1405 * sjt_math1406;
#line 84
    sjt_dot890 = _parent;
#line 85
    sjt_math1404 = (sjt_dot890)->m21;
#line 85
    sjt_math1401 = sjt_math1403 * sjt_math1404;
#line 84
    sjt_dot891 = _parent;
#line 85
    sjt_math1402 = (sjt_dot891)->m33;
#line 85
...
#line 84
    sjt_dot892 = _parent;
#line 85
    sjt_math1411 = (sjt_dot892)->m01;
#line 84
    sjt_dot893 = _parent;
#line 85
    sjt_math1412 = (sjt_dot893)->m10;
#line 85
    sjt_math1409 = sjt_math1411 * sjt_math1412;
#line 84
    sjt_dot894 = _parent;
#line 85
    sjt_math1410 = (sjt_dot894)->m22;
#line 85
    sjt_math1407 = sjt_math1409 * sjt_math1410;
#line 84
    sjt_dot895 = _parent;
#line 85
    sjt_math1408 = (sjt_dot895)->m33;
#line 85
...
#line 84
    sjt_dot896 = _parent;
#line 85
    sjt_math1417 = (sjt_dot896)->m00;
#line 84
    sjt_dot897 = _parent;
#line 85
    sjt_math1418 = (sjt_dot897)->m11;
#line 85
    sjt_math1415 = sjt_math1417 * sjt_math1418;
#line 84
    sjt_dot898 = _parent;
#line 85
    sjt_math1416 = (sjt_dot898)->m22;
#line 85
    sjt_math1413 = sjt_math1415 * sjt_math1416;
#line 84
    sjt_dot899 = _parent;
#line 85
    sjt_math1414 = (sjt_dot899)->m33;
#line 85
...
#line 61 "lib/ui/mat4.sj"
    sjt_dot484 = _parent;
#line 63
    sjt_math631 = (sjt_dot484)->m12;
#line 61
    sjt_dot485 = _parent;
#line 63
    sjt_math632 = (sjt_dot485)->m23;
#line 63
    sjt_math629 = sjt_math631 * sjt_math632;
#line 61
    sjt_dot486 = _parent;
#line 63
    sjt_math630 = (sjt_dot486)->m31;
#line 63
    sjt_math627 = sjt_math629 * sjt_math630;
#line 61
    sjt_dot487 = _parent;
#line 63
    sjt_math635 = (sjt_dot487)->m13;
#line 61
    sjt_dot488 = _parent;
#line 63
    sjt_math636 = (sjt_dot488)->m22;
#line 63
    sjt_math633 = sjt_math635 * sjt_math636;
#line 61
    sjt_dot489 = _parent;
#line 63
    sjt_math634 = (sjt_dot489)->m31;
#line 63
...
#line 61
    sjt_dot490 = _parent;
#line 63
    sjt_math639 = (sjt_dot490)->m13;
#line 61
    sjt_dot491 = _parent;
#line 63
    sjt_math640 = (sjt_dot491)->m21;
#line 63
    sjt_math637 = sjt_math639 * sjt_math640;
#line 61
    sjt_dot492 = _parent;
#line 63
    sjt_math638 = (sjt_dot492)->m32;
#line 63
...
#line 61
    sjt_dot493 = _parent;
#line 63
    sjt_math643 = (sjt_dot493)->m11;
#line 61
    sjt_dot494 = _parent;
#line 63
    sjt_math644 = (sjt_dot494)->m23;
#line 63
    sjt_math641 = sjt_math643 * sjt_math644;
#line 61
    sjt_dot495 = _parent;
#line 63
    sjt_math642 = (sjt_dot495)->m32;
#line 63
...
#line 61
    sjt_dot496 = _parent;
#line 63
    sjt_math647 = (sjt_dot496)->m12;
#line 61
    sjt_dot497 = _parent;
#line 63
    sjt_math648 = (sjt_dot497)->m21;
#line 63
    sjt_math645 = sjt_math647 * sjt_math648;
#line 61
    sjt_dot498 = _parent;
#line 63
    sjt_math646 = (sjt_dot498)->m33;
#line 63
...
#line 61
    sjt_dot499 = _parent;
#line 63
    sjt_math651 = (sjt_dot499)->m11;
#line 61
    sjt_dot500 = _parent;
#line 63
    sjt_math652 = (sjt_dot500)->m22;
#line 63
    sjt_math649 = sjt_math651 * sjt_math652;
#line 61
    sjt_dot501 = _parent;
#line 63
    sjt_math650 = (sjt_dot501)->m33;
#line 63
...
#line 61
    sjt_dot502 = _parent;
#line 64
    sjt_math665 = (sjt_dot502)->m03;
#line 61
    sjt_dot503 = _parent;
#line 64
    sjt_math666 = (sjt_dot503)->m22;
#line 64
    sjt_math663 = sjt_math665 * sjt_math666;
#line 61
    sjt_dot504 = _parent;
#line 64
    sjt_math664 = (sjt_dot504)->m31;
#line 64
    sjt_math661 = sjt_math663 * sjt_math664;
#line 61
    sjt_dot505 = _parent;
#line 64
    sjt_math669 = (sjt_dot505)->m02;
#line 61
    sjt_dot506 = _parent;
#line 64
    sjt_math670 = (sjt_dot506)->m23;
#line 64
    sjt_math667 = sjt_math669 * sjt_math670;
#line 61
    sjt_dot507 = _parent;
#line 64
    sjt_math668 = (sjt_dot507)->m31;
#line 64
...
#line 61
    sjt_dot508 = _parent;
#line 64
    sjt_math673 = (sjt_dot508)->m03;
#line 61
    sjt_dot509 = _parent;
#line 64
    sjt_math674 = (sjt_dot509)->m21;
#line 64
    sjt_math671 = sjt_math673 * sjt_math674;
#line 61
    sjt_dot510 = _parent;
#line 64
    sjt_math672 = (sjt_dot510)->m32;
#line 64
...
#line 61
    sjt_dot511 = _parent;
#line 64
    sjt_math677 = (sjt_dot511)->m01;
#line 61
    sjt_dot512 = _parent;
#line 64
    sjt_math678 = (sjt_dot512)->m23;
#line 64
    sjt_math675 = sjt_math677 * sjt_math678;
#line 61
    sjt_dot513 = _parent;
#line 64
    sjt_math676 = (sjt_dot513)->m32;
#line 64
...
#line 61
    sjt_dot514 = _parent;
#line 64
    sjt_math681 = (sjt_dot514)->m02;
#line 61
    sjt_dot515 = _parent;
#line 64
    sjt_math682 = (sjt_dot515)->m21;
#line 64
...
#line 61
    sjt_dot517 = _parent;
#line 64
    sjt_math685 = (sjt_dot517)->m01;
#line 61
    sjt_dot518 = _parent;
#line 64
    sjt_math686 = (sjt_dot518)->m22;
#line 64
    sjt_math683 = sjt_math685 * sjt_math686;
#line 61
    sjt_dot519 = _parent;
#line 64
    sjt_math684 = (sjt_dot519)->m33;
#line 64
...
#line 61
    sjt_dot520 = _parent;
#line 65
    sjt_math699 = (sjt_dot520)->m02;
#line 61
    sjt_dot521 = _parent;
#line 65
    sjt_math700 = (sjt_dot521)->m13;
#line 65
    sjt_math697 = sjt_math699 * sjt_math700;
#line 61
    sjt_dot522 = _parent;
#line 65
    sjt_math698 = (sjt_dot522)->m31;
#line 65
    sjt_math695 = sjt_math697 * sjt_math698;
#line 61
    sjt_dot523 = _parent;
#line 65
    sjt_math703 = (sjt_dot523)->m03;
#line 61
    sjt_dot524 = _parent;
#line 65
    sjt_math704 = (sjt_dot524)->m12;
#line 65
    sjt_math701 = sjt_math703 * sjt_math704;
#line 61
    sjt_dot525 = _parent;
#line 65
    sjt_math702 = (sjt_dot525)->m31;
#line 65
...
#line 61
    sjt_dot526 = _parent;
#line 65
    sjt_math707 = (sjt_dot526)->m03;
#line 61
    sjt_dot527 = _parent;
#line 65
    sjt_math708 = (sjt_dot527)->m11;
#line 65
    sjt_math705 = sjt_math707 * sjt_math708;
#line 61
    sjt_dot528 = _parent;
#line 65
    sjt_math706 = (sjt_dot528)->m32;
#line 65
...
#line 61
    sjt_dot529 = _parent;
#line 65
    sjt_math711 = (sjt_dot529)->m01;
#line 61
    sjt_dot530 = _parent;
#line 65
    sjt_math712 = (sjt_dot530)->m13;
#line 65
    sjt_math709 = sjt_math711 * sjt_math712;
#line 61
    sjt_dot531 = _parent;
#line 65
    sjt_math710 = (sjt_dot531)->m32;
#line 65
...
#line 61
    sjt_dot532 = _parent;
#line 65
    sjt_math715 = (sjt_dot532)->m02;
#line 61
    sjt_dot533 = _parent;
#line 65
    sjt_math716 = (sjt_dot533)->m11;
#line 65
    sjt_math713 = sjt_math715 * sjt_math716;
#line 61
    sjt_dot534 = _parent;
#line 65
    sjt_math714 = (sjt_dot534)->m33;
#line 65
...
#line 61
    sjt_dot535 = _parent;
#line 65
    sjt_math719 = (sjt_dot535)->m01;
#line 61
    sjt_dot536 = _parent;
#line 65
    sjt_math720 = (sjt_dot536)->m12;
#line 65
    sjt_math717 = sjt_math719 * sjt_math720;
#line 61
    sjt_dot537 = _parent;
#line 65
    sjt_math718 = (sjt_dot537)->m33;
#line 65
...
#line 61
    sjt_dot538 = _parent;
#line 66
    sjt_math733 = (sjt_dot538)->m03;
#line 61
    sjt_dot539 = _parent;
#line 66
    sjt_math734 = (sjt_dot539)->m12;
#line 66
    sjt_math731 = sjt_math733 * sjt_math734;
#line 61
    sjt_dot540 = _parent;
#line 66
    sjt_math732 = (sjt_dot540)->m21;
#line 66
    sjt_math729 = sjt_math731 * sjt_math732;
#line 61
    sjt_dot541 = _parent;
#line 66
    sjt_math737 = (sjt_dot541)->m02;
#line 61
    sjt_dot542 = _parent;
#line 66
    sjt_math738 = (sjt_dot542)->m13;
#line 66
    sjt_math735 = sjt_math737 * sjt_math738;
#line 61
    sjt_dot543 = _parent;
#line 66
    sjt_math736 = (sjt_dot543)->m21;
#line 66
...
#line 61
    sjt_dot544 = _parent;
#line 66
    sjt_math741 = (sjt_dot544)->m03;
#line 61
    sjt_dot545 = _parent;
#line 66
    sjt_math742 = (sjt_dot545)->m11;
#line 66
    sjt_math739 = sjt_math741 * sjt_math742;
#line 61
    sjt_dot546 = _parent;
#line 66
    sjt_math740 = (sjt_dot546)->m22;
#line 66
...
#line 61
    sjt_dot547 = _parent;
#line 66
    sjt_math745 = (sjt_dot547)->m01;
#line 61
    sjt_dot548 = _parent;
#line 66
    sjt_math746 = (sjt_dot548)->m13;
#line 66
    sjt_math743 = sjt_math745 * sjt_math746;
#line 61
    sjt_dot549 = _parent;
#line 66
    sjt_math744 = (sjt_dot549)->m22;
#line 66
...
#line 61
    sjt_dot550 = _parent;
#line 66
    sjt_math749 = (sjt_dot550)->m02;
#line 61
    sjt_dot551 = _parent;
#line 66
    sjt_math750 = (sjt_dot551)->m11;
#line 66
    sjt_math747 = sjt_math749 * sjt_math750;
#line 61
    sjt_dot552 = _parent;
#line 66
    sjt_math748 = (sjt_dot552)->m23;
#line 66
...
#line 61
    sjt_dot553 = _parent;
#line 66
    sjt_math753 = (sjt_dot553)->m01;
#line 61
    sjt_dot554 = _parent;
#line 66
    sjt_math754 = (sjt_dot554)->m12;
#line 66
    sjt_math751 = sjt_math753 * sjt_math754;
#line 61
    sjt_dot555 = _parent;
#line 66
    sjt_math752 = (sjt_dot555)->m23;
#line 66
...
#line 61
    sjt_dot556 = _parent;
#line 67
    sjt_math767 = (sjt_dot556)->m13;
#line 61
    sjt_dot557 = _parent;
#line 67
    sjt_math768 = (sjt_dot557)->m22;
#line 67
    sjt_math765 = sjt_math767 * sjt_math768;
#line 61
    sjt_dot558 = _parent;
#line 67
    sjt_math766 = (sjt_dot558)->m30;
#line 67
    sjt_math763 = sjt_math765 * sjt_math766;
#line 61
    sjt_dot559 = _parent;
#line 67
    sjt_math771 = (sjt_dot559)->m12;
#line 61
    sjt_dot560 = _parent;
#line 67
    sjt_math772 = (sjt_dot560)->m23;
#line 67
    sjt_math769 = sjt_math771 * sjt_math772;
#line 61
    sjt_dot561 = _parent;
#line 67
    sjt_math770 = (sjt_dot561)->m30;
#line 67
...
#line 61
    sjt_dot562 = _parent;
#line 67
    sjt_math775 = (sjt_dot562)->m13;
#line 61
    sjt_dot563 = _parent;
#line 67
    sjt_math776 = (sjt_dot563)->m20;
#line 67
    sjt_math773 = sjt_math775 * sjt_math776;
#line 61
    sjt_dot564 = _parent;
#line 67
    sjt_math774 = (sjt_dot564)->m32;
#line 67
...
#line 61
    sjt_dot565 = _parent;
#line 67
    sjt_math779 = (sjt_dot565)->m10;
#line 61
    sjt_dot566 = _parent;
#line 67
    sjt_math780 = (sjt_dot566)->m23;
#line 67
    sjt_math777 = sjt_math779 * sjt_math780;
#line 61
    sjt_dot567 = _parent;
#line 67
    sjt_math778 = (sjt_dot567)->m32;
#line 67
...
#line 61
    sjt_dot568 = _parent;
#line 67
    sjt_math783 = (sjt_dot568)->m12;
#line 61
    sjt_dot569 = _parent;
#line 67
    sjt_math784 = (sjt_dot569)->m20;
#line 67
    sjt_math781 = sjt_math783 * sjt_math784;
#line 61
    sjt_dot570 = _parent;
#line 67
    sjt_math782 = (sjt_dot570)->m33;
#line 67
...
#line 61
    sjt_dot571 = _parent;
#line 67
    sjt_math787 = (sjt_dot571)->m10;
#line 61
    sjt_dot572 = _parent;
#line 67
    sjt_math788 = (sjt_dot572)->m22;
#line 67
    sjt_math785 = sjt_math787 * sjt_math788;
#line 61
    sjt_dot573 = _parent;
#line 67
    sjt_math786 = (sjt_dot573)->m33;
#line 67
...
#line 61
    sjt_dot574 = _parent;
#line 68
    sjt_math801 = (sjt_dot574)->m02;
#line 61
    sjt_dot575 = _parent;
#line 68
    sjt_math802 = (sjt_dot575)->m23;
#line 68
    sjt_math799 = sjt_math801 * sjt_math802;
#line 61
    sjt_dot576 = _parent;
#line 68
    sjt_math800 = (sjt_dot576)->m30;
#line 68
    sjt_math797 = sjt_math799 * sjt_math800;
#line 61
    sjt_dot577 = _parent;
#line 68
    sjt_math805 = (sjt_dot577)->m03;
#line 61
    sjt_dot578 = _parent;
#line 68
    sjt_math806 = (sjt_dot578)->m22;
#line 68
    sjt_math803 = sjt_math805 * sjt_math806;
#line 61
    sjt_dot579 = _parent;
#line 68
    sjt_math804 = (sjt_dot579)->m30;
#line 68
...
#line 61
    sjt_dot580 = _parent;
#line 68
    sjt_math809 = (sjt_dot580)->m03;
#line 61
    sjt_dot581 = _parent;
#line 68
    sjt_math810 = (sjt_dot581)->m20;
#line 68
    sjt_math807 = sjt_math809 * sjt_math810;
#line 61
    sjt_dot582 = _parent;
#line 68
    sjt_math808 = (sjt_dot582)->m32;
#line 68
...
#line 61
    sjt_dot583 = _parent;
#line 68
    sjt_math813 = (sjt_dot583)->m00;
#line 61
    sjt_dot584 = _parent;
#line 68
    sjt_math814 = (sjt_dot584)->m23;
#line 68
    sjt_math811 = sjt_math813 * sjt_math814;
#line 61
    sjt_dot585 = _parent;
#line 68
    sjt_math812 = (sjt_dot585)->m32;
#line 68
...
#line 61
    sjt_dot586 = _parent;
#line 68
    sjt_math817 = (sjt_dot586)->m02;
#line 61
    sjt_dot587 = _parent;
#line 68
    sjt_math818 = (sjt_dot587)->m20;
#line 68
    sjt_math815 = sjt_math817 * sjt_math818;
#line 61
    sjt_dot588 = _parent;
#line 68
    sjt_math816 = (sjt_dot588)->m33;
#line 68
...
#line 61
    sjt_dot589 = _parent;
#line 68
    sjt_math821 = (sjt_dot589)->m00;
#line 61
    sjt_dot590 = _parent;
#line 68
    sjt_math822 = (sjt_dot590)->m22;
#line 68
    sjt_math819 = sjt_math821 * sjt_math822;
#line 61
    sjt_dot591 = _parent;
#line 68
    sjt_math820 = (sjt_dot591)->m33;
#line 68
...
#line 61
    sjt_dot592 = _parent;
#line 69
    sjt_math835 = (sjt_dot592)->m03;
#line 61
    sjt_dot593 = _parent;
#line 69
    sjt_math836 = (sjt_dot593)->m12;
#line 69
    sjt_math833 = sjt_math835 * sjt_math836;
#line 61
    sjt_dot594 = _parent;
#line 69
    sjt_math834 = (sjt_dot594)->m30;
#line 69
    sjt_math831 = sjt_math833 * sjt_math834;
#line 61
    sjt_dot595 = _parent;
#line 69
    sjt_math839 = (sjt_dot595)->m02;
#line 61
    sjt_dot596 = _parent;
#line 69
    sjt_math840 = (sjt_dot596)->m13;
#line 69
    sjt_math837 = sjt_math839 * sjt_math840;
#line 61
    sjt_dot597 = _parent;
#line 69
    sjt_math838 = (sjt_dot597)->m30;
#line 69
...
#line 61
    sjt_dot598 = _parent;
#line 69
    sjt_math843 = (sjt_dot598)->m03;
#line 61
    sjt_dot599 = _parent;
#line 69
    sjt_math844 = (sjt_dot599)->m10;
#line 69
    sjt_math841 = sjt_math843 * sjt_math844;
#line 61
    sjt_dot600 = _parent;
#line 69
    sjt_math842 = (sjt_dot600)->m32;
#line 69
...
#line 61
    sjt_dot601 = _parent;
#line 69
    sjt_math847 = (sjt_dot601)->m00;
#line 61
    sjt_dot602 = _parent;
#line 69
    sjt_math848 = (sjt_dot602)->m13;
#line 69
    sjt_math845 = sjt_math847 * sjt_math848;
#line 61
    sjt_dot603 = _parent;
#line 69
    sjt_math846 = (sjt_dot603)->m32;
#line 69
...
#line 61
    sjt_dot604 = _parent;
#line 69
    sjt_math851 = (sjt_dot604)->m02;
#line 61
    sjt_dot605 = _parent;
#line 69
    sjt_math852 = (sjt_dot605)->m10;
#line 69
    sjt_math849 = sjt_math851 * sjt_math852;
#line 61
    sjt_dot606 = _parent;
#line 69
    sjt_math850 = (sjt_dot606)->m33;
#line 69
...
#line 61
    sjt_dot607 = _parent;
#line 69
    sjt_math855 = (sjt_dot607)->m00;
#line 61
    sjt_dot608 = _parent;
#line 69
    sjt_math856 = (sjt_dot608)->m12;
#line 69
    sjt_math853 = sjt_math855 * sjt_math856;
#line 61
    sjt_dot609 = _parent;
#line 69
    sjt_math854 = (sjt_dot609)->m33;
#line 69
...
#line 61
    sjt_dot610 = _parent;
#line 70
    sjt_math869 = (sjt_dot610)->m02;
#line 61
    sjt_dot611 = _parent;
#line 70
    sjt_math870 = (sjt_dot611)->m13;
#line 70
    sjt_math867 = sjt_math869 * sjt_math870;
#line 61
    sjt_dot612 = _parent;
#line 70
    sjt_math868 = (sjt_dot612)->m20;
#line 70
    sjt_math865 = sjt_math867 * sjt_math868;
#line 61
    sjt_dot613 = _parent;
#line 70
    sjt_math873 = (sjt_dot613)->m03;
#line 61
    sjt_dot614 = _parent;
#line 70
    sjt_math874 = (sjt_dot614)->m12;
#line 70
    sjt_math871 = sjt_math873 * sjt_math874;
#line 61
    sjt_dot615 = _parent;
#line 70
    sjt_math872 = (sjt_dot615)->m20;
#line 70
...
#line 61
    sjt_dot616 = _parent;
#line 70
    sjt_math877 = (sjt_dot616)->m03;
#line 61
    sjt_dot617 = _parent;
#line 70
    sjt_math878 = (sjt_dot617)->m10;
#line 70
    sjt_math875 = sjt_math877 * sjt_math878;
#line 61
    sjt_dot618 = _parent;
#line 70
    sjt_math876 = (sjt_dot618)->m22;
#line 70
...
#line 61
    sjt_dot619 = _parent;
#line 70
    sjt_math881 = (sjt_dot619)->m00;
#line 61
    sjt_dot620 = _parent;
#line 70
    sjt_math882 = (sjt_dot620)->m13;
#line 70
    sjt_math879 = sjt_math881 * sjt_math882;
#line 61
    sjt_dot621 = _parent;
#line 70
    sjt_math880 = (sjt_dot621)->m22;
#line 70
...
#line 61
    sjt_dot622 = _parent;
#line 70
    sjt_math885 = (sjt_dot622)->m02;
#line 61
    sjt_dot623 = _parent;
#line 70
    sjt_math886 = (sjt_dot623)->m10;
#line 70
    sjt_math883 = sjt_math885 * sjt_math886;
#line 61
    sjt_dot624 = _parent;
#line 70
    sjt_math884 = (sjt_dot624)->m23;
#line 70
...
#line 61
    sjt_dot625 = _parent;
#line 70
    sjt_math889 = (sjt_dot625)->m00;
#line 61
    sjt_dot626 = _parent;
#line 70
    sjt_math890 = (sjt_dot626)->m12;
#line 70
    sjt_math887 = sjt_math889 * sjt_math890;
#line 61
    sjt_dot627 = _parent;
#line 70
    sjt_math888 = (sjt_dot627)->m23;
#line 70
...
#line 61
    sjt_dot628 = _parent;
#line 71
    sjt_math903 = (sjt_dot628)->m11;
#line 61
    sjt_dot629 = _parent;
#line 71
    sjt_math904 = (sjt_dot629)->m23;
#line 71
    sjt_math901 = sjt_math903 * sjt_math904;
#line 61
    sjt_dot630 = _parent;
#line 71
    sjt_math902 = (sjt_dot630)->m30;
#line 71
    sjt_math899 = sjt_math901 * sjt_math902;
#line 61
    sjt_dot631 = _parent;
#line 71
    sjt_math907 = (sjt_dot631)->m13;
#line 61
    sjt_dot632 = _parent;
#line 71
    sjt_math908 = (sjt_dot632)->m21;
#line 71
    sjt_math905 = sjt_math907 * sjt_math908;
#line 61
    sjt_dot633 = _parent;
#line 71
    sjt_math906 = (sjt_dot633)->m30;
#line 71
...
#line 61
    sjt_dot634 = _parent;
#line 71
    sjt_math911 = (sjt_dot634)->m13;
#line 61
    sjt_dot635 = _parent;
#line 71
    sjt_math912 = (sjt_dot635)->m20;
#line 71
    sjt_math909 = sjt_math911 * sjt_math912;
#line 61
    sjt_dot636 = _parent;
#line 71
    sjt_math910 = (sjt_dot636)->m31;
#line 71
...
#line 61
    sjt_dot637 = _parent;
#line 71
    sjt_math915 = (sjt_dot637)->m10;
#line 61
    sjt_dot638 = _parent;
#line 71
    sjt_math916 = (sjt_dot638)->m23;
#line 71
    sjt_math913 = sjt_math915 * sjt_math916;
#line 61
    sjt_dot639 = _parent;
#line 71
    sjt_math914 = (sjt_dot639)->m31;
#line 71
...
#line 61
    sjt_dot640 = _parent;
#line 71
    sjt_math919 = (sjt_dot640)->m11;
#line 61
    sjt_dot641 = _parent;
#line 71
    sjt_math920 = (sjt_dot641)->m20;
#line 71
    sjt_math917 = sjt_math919 * sjt_math920;
#line 61
    sjt_dot642 = _parent;
#line 71
    sjt_math918 = (sjt_dot642)->m33;
#line 71
...
#line 61
    sjt_dot643 = _parent;
#line 71
    sjt_math923 = (sjt_dot643)->m10;
#line 61
    sjt_dot644 = _parent;
#line 71
    sjt_math924 = (sjt_dot644)->m21;
#line 71
    sjt_math921 = sjt_math923 * sjt_math924;
#line 61
    sjt_dot645 = _parent;
#line 71
    sjt_math922 = (sjt_dot645)->m33;
#line 71
...
#line 61
    sjt_dot646 = _parent;
#line 72
    sjt_math937 = (sjt_dot646)->m03;
#line 61
    sjt_dot647 = _parent;
#line 72
    sjt_math938 = (sjt_dot647)->m21;
#line 72
    sjt_math935 = sjt_math937 * sjt_math938;
#line 61
    sjt_dot648 = _parent;
#line 72
    sjt_math936 = (sjt_dot648)->m30;
#line 72
    sjt_math933 = sjt_math935 * sjt_math936;
#line 61
    sjt_dot649 = _parent;
#line 72
    sjt_math941 = (sjt_dot649)->m01;
#line 61
    sjt_dot650 = _parent;
#line 72
    sjt_math942 = (sjt_dot650)->m23;
#line 72
    sjt_math939 = sjt_math941 * sjt_math942;
#line 61
    sjt_dot651 = _parent;
#line 72
    sjt_math940 = (sjt_dot651)->m30;
#line 72
...
#line 61
    sjt_dot652 = _parent;
#line 72
    sjt_math945 = (sjt_dot652)->m03;
#line 61
    sjt_dot653 = _parent;
#line 72
    sjt_math946 = (sjt_dot653)->m20;
#line 72
    sjt_math943 = sjt_math945 * sjt_math946;
#line 61
    sjt_dot654 = _parent;
#line 72
    sjt_math944 = (sjt_dot654)->m31;
#line 72
...
#line 61
    sjt_dot655 = _parent;
#line 72
    sjt_math949 = (sjt_dot655)->m00;
#line 61
    sjt_dot656 = _parent;
#line 72
    sjt_math950 = (sjt_dot656)->m23;
#line 72
    sjt_math947 = sjt_math949 * sjt_math950;
#line 61
    sjt_dot657 = _parent;
#line 72
    sjt_math948 = (sjt_dot657)->m31;
#line 72
...
#line 61
    sjt_dot658 = _parent;
#line 72
    sjt_math953 = (sjt_dot658)->m01;
#line 61
    sjt_dot659 = _parent;
#line 72
    sjt_math954 = (sjt_dot659)->m20;
#line 72
    sjt_math951 = sjt_math953 * sjt_math954;
#line 61
    sjt_dot660 = _parent;
#line 72
    sjt_math952 = (sjt_dot660)->m33;
#line 72
...
#line 61
    sjt_dot661 = _parent;
#line 72
    sjt_math957 = (sjt_dot661)->m00;
#line 61
    sjt_dot662 = _parent;
#line 72
    sjt_math958 = (sjt_dot662)->m21;
#line 72
    sjt_math955 = sjt_math957 * sjt_math958;
#line 61
    sjt_dot663 = _parent;
#line 72
    sjt_math956 = (sjt_dot663)->m33;
#line 72
...
#line 61
    sjt_dot664 = _parent;
#line 73
    sjt_math971 = (sjt_dot664)->m01;
#line 61
    sjt_dot665 = _parent;
#line 73
    sjt_math972 = (sjt_dot665)->m13;
#line 73
    sjt_math969 = sjt_math971 * sjt_math972;
#line 61
    sjt_dot666 = _parent;
#line 73
    sjt_math970 = (sjt_dot666)->m30;
#line 73
    sjt_math967 = sjt_math969 * sjt_math970;
#line 61
    sjt_dot667 = _parent;
#line 73
    sjt_math975 = (sjt_dot667)->m03;
#line 61
    sjt_dot668 = _parent;
#line 73
    sjt_math976 = (sjt_dot668)->m11;
#line 73
    sjt_math973 = sjt_math975 * sjt_math976;
#line 61
    sjt_dot669 = _parent;
#line 73
    sjt_math974 = (sjt_dot669)->m30;
#line 73
...
#line 61
    sjt_dot670 = _parent;
#line 73
    sjt_math979 = (sjt_dot670)->m03;
#line 61
    sjt_dot671 = _parent;
#line 73
    sjt_math980 = (sjt_dot671)->m10;
#line 73
    sjt_math977 = sjt_math979 * sjt_math980;
#line 61
    sjt_dot672 = _parent;
#line 73
    sjt_math978 = (sjt_dot672)->m31;
#line 73
...
#line 61
    sjt_dot673 = _parent;
#line 73
    sjt_math983 = (sjt_dot673)->m00;
#line 61
    sjt_dot674 = _parent;
#line 73
    sjt_math984 = (sjt_dot674)->m13;
#line 73
    sjt_math981 = sjt_math983 * sjt_math984;
#line 61
    sjt_dot675 = _parent;
#line 73
    sjt_math982 = (sjt_dot675)->m31;
#line 73
...
#line 61
    sjt_dot676 = _parent;
#line 73
    sjt_math987 = (sjt_dot676)->m01;
#line 61
    sjt_dot677 = _parent;
#line 73
    sjt_math988 = (sjt_dot677)->m10;
#line 73
    sjt_math985 = sjt_math987 * sjt_math988;
#line 61
    sjt_dot678 = _parent;
#line 73
    sjt_math986 = (sjt_dot678)->m33;
#line 73
...
#line 61
    sjt_dot679 = _parent;
#line 73
    sjt_math991 = (sjt_dot679)->m00;
#line 61
    sjt_dot680 = _parent;
#line 73
    sjt_math992 = (sjt_dot680)->m11;
#line 73
    sjt_math989 = sjt_math991 * sjt_math992;
#line 61
    sjt_dot681 = _parent;
#line 73
    sjt_math990 = (sjt_dot681)->m33;
#line 73
...
#line 61
    sjt_dot682 = _parent;
#line 74
    sjt_math1005 = (sjt_dot682)->m03;
#line 61
    sjt_dot683 = _parent;
#line 74
    sjt_math1006 = (sjt_dot683)->m11;
#line 74
    sjt_math1003 = sjt_math1005 * sjt_math1006;
#line 61
    sjt_dot684 = _parent;
#line 74
    sjt_math1004 = (sjt_dot684)->m20;
#line 74
    sjt_math1001 = sjt_math1003 * sjt_math1004;
#line 61
    sjt_dot685 = _parent;
#line 74
    sjt_math1009 = (sjt_dot685)->m01;
#line 61
    sjt_dot686 = _parent;
#line 74
    sjt_math1010 = (sjt_dot686)->m13;
#line 74
    sjt_math1007 = sjt_math1009 * sjt_math1010;
#line 61
    sjt_dot687 = _parent;
#line 74
    sjt_math1008 = (sjt_dot687)->m20;
#line 74
...
#line 61
    sjt_dot688 = _parent;
#line 74
    sjt_math1013 = (sjt_dot688)->m03;
#line 61
    sjt_dot689 = _parent;
#line 74
    sjt_math1014 = (sjt_dot689)->m10;
#line 74
    sjt_math1011 = sjt_math1013 * sjt_math1014;
#line 61
    sjt_dot690 = _parent;
#line 74
    sjt_math1012 = (sjt_dot690)->m21;
#line 74
...
#line 61
    sjt_dot691 = _parent;
#line 74
    sjt_math1017 = (sjt_dot691)->m00;
#line 61
    sjt_dot692 = _parent;
#line 74
    sjt_math1018 = (sjt_dot692)->m13;
#line 74
    sjt_math1015 = sjt_math1017 * sjt_math1018;
#line 61
    sjt_dot693 = _parent;
#line 74
    sjt_math1016 = (sjt_dot693)->m21;
#line 74
...
#line 61
    sjt_dot694 = _parent;
#line 74
    sjt_math1021 = (sjt_dot694)->m01;
#line 61
    sjt_dot695 = _parent;
#line 74
    sjt_math1022 = (sjt_dot695)->m10;
#line 74
    sjt_math1019 = sjt_math1021 * sjt_math1022;
#line 61
    sjt_dot696 = _parent;
#line 74
    sjt_math1020 = (sjt_dot696)->m23;
#line 74
...
#line 61
    sjt_dot697 = _parent;
#line 74
    sjt_math1025 = (sjt_dot697)->m00;
#line 61
    sjt_dot698 = _parent;
#line 74
    sjt_math1026 = (sjt_dot698)->m11;
#line 74
    sjt_math1023 = sjt_math1025 * sjt_math1026;
#line 61
    sjt_dot699 = _parent;
#line 74
    sjt_math1024 = (sjt_dot699)->m23;
#line 74
...
#line 61
    sjt_dot700 = _parent;
#line 75
    sjt_math1039 = (sjt_dot700)->m12;
#line 61
    sjt_dot701 = _parent;
#line 75
    sjt_math1040 = (sjt_dot701)->m21;
#line 75
    sjt_math1037 = sjt_math1039 * sjt_math1040;
#line 61
    sjt_dot702 = _parent;
#line 75
    sjt_math1038 = (sjt_dot702)->m30;
#line 75
    sjt_math1035 = sjt_math1037 * sjt_math1038;
#line 61
    sjt_dot703 = _parent;
#line 75
    sjt_math1043 = (sjt_dot703)->m11;
#line 61
    sjt_dot704 = _parent;
#line 75
    sjt_math1044 = (sjt_dot704)->m22;
#line 75
    sjt_math1041 = sjt_math1043 * sjt_math1044;
#line 61
    sjt_dot705 = _parent;
#line 75
    sjt_math1042 = (sjt_dot705)->m30;
#line 75
...
#line 61
    sjt_dot706 = _parent;
#line 75
    sjt_math1047 = (sjt_dot706)->m12;
#line 61
    sjt_dot707 = _parent;
#line 75
    sjt_math1048 = (sjt_dot707)->m20;
#line 75
    sjt_math1045 = sjt_math1047 * sjt_math1048;
#line 61
    sjt_dot708 = _parent;
#line 75
    sjt_math1046 = (sjt_dot708)->m31;
#line 75
...
#line 61
    sjt_dot709 = _parent;
#line 75
    sjt_math1051 = (sjt_dot709)->m10;
#line 61
    sjt_dot710 = _parent;
#line 75
    sjt_math1052 = (sjt_dot710)->m22;
#line 75
    sjt_math1049 = sjt_math1051 * sjt_math1052;
#line 61
    sjt_dot711 = _parent;
#line 75
    sjt_math1050 = (sjt_dot711)->m31;
#line 75
...
#line 61
    sjt_dot712 = _parent;
#line 75
    sjt_math1055 = (sjt_dot712)->m11;
#line 61
    sjt_dot713 = _parent;
#line 75
    sjt_math1056 = (sjt_dot713)->m20;
#line 75
    sjt_math1053 = sjt_math1055 * sjt_math1056;
#line 61
    sjt_dot714 = _parent;
#line 75
    sjt_math1054 = (sjt_dot714)->m32;
#line 75
...
#line 61
    sjt_dot715 = _parent;
#line 75
    sjt_math1059 = (sjt_dot715)->m10;
#line 61
    sjt_dot716 = _parent;
#line 75
    sjt_math1060 = (sjt_dot716)->m21;
#line 75
    sjt_math1057 = sjt_math1059 * sjt_math1060;
#line 61
    sjt_dot717 = _parent;
#line 75
    sjt_math1058 = (sjt_dot717)->m32;
#line 75
...
#line 61
    sjt_dot718 = _parent;
#line 76
    sjt_math1073 = (sjt_dot718)->m01;
#line 61
    sjt_dot719 = _parent;
#line 76
    sjt_math1074 = (sjt_dot719)->m22;
#line 76
    sjt_math1071 = sjt_math1073 * sjt_math1074;
#line 61
    sjt_dot720 = _parent;
#line 76
    sjt_math1072 = (sjt_dot720)->m30;
#line 76
    sjt_math1069 = sjt_math1071 * sjt_math1072;
#line 61
    sjt_dot721 = _parent;
#line 76
    sjt_math1077 = (sjt_dot721)->m02;
#line 61
    sjt_dot722 = _parent;
#line 76
    sjt_math1078 = (sjt_dot722)->m21;
#line 76
    sjt_math1075 = sjt_math1077 * sjt_math1078;
#line 61
    sjt_dot723 = _parent;
#line 76
    sjt_math1076 = (sjt_dot723)->m30;
#line 76
...
#line 61
    sjt_dot724 = _parent;
#line 76
    sjt_math1081 = (sjt_dot724)->m02;
#line 61
    sjt_dot725 = _parent;
#line 76
    sjt_math1082 = (sjt_dot725)->m20;
#line 76
    sjt_math1079 = sjt_math1081 * sjt_math1082;
#line 61
    sjt_dot726 = _parent;
#line 76
    sjt_math1080 = (sjt_dot726)->m31;
#line 76
...
#line 61
    sjt_dot727 = _parent;
#line 76
    sjt_math1085 = (sjt_dot727)->m00;
#line 61
    sjt_dot728 = _parent;
#line 76
    sjt_math1086 = (sjt_dot728)->m22;
#line 76
    sjt_math1083 = sjt_math1085 * sjt_math1086;
#line 61
    sjt_dot729 = _parent;
#line 76
    sjt_math1084 = (sjt_dot729)->m31;
#line 76
...
#line 61
    sjt_dot730 = _parent;
#line 76
    sjt_math1089 = (sjt_dot730)->m01;
#line 61
    sjt_dot731 = _parent;
#line 76
    sjt_math1090 = (sjt_dot731)->m20;
#line 76
    sjt_math1087 = sjt_math1089 * sjt_math1090;
#line 61
    sjt_dot732 = _parent;
#line 76
    sjt_math1088 = (sjt_dot732)->m32;
#line 76
...
#line 61
    sjt_dot733 = _parent;
#line 76
    sjt_math1093 = (sjt_dot733)->m00;
#line 61
    sjt_dot734 = _parent;
#line 76
    sjt_math1094 = (sjt_dot734)->m21;
#line 76
    sjt_math1091 = sjt_math1093 * sjt_math1094;
#line 61
    sjt_dot735 = _parent;
#line 76
    sjt_math1092 = (sjt_dot735)->m32;
#line 76
...
#line 61
    sjt_dot736 = _parent;
#line 77
    sjt_math1107 = (sjt_dot736)->m02;
#line 61
    sjt_dot737 = _parent;
#line 77
    sjt_math1108 = (sjt_dot737)->m11;
#line 77
    sjt_math1105 = sjt_math1107 * sjt_math1108;
#line 61
    sjt_dot738 = _parent;
#line 77
    sjt_math1106 = (sjt_dot738)->m30;
#line 77
    sjt_math1103 = sjt_math1105 * sjt_math1106;
#line 61
    sjt_dot739 = _parent;
#line 77
    sjt_math1111 = (sjt_dot739)->m01;
#line 61
    sjt_dot740 = _parent;
#line 77
    sjt_math1112 = (sjt_dot740)->m12;
#line 77
    sjt_math1109 = sjt_math1111 * sjt_math1112;
#line 61
    sjt_dot741 = _parent;
#line 77
    sjt_math1110 = (sjt_dot741)->m30;
#line 77
...
#line 61
    sjt_dot742 = _parent;
#line 77
    sjt_math1115 = (sjt_dot742)->m02;
#line 61
    sjt_dot743 = _parent;
#line 77
    sjt_math1116 = (sjt_dot743)->m10;
#line 77
    sjt_math1113 = sjt_math1115 * sjt_math1116;
#line 61
    sjt_dot744 = _parent;
#line 77
    sjt_math1114 = (sjt_dot744)->m31;
#line 77
...
#line 61
    sjt_dot745 = _parent;
#line 77
    sjt_math1119 = (sjt_dot745)->m00;
#line 61
    sjt_dot746 = _parent;
#line 77
    sjt_math1120 = (sjt_dot746)->m12;
#line 77
    sjt_math1117 = sjt_math1119 * sjt_math1120;
#line 61
    sjt_dot747 = _parent;
#line 77
    sjt_math1118 = (sjt_dot747)->m31;
#line 77
...
#line 61
    sjt_dot748 = _parent;
#line 77
    sjt_math1123 = (sjt_dot748)->m01;
#line 61
    sjt_dot749 = _parent;
#line 77
    sjt_math1124 = (sjt_dot749)->m10;
#line 77
    sjt_math1121 = sjt_math1123 * sjt_math1124;
#line 61
    sjt_dot750 = _parent;
#line 77
    sjt_math1122 = (sjt_dot750)->m32;
#line 77
...
#line 61
    sjt_dot751 = _parent;
#line 77
    sjt_math1127 = (sjt_dot751)->m00;
#line 61
    sjt_dot752 = _parent;
#line 77
    sjt_math1128 = (sjt_dot752)->m11;
#line 77
    sjt_math1125 = sjt_math1127 * sjt_math1128;
#line 61
    sjt_dot753 = _parent;
#line 77
    sjt_math1126 = (sjt_dot753)->m32;
#line 77
...
#line 61
    sjt_dot754 = _parent;
#line 78
    sjt_math1141 = (sjt_dot754)->m01;
#line 61
    sjt_dot755 = _parent;
#line 78
    sjt_math1142 = (sjt_dot755)->m12;
#line 78
    sjt_math1139 = sjt_math1141 * sjt_math1142;
#line 61
    sjt_dot756 = _parent;
#line 78
    sjt_math1140 = (sjt_dot756)->m20;
#line 78
    sjt_math1137 = sjt_math1139 * sjt_math1140;
#line 61
    sjt_dot757 = _parent;
#line 78
    sjt_math1145 = (sjt_dot757)->m02;
#line 61
    sjt_dot758 = _parent;
#line 78
    sjt_math1146 = (sjt_dot758)->m11;
#line 78
    sjt_math1143 = sjt_math1145 * sjt_math1146;
#line 61
    sjt_dot759 = _parent;
#line 78
    sjt_math1144 = (sjt_dot759)->m20;
#line 78
...
#line 61
    sjt_dot760 = _parent;
#line 78
    sjt_math1149 = (sjt_dot760)->m02;
#line 61
    sjt_dot761 = _parent;
#line 78
    sjt_math1150 = (sjt_dot761)->m10;
#line 78
    sjt_math1147 = sjt_math1149 * sjt_math1150;
#line 61
    sjt_dot762 = _parent;
#line 78
    sjt_math1148 = (sjt_dot762)->m21;
#line 78
...
#line 61
    sjt_dot763 = _parent;
#line 78
    sjt_math1153 = (sjt_dot763)->m00;
#line 61
    sjt_dot764 = _parent;
#line 78
    sjt_math1154 = (sjt_dot764)->m12;
#line 78
    sjt_math1151 = sjt_math1153 * sjt_math1154;
#line 61
    sjt_dot765 = _parent;
#line 78
    sjt_math1152 = (sjt_dot765)->m21;
#line 78
...
#line 61
    sjt_dot766 = _parent;
#line 78
    sjt_math1157 = (sjt_dot766)->m01;
#line 61
    sjt_dot767 = _parent;
#line 78
    sjt_math1158 = (sjt_dot767)->m10;
#line 78
    sjt_math1155 = sjt_math1157 * sjt_math1158;
#line 61
    sjt_dot768 = _parent;
#line 78
    sjt_math1156 = (sjt_dot768)->m22;
#line 78
...
#line 61
    sjt_dot769 = _parent;
#line 78
    sjt_math1161 = (sjt_dot769)->m00;
#line 61
    sjt_dot770 = _parent;
#line 78
    sjt_math1162 = (sjt_dot770)->m11;
#line 78
    sjt_math1159 = sjt_math1161 * sjt_math1162;
#line 61
    sjt_dot771 = _parent;
#line 78
    sjt_math1160 = (sjt_dot771)->m22;
#line 78
...
#line 61 "lib/ui/mat4.sj"
    sjt_dot900 = _parent;
#line 63
    sjt_math1431 = (sjt_dot900)->m12;
#line 61
    sjt_dot901 = _parent;
#line 63
    sjt_math1432 = (sjt_dot901)->m23;
#line 63
    sjt_math1429 = sjt_math1431 * sjt_math1432;
#line 61
    sjt_dot902 = _parent;
#line 63
    sjt_math1430 = (sjt_dot902)->m31;
#line 63
    sjt_math1427 = sjt_math1429 * sjt_math1430;
#line 61
    sjt_dot903 = _parent;
#line 63
    sjt_math1435 = (sjt_dot903)->m13;
#line 61
    sjt_dot904 = _parent;
#line 63
    sjt_math1436 = (sjt_dot904)->m22;
#line 63
    sjt_math1433 = sjt_math1435 * sjt_math1436;
#line 61
    sjt_dot905 = _parent;
#line 63
    sjt_math1434 = (sjt_dot905)->m31;
#line 63
...
#line 61
    sjt_dot906 = _parent;
#line 63
    sjt_math1439 = (sjt_dot906)->m13;
#line 61
    sjt_dot907 = _parent;
#line 63
    sjt_math1440 = (sjt_dot907)->m21;
#line 63
    sjt_math1437 = sjt_math1439 * sjt_math1440;
#line 61
    sjt_dot908 = _parent;
#line 63
    sjt_math1438 = (sjt_dot908)->m32;
#line 63
...
#line 61
    sjt_dot909 = _parent;
#line 63
    sjt_math1443 = (sjt_dot909)->m11;
#line 61
    sjt_dot910 = _parent;
#line 63
    sjt_math1444 = (sjt_dot910)->m23;
#line 63
    sjt_math1441 = sjt_math1443 * sjt_math1444;
#line 61
    sjt_dot911 = _parent;
#line 63
    sjt_math1442 = (sjt_dot911)->m32;
#line 63
...
#line 61
    sjt_dot912 = _parent;
#line 63
    sjt_math1447 = (sjt_dot912)->m12;
#line 61
    sjt_dot913 = _parent;
#line 63
    sjt_math1448 = (sjt_dot913)->m21;
#line 63
    sjt_math1445 = sjt_math1447 * sjt_math1448;
#line 61
    sjt_dot914 = _parent;
#line 63
    sjt_math1446 = (sjt_dot914)->m33;
#line 63
...
#line 61
    sjt_dot915 = _parent;
#line 63
    sjt_math1451 = (sjt_dot915)->m11;
#line 61
    sjt_dot916 = _parent;
#line 63
    sjt_math1452 = (sjt_dot916)->m22;
#line 63
    sjt_math1449 = sjt_math1451 * sjt_math1452;
#line 61
    sjt_dot917 = _parent;
#line 63
    sjt_math1450 = (sjt_dot917)->m33;
#line 63
...
#line 61
    sjt_dot918 = _parent;
#line 64
    sjt_math1465 = (sjt_dot918)->m03;
#line 61
    sjt_dot919 = _parent;
#line 64
    sjt_math1466 = (sjt_dot919)->m22;
#line 64
    sjt_math1463 = sjt_math1465 * sjt_math1466;
#line 61
    sjt_dot920 = _parent;
#line 64
    sjt_math1464 = (sjt_dot920)->m31;
#line 64
    sjt_math1461 = sjt_math1463 * sjt_math1464;
#line 61
    sjt_dot921 = _parent;
#line 64
    sjt_math1469 = (sjt_dot921)->m02;
#line 61
    sjt_dot922 = _parent;
#line 64
    sjt_math1470 = (sjt_dot922)->m23;
#line 64
    sjt_math1467 = sjt_math1469 * sjt_math1470;
#line 61
    sjt_dot923 = _parent;
#line 64
    sjt_math1468 = (sjt_dot923)->m31;
#line 64
...
#line 61
    sjt_dot924 = _parent;
#line 64
    sjt_math1473 = (sjt_dot924)->m03;
#line 61
    sjt_dot925 = _parent;
#line 64
    sjt_math1474 = (sjt_dot925)->m21;
#line 64
    sjt_math1471 = sjt_math1473 * sjt_math1474;
#line 61
    sjt_dot926 = _parent;
#line 64
    sjt_math1472 = (sjt_dot926)->m32;
#line 64
...
#line 61
    sjt_dot927 = _parent;
#line 64
    sjt_math1477 = (sjt_dot927)->m01;
#line 61
    sjt_dot928 = _parent;
#line 64
    sjt_math1478 = (sjt_dot928)->m23;
#line 64
    sjt_math1475 = sjt_math1477 * sjt_math1478;
#line 61
    sjt_dot929 = _parent;
#line 64
    sjt_math1476 = (sjt_dot929)->m32;
#line 64
...
#line 61
    sjt_dot930 = _parent;
#line 64
    sjt_math1481 = (sjt_dot930)->m02;
#line 61
    sjt_dot931 = _parent;
#line 64
    sjt_math1482 = (sjt_dot931)->m21;
#line 64
    sjt_math1479 = sjt_math1481 * sjt_math1482;
#line 61
    sjt_dot932 = _parent;
#line 64
    sjt_math1480 = (sjt_dot932)->m33;
#line 64
...
#line 61
    sjt_dot933 = _parent;
#line 64
    sjt_math1485 = (sjt_dot933)->m01;
#line 61
    sjt_dot934 = _parent;
#line 64
    sjt_math1486 = (sjt_dot934)->m22;
#line 64
    sjt_math1483 = sjt_math1485 * sjt_math1486;
#line 61
    sjt_dot935 = _parent;
#line 64
    sjt_math1484 = (sjt_dot935)->m33;
#line 64
...
#line 61
    sjt_dot936 = _parent;
#line 65
    sjt_math1499 = (sjt_dot936)->m02;
#line 61
    sjt_dot937 = _parent;
#line 65
    sjt_math1500 = (sjt_dot937)->m13;
#line 65
    sjt_math1497 = sjt_math1499 * sjt_math1500;
#line 61
    sjt_dot938 = _parent;
#line 65
    sjt_math1498 = (sjt_dot938)->m31;
#line 65
    sjt_math1495 = sjt_math1497 * sjt_math1498;
#line 61
    sjt_dot939 = _parent;
#line 65
    sjt_math1503 = (sjt_dot939)->m03;
#line 61
    sjt_dot940 = _parent;
#line 65
    sjt_math1504 = (sjt_dot940)->m12;
#line 65
    sjt_math1501 = sjt_math1503 * sjt_math1504;
#line 61
    sjt_dot941 = _parent;
#line 65
    sjt_math1502 = (sjt_dot941)->m31;
#line 65
...
#line 61
    sjt_dot942 = _parent;
#line 65
    sjt_math1507 = (sjt_dot942)->m03;
#line 61
    sjt_dot943 = _parent;
#line 65
    sjt_math1508 = (sjt_dot943)->m11;
#line 65
    sjt_math1505 = sjt_math1507 * sjt_math1508;
#line 61
    sjt_dot944 = _parent;
#line 65
    sjt_math1506 = (sjt_dot944)->m32;
#line 65
...
#line 61
    sjt_dot945 = _parent;
#line 65
    sjt_math1511 = (sjt_dot945)->m01;
#line 61
    sjt_dot946 = _parent;
#line 65
    sjt_math1512 = (sjt_dot946)->m13;
#line 65
    sjt_math1509 = sjt_math1511 * sjt_math1512;
#line 61
    sjt_dot947 = _parent;
#line 65
    sjt_math1510 = (sjt_dot947)->m32;
#line 65
...
#line 61
    sjt_dot948 = _parent;
#line 65
    sjt_math1515 = (sjt_dot948)->m02;
#line 61
    sjt_dot949 = _parent;
#line 65
    sjt_math1516 = (sjt_dot949)->m11;
#line 65
    sjt_math1513 = sjt_math1515 * sjt_math1516;
#line 61
    sjt_dot950 = _parent;
#line 65
    sjt_math1514 = (sjt_dot950)->m33;
#line 65
...
#line 61
    sjt_dot951 = _parent;
#line 65
    sjt_math1519 = (sjt_dot951)->m01;
#line 61
    sjt_dot952 = _parent;
#line 65
    sjt_math1520 = (sjt_dot952)->m12;
#line 65
    sjt_math1517 = sjt_math1519 * sjt_math1520;
#line 61
    sjt_dot953 = _parent;
#line 65
    sjt_math1518 = (sjt_dot953)->m33;
#line 65
...
#line 61
    sjt_dot954 = _parent;
#line 66
    sjt_math1533 = (sjt_dot954)->m03;
#line 61
    sjt_dot955 = _parent;
#line 66
    sjt_math1534 = (sjt_dot955)->m12;
#line 66
    sjt_math1531 = sjt_math1533 * sjt_math1534;
#line 61
    sjt_dot956 = _parent;
#line 66
    sjt_math1532 = (sjt_dot956)->m21;
#line 66
    sjt_math1529 = sjt_math1531 * sjt_math1532;
#line 61
    sjt_dot957 = _parent;
#line 66
    sjt_math1537 = (sjt_dot957)->m02;
#line 61
    sjt_dot958 = _parent;
#line 66
    sjt_math1538 = (sjt_dot958)->m13;
#line 66
    sjt_math1535 = sjt_math1537 * sjt_math1538;
#line 61
    sjt_dot959 = _parent;
#line 66
    sjt_math1536 = (sjt_dot959)->m21;
#line 66
...
#line 61
    sjt_dot960 = _parent;
#line 66
    sjt_math1541 = (sjt_dot960)->m03;
#line 61
    sjt_dot961 = _parent;
#line 66
    sjt_math1542 = (sjt_dot961)->m11;
#line 66
    sjt_math1539 = sjt_math1541 * sjt_math1542;
#line 61
    sjt_dot962 = _parent;
#line 66
    sjt_math1540 = (sjt_dot962)->m22;
#line 66
...
#line 61
    sjt_dot963 = _parent;
#line 66
    sjt_math1545 = (sjt_dot963)->m01;
#line 61
    sjt_dot964 = _parent;
#line 66
    sjt_math1546 = (sjt_dot964)->m13;
#line 66
    sjt_math1543 = sjt_math1545 * sjt_math1546;
#line 61
    sjt_dot965 = _parent;
#line 66
    sjt_math1544 = (sjt_dot965)->m22;
#line 66
...
#line 61
    sjt_dot966 = _parent;
#line 66
    sjt_math1549 = (sjt_dot966)->m02;
#line 61
    sjt_dot967 = _parent;
#line 66
    sjt_math1550 = (sjt_dot967)->m11;
#line 66
    sjt_math1547 = sjt_math1549 * sjt_math1550;
#line 61
    sjt_dot968 = _parent;
#line 66
    sjt_math1548 = (sjt_dot968)->m23;
#line 66
...
#line 61
    sjt_dot969 = _parent;
#line 66
    sjt_math1553 = (sjt_dot969)->m01;
#line 61
    sjt_dot970 = _parent;
#line 66
    sjt_math1554 = (sjt_dot970)->m12;
#line 66
    sjt_math1551 = sjt_math1553 * sjt_math1554;
#line 61
    sjt_dot971 = _parent;
#line 66
    sjt_math1552 = (sjt_dot971)->m23;
#line 66
...
#line 61
    sjt_dot972 = _parent;
#line 67
    sjt_math1567 = (sjt_dot972)->m13;
#line 61
    sjt_dot973 = _parent;
#line 67
    sjt_math1568 = (sjt_dot973)->m22;
#line 67
    sjt_math1565 = sjt_math1567 * sjt_math1568;
#line 61
    sjt_dot974 = _parent;
#line 67
    sjt_math1566 = (sjt_dot974)->m30;
#line 67
    sjt_math1563 = sjt_math1565 * sjt_math1566;
#line 61
    sjt_dot975 = _parent;
#line 67
    sjt_math1571 = (sjt_dot975)->m12;
#line 61
    sjt_dot976 = _parent;
#line 67
    sjt_math1572 = (sjt_dot976)->m23;
#line 67
    sjt_math1569 = sjt_math1571 * sjt_math1572;
#line 61
    sjt_dot977 = _parent;
#line 67
    sjt_math1570 = (sjt_dot977)->m30;
#line 67
...
#line 61
    sjt_dot978 = _parent;
#line 67
    sjt_math1575 = (sjt_dot978)->m13;
#line 61
    sjt_dot979 = _parent;
#line 67
    sjt_math1576 = (sjt_dot979)->m20;
#line 67
    sjt_math1573 = sjt_math1575 * sjt_math1576;
#line 61
    sjt_dot980 = _parent;
#line 67
    sjt_math1574 = (sjt_dot980)->m32;
#line 67
...
#line 61
    sjt_dot981 = _parent;
#line 67
    sjt_math1579 = (sjt_dot981)->m10;
#line 61
    sjt_dot982 = _parent;
#line 67
    sjt_math1580 = (sjt_dot982)->m23;
#line 67
    sjt_math1577 = sjt_math1579 * sjt_math1580;
#line 61
    sjt_dot983 = _parent;
#line 67
    sjt_math1578 = (sjt_dot983)->m32;
#line 67
...
#line 61
    sjt_dot984 = _parent;
#line 67
    sjt_math1583 = (sjt_dot984)->m12;
#line 61
    sjt_dot985 = _parent;
#line 67
    sjt_math1584 = (sjt_dot985)->m20;
#line 67
    sjt_math1581 = sjt_math1583 * sjt_math1584;
#line 61
    sjt_dot986 = _parent;
#line 67
    sjt_math1582 = (sjt_dot986)->m33;
#line 67
...
#line 61
    sjt_dot987 = _parent;
#line 67
    sjt_math1587 = (sjt_dot987)->m10;
#line 61
    sjt_dot988 = _parent;
#line 67
    sjt_math1588 = (sjt_dot988)->m22;
#line 67
    sjt_math1585 = sjt_math1587 * sjt_math1588;
#line 61
    sjt_dot989 = _parent;
#line 67
    sjt_math1586 = (sjt_dot989)->m33;
#line 67
...
#line 61
    sjt_dot990 = _parent;
#line 68
    sjt_math1601 = (sjt_dot990)->m02;
#line 61
    sjt_dot991 = _parent;
#line 68
    sjt_math1602 = (sjt_dot991)->m23;
#line 68
    sjt_math1599 = sjt_math1601 * sjt_math1602;
#line 61
    sjt_dot992 = _parent;
#line 68
    sjt_math1600 = (sjt_dot992)->m30;
#line 68
    sjt_math1597 = sjt_math1599 * sjt_math1600;
#line 61
    sjt_dot993 = _parent;
#line 68
    sjt_math1605 = (sjt_dot993)->m03;
#line 61
    sjt_dot994 = _parent;
#line 68
    sjt_math1606 = (sjt_dot994)->m22;
#line 68
    sjt_math1603 = sjt_math1605 * sjt_math1606;
#line 61
    sjt_dot995 = _parent;
#line 68
    sjt_math1604 = (sjt_dot995)->m30;
#line 68
...
#line 61
    sjt_dot996 = _parent;
#line 68
    sjt_math1609 = (sjt_dot996)->m03;
#line 61
    sjt_dot997 = _parent;
#line 68
    sjt_math1610 = (sjt_dot997)->m20;
#line 68
    sjt_math1607 = sjt_math1609 * sjt_math1610;
#line 61
    sjt_dot998 = _parent;
#line 68
    sjt_math1608 = (sjt_dot998)->m32;
#line 68
...
#line 61
    sjt_dot999 = _parent;
#line 68
    sjt_math1613 = (sjt_dot999)->m00;
#line 61
    sjt_dot1000 = _parent;
#line 68
    sjt_math1614 = (sjt_dot1000)->m23;
#line 68
    sjt_math1611 = sjt_math1613 * sjt_math1614;
#line 61
    sjt_dot1001 = _parent;
#line 68
    sjt_math1612 = (sjt_dot1001)->m32;
#line 68
...
#line 61
    sjt_dot1002 = _parent;
#line 68
    sjt_math1617 = (sjt_dot1002)->m02;
#line 61
    sjt_dot1003 = _parent;
#line 68
    sjt_math1618 = (sjt_dot1003)->m20;
#line 68
    sjt_math1615 = sjt_math1617 * sjt_math1618;
#line 61
    sjt_dot1004 = _parent;
#line 68
    sjt_math1616 = (sjt_dot1004)->m33;
#line 68
...
#line 61
    sjt_dot1005 = _parent;
#line 68
    sjt_math1621 = (sjt_dot1005)->m00;
#line 61
    sjt_dot1006 = _parent;
#line 68
    sjt_math1622 = (sjt_dot1006)->m22;
#line 68
    sjt_math1619 = sjt_math1621 * sjt_math1622;
#line 61
    sjt_dot1007 = _parent;
#line 68
    sjt_math1620 = (sjt_dot1007)->m33;
#line 68
...
#line 61
    sjt_dot1008 = _parent;
#line 69
    sjt_math1635 = (sjt_dot1008)->m03;
#line 61
    sjt_dot1009 = _parent;
#line 69
    sjt_math1636 = (sjt_dot1009)->m12;
#line 69
    sjt_math1633 = sjt_math1635 * sjt_math1636;
#line 61
    sjt_dot1010 = _parent;
#line 69
    sjt_math1634 = (sjt_dot1010)->m30;
#line 69
    sjt_math1631 = sjt_math1633 * sjt_math1634;
#line 61
    sjt_dot1011 = _parent;
#line 69
    sjt_math1639 = (sjt_dot1011)->m02;
#line 61
    sjt_dot1012 = _parent;
#line 69
    sjt_math1640 = (sjt_dot1012)->m13;
#line 69
    sjt_math1637 = sjt_math1639 * sjt_math1640;
#line 61
    sjt_dot1013 = _parent;
#line 69
    sjt_math1638 = (sjt_dot1013)->m30;
#line 69
...
#line 61
    sjt_dot1014 = _parent;
#line 69
    sjt_math1643 = (sjt_dot1014)->m03;
#line 61
    sjt_dot1015 = _parent;
#line 69
    sjt_math1644 = (sjt_dot1015)->m10;
#line 69
    sjt_math1641 = sjt_math1643 * sjt_math1644;
#line 61
    sjt_dot1016 = _parent;
#line 69
    sjt_math1642 = (sjt_dot1016)->m32;
#line 69
...
#line 61
    sjt_dot1017 = _parent;
#line 69
    sjt_math1647 = (sjt_dot1017)->m00;
#line 61
    sjt_dot1018 = _parent;
#line 69
    sjt_math1648 = (sjt_dot1018)->m13;
#line 69
    sjt_math1645 = sjt_math1647 * sjt_math1648;
#line 61
    sjt_dot1019 = _parent;
#line 69
    sjt_math1646 = (sjt_dot1019)->m32;
#line 69
...
#line 61
    sjt_dot1020 = _parent;
#line 69
    sjt_math1651 = (sjt_dot1020)->m02;
#line 61
    sjt_dot1021 = _parent;
#line 69
    sjt_math1652 = (sjt_dot1021)->m10;
#line 69
    sjt_math1649 = sjt_math1651 * sjt_math1652;
#line 61
    sjt_dot1022 = _parent;
#line 69
    sjt_math1650 = (sjt_dot1022)->m33;
#line 69
...
#line 61
    sjt_dot1023 = _parent;
#line 69
    sjt_math1655 = (sjt_dot1023)->m00;
#line 61
    sjt_dot1024 = _parent;
#line 69
    sjt_math1656 = (sjt_dot1024)->m12;
#line 69
    sjt_math1653 = sjt_math1655 * sjt_math1656;
#line 61
    sjt_dot1025 = _parent;
#line 69
    sjt_math1654 = (sjt_dot1025)->m33;
#line 69
...
#line 61
    sjt_dot1026 = _parent;
#line 70
    sjt_math1669 = (sjt_dot1026)->m02;
#line 61
    sjt_dot1027 = _parent;
#line 70
    sjt_math1670 = (sjt_dot1027)->m13;
#line 70
    sjt_math1667 = sjt_math1669 * sjt_math1670;
#line 61
    sjt_dot1028 = _parent;
#line 70
    sjt_math1668 = (sjt_dot1028)->m20;
#line 70
    sjt_math1665 = sjt_math1667 * sjt_math1668;
#line 61
    sjt_dot1029 = _parent;
#line 70
    sjt_math1673 = (sjt_dot1029)->m03;
#line 61
    sjt_dot1030 = _parent;
#line 70
    sjt_math1674 = (sjt_dot1030)->m12;
#line 70
    sjt_math1671 = sjt_math1673 * sjt_math1674;
#line 61
    sjt_dot1031 = _parent;
#line 70
    sjt_math1672 = (sjt_dot1031)->m20;
#line 70
...
#line 61
    sjt_dot1032 = _parent;
#line 70
    sjt_math1677 = (sjt_dot1032)->m03;
#line 61
    sjt_dot1033 = _parent;
#line 70
    sjt_math1678 = (sjt_dot1033)->m10;
#line 70
    sjt_math1675 = sjt_math1677 * sjt_math1678;
#line 61
    sjt_dot1034 = _parent;
#line 70
    sjt_math1676 = (sjt_dot1034)->m22;
#line 70
...
#line 61
    sjt_dot1035 = _parent;
#line 70
    sjt_math1681 = (sjt_dot1035)->m00;
#line 61
    sjt_dot1036 = _parent;
#line 70
    sjt_math1682 = (sjt_dot1036)->m13;
#line 70
    sjt_math1679 = sjt_math1681 * sjt_math1682;
#line 61
    sjt_dot1037 = _parent;
#line 70
    sjt_math1680 = (sjt_dot1037)->m22;
#line 70
...
#line 61
    sjt_dot1038 = _parent;
#line 70
    sjt_math1685 = (sjt_dot1038)->m02;
#line 61
    sjt_dot1039 = _parent;
#line 70
    sjt_math1686 = (sjt_dot1039)->m10;
#line 70
    sjt_math1683 = sjt_math1685 * sjt_math1686;
#line 61
    sjt_dot1040 = _parent;
#line 70
    sjt_math1684 = (sjt_dot1040)->m23;
#line 70
...
#line 61
    sjt_dot1041 = _parent;
#line 70
    sjt_math1689 = (sjt_dot1041)->m00;
#line 61
    sjt_dot1042 = _parent;
#line 70
    sjt_math1690 = (sjt_dot1042)->m12;
#line 70
    sjt_math1687 = sjt_math1689 * sjt_math1690;
#line 61
    sjt_dot1043 = _parent;
#line 70
    sjt_math1688 = (sjt_dot1043)->m23;
#line 70
...
#line 61
    sjt_dot1044 = _parent;
#line 71
    sjt_math1703 = (sjt_dot1044)->m11;
#line 61
    sjt_dot1045 = _parent;
#line 71
    sjt_math1704 = (sjt_dot1045)->m23;
#line 71
    sjt_math1701 = sjt_math1703 * sjt_math1704;
#line 61
    sjt_dot1046 = _parent;
#line 71
    sjt_math1702 = (sjt_dot1046)->m30;
#line 71
    sjt_math1699 = sjt_math1701 * sjt_math1702;
#line 61
    sjt_dot1047 = _parent;
#line 71
    sjt_math1707 = (sjt_dot1047)->m13;
#line 61
    sjt_dot1048 = _parent;
#line 71
    sjt_math1708 = (sjt_dot1048)->m21;
#line 71
    sjt_math1705 = sjt_math1707 * sjt_math1708;
#line 61
    sjt_dot1049 = _parent;
#line 71
    sjt_math1706 = (sjt_dot1049)->m30;
#line 71
...
#line 61
    sjt_dot1050 = _parent;
#line 71
    sjt_math1711 = (sjt_dot1050)->m13;
#line 61
    sjt_dot1051 = _parent;
#line 71
    sjt_math1712 = (sjt_dot1051)->m20;
#line 71
    sjt_math1709 = sjt_math1711 * sjt_math1712;
#line 61
    sjt_dot1052 = _parent;
#line 71
    sjt_math1710 = (sjt_dot1052)->m31;
#line 71
...
#line 61
    sjt_dot1053 = _parent;
#line 71
    sjt_math1715 = (sjt_dot1053)->m10;
#line 61
    sjt_dot1054 = _parent;
#line 71
    sjt_math1716 = (sjt_dot1054)->m23;
#line 71
    sjt_math1713 = sjt_math1715 * sjt_math1716;
#line 61
    sjt_dot1055 = _parent;
#line 71
    sjt_math1714 = (sjt_dot1055)->m31;
#line 71
...
#line 61
    sjt_dot1056 = _parent;
#line 71
    sjt_math1719 = (sjt_dot1056)->m11;
#line 61
    sjt_dot1057 = _parent;
#line 71
    sjt_math1720 = (sjt_dot1057)->m20;
#line 71
    sjt_math1717 = sjt_math1719 * sjt_math1720;
#line 61
    sjt_dot1058 = _parent;
#line 71
    sjt_math1718 = (sjt_dot1058)->m33;
#line 71
...
#line 61
    sjt_dot1059 = _parent;
#line 71
    sjt_math1723 = (sjt_dot1059)->m10;
#line 61
    sjt_dot1060 = _parent;
#line 71
    sjt_math1724 = (sjt_dot1060)->m21;
#line 71
    sjt_math1721 = sjt_math1723 * sjt_math1724;
#line 61
    sjt_dot1061 = _parent;
#line 71
    sjt_math1722 = (sjt_dot1061)->m33;
#line 71
...
#line 61
    sjt_dot1062 = _parent;
#line 72
    sjt_math1737 = (sjt_dot1062)->m03;
#line 61
    sjt_dot1063 = _parent;
#line 72
    sjt_math1738 = (sjt_dot1063)->m21;
#line 72
    sjt_math1735 = sjt_math1737 * sjt_math1738;
#line 61
    sjt_dot1064 = _parent;
#line 72
    sjt_math1736 = (sjt_dot1064)->m30;
#line 72
    sjt_math1733 = sjt_math1735 * sjt_math1736;
#line 61
    sjt_dot1065 = _parent;
#line 72
    sjt_math1741 = (sjt_dot1065)->m01;
#line 61
    sjt_dot1066 = _parent;
#line 72
    sjt_math1742 = (sjt_dot1066)->m23;
#line 72
    sjt_math1739 = sjt_math1741 * sjt_math1742;
#line 61
    sjt_dot1067 = _parent;
#line 72
    sjt_math1740 = (sjt_dot1067)->m30;
#line 72
...
#line 61
    sjt_dot1068 = _parent;
#line 72
    sjt_math1745 = (sjt_dot1068)->m03;
#line 61
    sjt_dot1069 = _parent;
#line 72
    sjt_math1746 = (sjt_dot1069)->m20;
#line 72
    sjt_math1743 = sjt_math1745 * sjt_math1746;
#line 61
    sjt_dot1070 = _parent;
#line 72
    sjt_math1744 = (sjt_dot1070)->m31;
#line 72
...
#line 61
    sjt_dot1071 = _parent;
#line 72
    sjt_math1749 = (sjt_dot1071)->m00;
#line 61
    sjt_dot1072 = _parent;
#line 72
    sjt_math1750 = (sjt_dot1072)->m23;
#line 72
    sjt_math1747 = sjt_math1749 * sjt_math1750;
#line 61
    sjt_dot1073 = _parent;
#line 72
    sjt_math1748 = (sjt_dot1073)->m31;
#line 72
...
#line 61
    sjt_dot1074 = _parent;
#line 72
    sjt_math1753 = (sjt_dot1074)->m01;
#line 61
    sjt_dot1075 = _parent;
#line 72
    sjt_math1754 = (sjt_dot1075)->m20;
#line 72
    sjt_math1751 = sjt_math1753 * sjt_math1754;
#line 61
    sjt_dot1076 = _parent;
#line 72
    sjt_math1752 = (sjt_dot1076)->m33;
#line 72
...
#line 61
    sjt_dot1077 = _parent;
#line 72
    sjt_math1757 = (sjt_dot1077)->m00;
#line 61
    sjt_dot1078 = _parent;
#line 72
    sjt_math1758 = (sjt_dot1078)->m21;
#line 72
    sjt_math1755 = sjt_math1757 * sjt_math1758;
#line 61
    sjt_dot1079 = _parent;
#line 72
    sjt_math1756 = (sjt_dot1079)->m33;
#line 72
...
#line 61
    sjt_dot1080 = _parent;
#line 73
    sjt_math1771 = (sjt_dot1080)->m01;
#line 61
    sjt_dot1081 = _parent;
#line 73
    sjt_math1772 = (sjt_dot1081)->m13;
#line 73
    sjt_math1769 = sjt_math1771 * sjt_math1772;
#line 61
    sjt_dot1082 = _parent;
#line 73
    sjt_math1770 = (sjt_dot1082)->m30;
#line 73
    sjt_math1767 = sjt_math1769 * sjt_math1770;
#line 61
    sjt_dot1083 = _parent;
#line 73
    sjt_math1775 = (sjt_dot1083)->m03;
#line 61
    sjt_dot1084 = _parent;
#line 73
    sjt_math1776 = (sjt_dot1084)->m11;
#line 73
    sjt_math1773 = sjt_math1775 * sjt_math1776;
#line 61
    sjt_dot1085 = _parent;
#line 73
    sjt_math1774 = (sjt_dot1085)->m30;
#line 73
...
#line 61
    sjt_dot1086 = _parent;
#line 73
    sjt_math1779 = (sjt_dot1086)->m03;
#line 61
    sjt_dot1087 = _parent;
#line 73
    sjt_math1780 = (sjt_dot1087)->m10;
#line 73
    sjt_math1777 = sjt_math1779 * sjt_math1780;
#line 61
    sjt_dot1088 = _parent;
#line 73
    sjt_math1778 = (sjt_dot1088)->m31;
#line 73
...
#line 61
    sjt_dot1089 = _parent;
#line 73
    sjt_math1783 = (sjt_dot1089)->m00;
#line 61
    sjt_dot1090 = _parent;
#line 73
    sjt_math1784 = (sjt_dot1090)->m13;
#line 73
    sjt_math1781 = sjt_math1783 * sjt_math1784;
#line 61
    sjt_dot1091 = _parent;
#line 73
    sjt_math1782 = (sjt_dot1091)->m31;
#line 73
...
#line 61
    sjt_dot1092 = _parent;
#line 73
    sjt_math1787 = (sjt_dot1092)->m01;
#line 61
    sjt_dot1093 = _parent;
#line 73
    sjt_math1788 = (sjt_dot1093)->m10;
#line 73
    sjt_math1785 = sjt_math1787 * sjt_math1788;
#line 61
    sjt_dot1094 = _parent;
#line 73
    sjt_math1786 = (sjt_dot1094)->m33;
#line 73
...
#line 61
    sjt_dot1095 = _parent;
#line 73
    sjt_math1791 = (sjt_dot1095)->m00;
#line 61
    sjt_dot1096 = _parent;
#line 73
    sjt_math1792 = (sjt_dot1096)->m11;
#line 73
    sjt_math1789 = sjt_math1791 * sjt_math1792;
#line 61
    sjt_dot1097 = _parent;
#line 73
    sjt_math1790 = (sjt_dot1097)->m33;
#line 73
...
#line 61
    sjt_dot1098 = _parent;
#line 74
    sjt_math1805 = (sjt_dot1098)->m03;
#line 61
    sjt_dot1099 = _parent;
#line 74
    sjt_math1806 = (sjt_dot1099)->m11;
#line 74
    sjt_math1803 = sjt_math1805 * sjt_math1806;
#line 61
    sjt_dot1100 = _parent;
#line 74
    sjt_math1804 = (sjt_dot1100)->m20;
#line 74
    sjt_math1801 = sjt_math1803 * sjt_math1804;
#line 61
    sjt_dot1101 = _parent;
#line 74
    sjt_math1809 = (sjt_dot1101)->m01;
#line 61
    sjt_dot1102 = _parent;
#line 74
    sjt_math1810 = (sjt_dot1102)->m13;
#line 74
    sjt_math1807 = sjt_math1809 * sjt_math1810;
#line 61
    sjt_dot1103 = _parent;
#line 74
    sjt_math1808 = (sjt_dot1103)->m20;
#line 74
...
#line 61
    sjt_dot1104 = _parent;
#line 74
    sjt_math1813 = (sjt_dot1104)->m03;
#line 61
    sjt_dot1105 = _parent;
#line 74
    sjt_math1814 = (sjt_dot1105)->m10;
#line 74
    sjt_math1811 = sjt_math1813 * sjt_math1814;
#line 61
    sjt_dot1106 = _parent;
#line 74
    sjt_math1812 = (sjt_dot1106)->m21;
#line 74
...
#line 61
    sjt_dot1107 = _parent;
#line 74
    sjt_math1817 = (sjt_dot1107)->m00;
#line 61
    sjt_dot1108 = _parent;
#line 74
    sjt_math1818 = (sjt_dot1108)->m13;
#line 74
    sjt_math1815 = sjt_math1817 * sjt_math1818;
#line 61
    sjt_dot1109 = _parent;
#line 74
    sjt_math1816 = (sjt_dot1109)->m21;
#line 74
...
#line 61
    sjt_dot1110 = _parent;
#line 74
    sjt_math1821 = (sjt_dot1110)->m01;
#line 61
    sjt_dot1111 = _parent;
#line 74
    sjt_math1822 = (sjt_dot1111)->m10;
#line 74
    sjt_math1819 = sjt_math1821 * sjt_math1822;
#line 61
    sjt_dot1112 = _parent;
#line 74
    sjt_math1820 = (sjt_dot1112)->m23;
#line 74
...
#line 61
    sjt_dot1113 = _parent;
#line 74
    sjt_math1825 = (sjt_dot1113)->m00;
#line 61
    sjt_dot1114 = _parent;
#line 74
    sjt_math1826 = (sjt_dot1114)->m11;
#line 74
    sjt_math1823 = sjt_math1825 * sjt_math1826;
#line 61
    sjt_dot1115 = _parent;
#line 74
    sjt_math1824 = (sjt_dot1115)->m23;
#line 74
...
#line 61
    sjt_dot1116 = _parent;
#line 75
    sjt_math1839 = (sjt_dot1116)->m12;
#line 61
    sjt_dot1117 = _parent;
#line 75
    sjt_math1840 = (sjt_dot1117)->m21;
#line 75
    sjt_math1837 = sjt_math1839 * sjt_math1840;
#line 61
    sjt_dot1118 = _parent;
#line 75
    sjt_math1838 = (sjt_dot1118)->m30;
#line 75
    sjt_math1835 = sjt_math1837 * sjt_math1838;
#line 61
    sjt_dot1119 = _parent;
#line 75
    sjt_math1843 = (sjt_dot1119)->m11;
#line 61
    sjt_dot1120 = _parent;
#line 75
    sjt_math1844 = (sjt_dot1120)->m22;
#line 75
    sjt_math1841 = sjt_math1843 * sjt_math1844;
#line 61
    sjt_dot1121 = _parent;
#line 75
    sjt_math1842 = (sjt_dot1121)->m30;
#line 75
...
#line 61
    sjt_dot1122 = _parent;
#line 75
    sjt_math1847 = (sjt_dot1122)->m12;
#line 61
    sjt_dot1123 = _parent;
#line 75
    sjt_math1848 = (sjt_dot1123)->m20;
#line 75
    sjt_math1845 = sjt_math1847 * sjt_math1848;
#line 61
    sjt_dot1124 = _parent;
#line 75
    sjt_math1846 = (sjt_dot1124)->m31;
#line 75
...
#line 61
    sjt_dot1125 = _parent;
#line 75
    sjt_math1851 = (sjt_dot1125)->m10;
#line 61
    sjt_dot1126 = _parent;
#line 75
    sjt_math1852 = (sjt_dot1126)->m22;
#line 75
    sjt_math1849 = sjt_math1851 * sjt_math1852;
#line 61
    sjt_dot1127 = _parent;
#line 75
    sjt_math1850 = (sjt_dot1127)->m31;
#line 75
...
#line 61
    sjt_dot1128 = _parent;
#line 75
    sjt_math1855 = (sjt_dot1128)->m11;
#line 61
    sjt_dot1129 = _parent;
#line 75
    sjt_math1856 = (sjt_dot1129)->m20;
#line 75
    sjt_math1853 = sjt_math1855 * sjt_math1856;
#line 61
    sjt_dot1130 = _parent;
#line 75
    sjt_math1854 = (sjt_dot1130)->m32;
#line 75
...
#line 61
    sjt_dot1131 = _parent;
#line 75
    sjt_math1859 = (sjt_dot1131)->m10;
#line 61
    sjt_dot1132 = _parent;
#line 75
    sjt_math1860 = (sjt_dot1132)->m21;
#line 75
    sjt_math1857 = sjt_math1859 * sjt_math1860;
#line 61
    sjt_dot1133 = _parent;
#line 75
    sjt_math1858 = (sjt_dot1133)->m32;
#line 75
...
#line 61
    sjt_dot1134 = _parent;
#line 76
    sjt_math1873 = (sjt_dot1134)->m01;
#line 61
    sjt_dot1135 = _parent;
#line 76
    sjt_math1874 = (sjt_dot1135)->m22;
#line 76
    sjt_math1871 = sjt_math1873 * sjt_math1874;
#line 61
    sjt_dot1136 = _parent;
#line 76
    sjt_math1872 = (sjt_dot1136)->m30;
#line 76
    sjt_math1869 = sjt_math1871 * sjt_math1872;
#line 61
    sjt_dot1137 = _parent;
#line 76
    sjt_math1877 = (sjt_dot1137)->m02;
#line 61
    sjt_dot1138 = _parent;
#line 76
    sjt_math1878 = (sjt_dot1138)->m21;
#line 76
    sjt_math1875 = sjt_math1877 * sjt_math1878;
#line 61
    sjt_dot1139 = _parent;
#line 76
    sjt_math1876 = (sjt_dot1139)->m30;
#line 76
...
#line 61
    sjt_dot1140 = _parent;
#line 76
    sjt_math1881 = (sjt_dot1140)->m02;
#line 61
    sjt_dot1141 = _parent;
#line 76
    sjt_math1882 = (sjt_dot1141)->m20;
#line 76
    sjt_math1879 = sjt_math1881 * sjt_math1882;
#line 61
    sjt_dot1142 = _parent;
#line 76
    sjt_math1880 = (sjt_dot1142)->m31;
#line 76
...
#line 61
    sjt_dot1143 = _parent;
#line 76
    sjt_math1885 = (sjt_dot1143)->m00;
#line 61
    sjt_dot1144 = _parent;
#line 76
    sjt_math1886 = (sjt_dot1144)->m22;
#line 76
    sjt_math1883 = sjt_math1885 * sjt_math1886;
#line 61
    sjt_dot1145 = _parent;
#line 76
    sjt_math1884 = (sjt_dot1145)->m31;
#line 76
...
#line 61
    sjt_dot1146 = _parent;
#line 76
    sjt_math1889 = (sjt_dot1146)->m01;
#line 61
    sjt_dot1147 = _parent;
#line 76
    sjt_math1890 = (sjt_dot1147)->m20;
#line 76
    sjt_math1887 = sjt_math1889 * sjt_math1890;
#line 61
    sjt_dot1148 = _parent;
#line 76
    sjt_math1888 = (sjt_dot1148)->m32;
#line 76
...
#line 61
    sjt_dot1149 = _parent;
#line 76
    sjt_math1893 = (sjt_dot1149)->m00;
#line 61
    sjt_dot1150 = _parent;
#line 76
    sjt_math1894 = (sjt_dot1150)->m21;
#line 76
    sjt_math1891 = sjt_math1893 * sjt_math1894;
#line 61
    sjt_dot1151 = _parent;
#line 76
    sjt_math1892 = (sjt_dot1151)->m32;
#line 76
...
#line 61
    sjt_dot1152 = _parent;
#line 77
    sjt_math1907 = (sjt_dot1152)->m02;
#line 61
    sjt_dot1153 = _parent;
#line 77
    sjt_math1908 = (sjt_dot1153)->m11;
#line 77
    sjt_math1905 = sjt_math1907 * sjt_math1908;
#line 61
    sjt_dot1154 = _parent;
#line 77
    sjt_math1906 = (sjt_dot1154)->m30;
#line 77
    sjt_math1903 = sjt_math1905 * sjt_math1906;
#line 61
    sjt_dot1155 = _parent;
#line 77
    sjt_math1911 = (sjt_dot1155)->m01;
#line 61
    sjt_dot1156 = _parent;
#line 77
    sjt_math1912 = (sjt_dot1156)->m12;
#line 77
    sjt_math1909 = sjt_math1911 * sjt_math1912;
#line 61
    sjt_dot1157 = _parent;
#line 77
    sjt_math1910 = (sjt_dot1157)->m30;
#line 77
...
#line 61
    sjt_dot1158 = _parent;
#line 77
    sjt_math1915 = (sjt_dot1158)->m02;
#line 61
    sjt_dot1159 = _parent;
#line 77
    sjt_math1916 = (sjt_dot1159)->m10;
#line 77
    sjt_math1913 = sjt_math1915 * sjt_math1916;
#line 61
    sjt_dot1160 = _parent;
#line 77
    sjt_math1914 = (sjt_dot1160)->m31;
#line 77
...
#line 61
    sjt_dot1161 = _parent;
#line 77
    sjt_math1919 = (sjt_dot1161)->m00;
#line 61
    sjt_dot1162 = _parent;
#line 77
    sjt_math1920 = (sjt_dot1162)->m12;
#line 77
    sjt_math1917 = sjt_math1919 * sjt_math1920;
#line 61
    sjt_dot1163 = _parent;
#line 77
    sjt_math1918 = (sjt_dot1163)->m31;
#line 77
...
#line 61
    sjt_dot1164 = _parent;
#line 77
    sjt_math1923 = (sjt_dot1164)->m01;
#line 61
    sjt_dot1165 = _parent;
#line 77
    sjt_math1924 = (sjt_dot1165)->m10;
#line 77
    sjt_math1921 = sjt_math1923 * sjt_math1924;
#line 61
    sjt_dot1166 = _parent;
#line 77
    sjt_math1922 = (sjt_dot1166)->m32;
#line 77
...
#line 61
    sjt_dot1167 = _parent;
#line 77
    sjt_math1927 = (sjt_dot1167)->m00;
#line 61
    sjt_dot1168 = _parent;
#line 77
    sjt_math1928 = (sjt_dot1168)->m11;
#line 77
    sjt_math1925 = sjt_math1927 * sjt_math1928;
#line 61
    sjt_dot1169 = _parent;
#line 77
    sjt_math1926 = (sjt_dot1169)->m32;
#line 77
...
#line 61
    sjt_dot1170 = _parent;
#line 78
    sjt_math1941 = (sjt_dot1170)->m01;
#line 61
    sjt_dot1171 = _parent;
#line 78
    sjt_math1942 = (sjt_dot1171)->m12;
#line 78
    sjt_math1939 = sjt_math1941 * sjt_math1942;
#line 61
    sjt_dot1172 = _parent;
#line 78
    sjt_math1940 = (sjt_dot1172)->m20;
#line 78
    sjt_math1937 = sjt_math1939 * sjt_math1940;
#line 61
    sjt_dot1173 = _parent;
#line 78
    sjt_math1945 = (sjt_dot1173)->m02;
#line 61
    sjt_dot1174 = _parent;
#line 78
    sjt_math1946 = (sjt_dot1174)->m11;
#line 78
    sjt_math1943 = sjt_math1945 * sjt_math1946;
#line 61
    sjt_dot1175 = _parent;
#line 78
    sjt_math1944 = (sjt_dot1175)->m20;
#line 78
...
#line 61
    sjt_dot1176 = _parent;
#line 78
    sjt_math1949 = (sjt_dot1176)->m02;
#line 61
    sjt_dot1177 = _parent;
#line 78
    sjt_math1950 = (sjt_dot1177)->m10;
#line 78
    sjt_math1947 = sjt_math1949 * sjt_math1950;
#line 61
    sjt_dot1178 = _parent;
#line 78
    sjt_math1948 = (sjt_dot1178)->m21;
#line 78
...
#line 61
    sjt_dot1179 = _parent;
#line 78
    sjt_math1953 = (sjt_dot1179)->m00;
#line 61
    sjt_dot1180 = _parent;
#line 78
    sjt_math1954 = (sjt_dot1180)->m12;
#line 78
    sjt_math1951 = sjt_math1953 * sjt_math1954;
#line 61
    sjt_dot1181 = _parent;
#line 78
    sjt_math1952 = (sjt_dot1181)->m21;
#line 78
...
#line 61
    sjt_dot1182 = _parent;
#line 78
    sjt_math1957 = (sjt_dot1182)->m01;
#line 61
    sjt_dot1183 = _parent;
#line 78
    sjt_math1958 = (sjt_dot1183)->m10;
#line 78
    sjt_math1955 = sjt_math1957 * sjt_math1958;
#line 61
    sjt_dot1184 = _parent;
#line 78
    sjt_math1956 = (sjt_dot1184)->m22;
#line 78
...
#line 61
    sjt_dot1185 = _parent;
#line 78
    sjt_math1961 = (sjt_dot1185)->m00;
#line 61
    sjt_dot1186 = _parent;
#line 78
    sjt_math1962 = (sjt_dot1186)->m11;
#line 78
    sjt_math1959 = sjt_math1961 * sjt_math1962;
#line 61
    sjt_dot1187 = _parent;
#line 78
    sjt_math1960 = (sjt_dot1187)->m22;
#line 78
...
#line 1 "lib/ui/vec3.sj"
    sjt_dot161 = &sjv_xaxis;
#line 124 "lib/ui/mat4.sj"
    _return->m00 = (sjt_dot161)->x;
#line 1 "lib/ui/vec3.sj"
    sjt_dot162 = &sjv_yaxis;
#line 124 "lib/ui/mat4.sj"
    _return->m01 = (sjt_dot162)->x;
#line 1 "lib/ui/vec3.sj"
    sjt_dot163 = &sjv_zaxis;
#line 124 "lib/ui/mat4.sj"
    _return->m02 = (sjt_dot163)->x;
#line 128
    _return->m03 = 0.0f;
#line 1 "lib/ui/vec3.sj"
    sjt_dot164 = &sjv_xaxis;
#line 124 "lib/ui/mat4.sj"
    _return->m10 = (sjt_dot164)->y;
#line 1 "lib/ui/vec3.sj"
    sjt_dot165 = &sjv_yaxis;
#line 124 "lib/ui/mat4.sj"
    _return->m11 = (sjt_dot165)->y;
#line 1 "lib/ui/vec3.sj"
    sjt_dot166 = &sjv_zaxis;
#line 124 "lib/ui/mat4.sj"
    _return->m12 = (sjt_dot166)->y;
#line 132
    _return->m13 = 0.0f;
#line 1 "lib/ui/vec3.sj"
    sjt_dot167 = &sjv_xaxis;
#line 124 "lib/ui/mat4.sj"
    _return->m20 = (sjt_dot167)->z;
#line 1 "lib/ui/vec3.sj"
    sjt_dot168 = &sjv_yaxis;
#line 124 "lib/ui/mat4.sj"
    _return->m21 = (sjt_dot168)->z;
#line 1 "lib/ui/vec3.sj"
    sjt_dot169 = &sjv_zaxis;
#line 124 "lib/ui/mat4.sj"
    _return->m22 = (sjt_dot169)->z;
#line 136
    _return->m23 = 0.0f;
#line 137
    sjt_math149 = 0.0f;
...
#line 19 "lib/ui/mat4.sj"
    sjt_dot194 = m;
#line 21
    sjt_math177 = (sjt_dot194)->m00;
#line 19
    sjt_dot195 = _parent;
#line 21
    sjt_math178 = (sjt_dot195)->m00;
#line 21
    sjt_math175 = sjt_math177 * sjt_math178;
#line 19
    sjt_dot196 = m;
#line 21
    sjt_math179 = (sjt_dot196)->m01;
#line 19
    sjt_dot197 = _parent;
#line 21
    sjt_math180 = (sjt_dot197)->m10;
#line 21
...
#line 19
    sjt_dot198 = m;
#line 21
    sjt_math181 = (sjt_dot198)->m02;
#line 19
    sjt_dot199 = _parent;
#line 21
    sjt_math182 = (sjt_dot199)->m20;
#line 21
...
#line 19
    sjt_dot200 = m;
#line 21
    sjt_math183 = (sjt_dot200)->m03;
#line 19
    sjt_dot201 = _parent;
#line 21
    sjt_math184 = (sjt_dot201)->m30;
#line 21
...
#line 19
    sjt_dot202 = m;
#line 22
    sjt_math191 = (sjt_dot202)->m00;
#line 19
    sjt_dot203 = _parent;
#line 22
    sjt_math192 = (sjt_dot203)->m01;
#line 22
    sjt_math189 = sjt_math191 * sjt_math192;
#line 19
    sjt_dot204 = m;
#line 22
    sjt_math193 = (sjt_dot204)->m01;
#line 19
    sjt_dot205 = _parent;
#line 22
    sjt_math194 = (sjt_dot205)->m11;
#line 22
...
#line 19
    sjt_dot206 = m;
#line 22
    sjt_math195 = (sjt_dot206)->m02;
#line 19
    sjt_dot207 = _parent;
#line 22
    sjt_math196 = (sjt_dot207)->m21;
#line 22
...
#line 19
    sjt_dot208 = m;
#line 22
    sjt_math197 = (sjt_dot208)->m03;
#line 19
    sjt_dot209 = _parent;
#line 22
    sjt_math198 = (sjt_dot209)->m31;
#line 22
...
#line 19
    sjt_dot210 = m;
#line 23
    sjt_math205 = (sjt_dot210)->m00;
#line 19
    sjt_dot211 = _parent;
#line 23
    sjt_math206 = (sjt_dot211)->m02;
#line 23
    sjt_math203 = sjt_math205 * sjt_math206;
#line 19
    sjt_dot212 = m;
#line 23
    sjt_math207 = (sjt_dot212)->m01;
#line 19
    sjt_dot213 = _parent;
#line 23
    sjt_math208 = (sjt_dot213)->m12;
#line 23
...
#line 19
    sjt_dot214 = m;
#line 23
    sjt_math209 = (sjt_dot214)->m02;
#line 19
    sjt_dot215 = _parent;
#line 23
    sjt_math210 = (sjt_dot215)->m22;
#line 23
...
#line 19
    sjt_dot216 = m;
#line 23
    sjt_math211 = (sjt_dot216)->m03;
#line 19
    sjt_dot217 = _parent;
#line 23
    sjt_math212 = (sjt_dot217)->m32;
#line 23
...
#line 19
    sjt_dot218 = m;
#line 24
    sjt_math219 = (sjt_dot218)->m00;
#line 19
    sjt_dot219 = _parent;
#line 24
    sjt_math220 = (sjt_dot219)->m03;
#line 24
    sjt_math217 = sjt_math219 * sjt_math220;
#line 19
    sjt_dot220 = m;
#line 24
    sjt_math221 = (sjt_dot220)->m01;
#line 19
    sjt_dot221 = _parent;
#line 24
    sjt_math222 = (sjt_dot221)->m13;
#line 24
...
#line 19
    sjt_dot222 = m;
#line 24
    sjt_math223 = (sjt_dot222)->m02;
#line 19
    sjt_dot223 = _parent;
#line 24
    sjt_math224 = (sjt_dot223)->m23;
#line 24
...
#line 19
    sjt_dot224 = m;
#line 24
    sjt_math225 = (sjt_dot224)->m03;
#line 19
    sjt_dot225 = _parent;
#line 24
    sjt_math226 = (sjt_dot225)->m33;
#line 24
...
#line 19
    sjt_dot226 = m;
#line 25
    sjt_math233 = (sjt_dot226)->m10;
#line 19
    sjt_dot227 = _parent;
#line 25
    sjt_math234 = (sjt_dot227)->m00;
#line 25
    sjt_math231 = sjt_math233 * sjt_math234;
#line 19
    sjt_dot228 = m;
#line 25
    sjt_math235 = (sjt_dot228)->m11;
#line 19
    sjt_dot229 = _parent;
#line 25
    sjt_math236 = (sjt_dot229)->m10;
#line 25
...
#line 19
    sjt_dot230 = m;
#line 25
    sjt_math237 = (sjt_dot230)->m12;
#line 19
    sjt_dot231 = _parent;
#line 25
    sjt_math238 = (sjt_dot231)->m20;
#line 25
...
#line 19
    sjt_dot232 = m;
#line 25
    sjt_math239 = (sjt_dot232)->m13;
#line 19
    sjt_dot233 = _parent;
#line 25
    sjt_math240 = (sjt_dot233)->m30;
#line 25
...
#line 19
    sjt_dot234 = m;
#line 26
    sjt_math247 = (sjt_dot234)->m10;
#line 19
    sjt_dot235 = _parent;
#line 26
    sjt_math248 = (sjt_dot235)->m01;
#line 26
    sjt_math245 = sjt_math247 * sjt_math248;
#line 19
    sjt_dot236 = m;
#line 26
    sjt_math249 = (sjt_dot236)->m11;
#line 19
    sjt_dot237 = _parent;
#line 26
    sjt_math250 = (sjt_dot237)->m11;
#line 26
...
#line 19
    sjt_dot238 = m;
#line 26
    sjt_math251 = (sjt_dot238)->m12;
#line 19
    sjt_dot239 = _parent;
#line 26
    sjt_math252 = (sjt_dot239)->m21;
#line 26
...
#line 19
    sjt_dot240 = m;
#line 26
    sjt_math253 = (sjt_dot240)->m13;
#line 19
    sjt_dot241 = _parent;
#line 26
    sjt_math254 = (sjt_dot241)->m31;
#line 26
...
#line 19
    sjt_dot242 = m;
#line 27
    sjt_math261 = (sjt_dot242)->m10;
#line 19
    sjt_dot243 = _parent;
#line 27
    sjt_math262 = (sjt_dot243)->m02;
#line 27
    sjt_math259 = sjt_math261 * sjt_math262;
#line 19
    sjt_dot244 = m;
#line 27
    sjt_math263 = (sjt_dot244)->m11;
#line 19
    sjt_dot245 = _parent;
#line 27
    sjt_math264 = (sjt_dot245)->m12;
#line 27
...
#line 19
    sjt_dot246 = m;
#line 27
    sjt_math265 = (sjt_dot246)->m12;
#line 19
    sjt_dot247 = _parent;
#line 27
    sjt_math266 = (sjt_dot247)->m22;
#line 27
...
#line 19
    sjt_dot248 = m;
#line 27
    sjt_math267 = (sjt_dot248)->m13;
#line 19
    sjt_dot249 = _parent;
#line 27
    sjt_math268 = (sjt_dot249)->m32;
#line 27
...
#line 19
    sjt_dot250 = m;
#line 28
    sjt_math275 = (sjt_dot250)->m10;
#line 19
    sjt_dot251 = _parent;
#line 28
    sjt_math276 = (sjt_dot251)->m03;
#line 28
    sjt_math273 = sjt_math275 * sjt_math276;
#line 19
    sjt_dot252 = m;
#line 28
    sjt_math277 = (sjt_dot252)->m11;
#line 19
    sjt_dot253 = _parent;
#line 28
    sjt_math278 = (sjt_dot253)->m13;
#line 28
...
#line 19
    sjt_dot254 = m;
#line 28
    sjt_math279 = (sjt_dot254)->m12;
#line 19
    sjt_dot255 = _parent;
#line 28
    sjt_math280 = (sjt_dot255)->m23;
#line 28
...
#line 19
    sjt_dot256 = m;
#line 28
    sjt_math281 = (sjt_dot256)->m13;
#line 19
    sjt_dot257 = _parent;
#line 28
    sjt_math282 = (sjt_dot257)->m33;
#line 28
...
#line 19
    sjt_dot258 = m;
#line 29
    sjt_math289 = (sjt_dot258)->m20;
#line 19
    sjt_dot259 = _parent;
#line 29
    sjt_math290 = (sjt_dot259)->m00;
#line 29
    sjt_math287 = sjt_math289 * sjt_math290;
#line 19
    sjt_dot260 = m;
#line 29
    sjt_math291 = (sjt_dot260)->m21;
#line 19
    sjt_dot261 = _parent;
#line 29
    sjt_math292 = (sjt_dot261)->m10;
#line 29
...
#line 19
    sjt_dot262 = m;
#line 29
    sjt_math293 = (sjt_dot262)->m22;
#line 19
    sjt_dot263 = _parent;
#line 29
    sjt_math294 = (sjt_dot263)->m20;
#line 29
...
#line 19
    sjt_dot264 = m;
#line 29
    sjt_math295 = (sjt_dot264)->m23;
#line 19
    sjt_dot265 = _parent;
#line 29
    sjt_math296 = (sjt_dot265)->m30;
#line 29
...
#line 19
    sjt_dot266 = m;
#line 30
    sjt_math303 = (sjt_dot266)->m20;
#line 19
    sjt_dot267 = _parent;
#line 30
    sjt_math304 = (sjt_dot267)->m01;
#line 30
    sjt_math301 = sjt_math303 * sjt_math304;
#line 19
    sjt_dot268 = m;
#line 30
    sjt_math305 = (sjt_dot268)->m21;
#line 19
    sjt_dot269 = _parent;
#line 30
    sjt_math306 = (sjt_dot269)->m11;
#line 30
...
#line 19
    sjt_dot270 = m;
#line 30
    sjt_math307 = (sjt_dot270)->m22;
#line 19
    sjt_dot271 = _parent;
#line 30
    sjt_math308 = (sjt_dot271)->m21;
#line 30
...
#line 19
    sjt_dot272 = m;
#line 30
    sjt_math309 = (sjt_dot272)->m23;
#line 19
    sjt_dot273 = _parent;
#line 30
    sjt_math310 = (sjt_dot273)->m31;
#line 30
...
#line 19
    sjt_dot274 = m;
#line 31
    sjt_math317 = (sjt_dot274)->m20;
#line 19
    sjt_dot275 = _parent;
#line 31
    sjt_math318 = (sjt_dot275)->m02;
#line 31
    sjt_math315 = sjt_math317 * sjt_math318;
#line 19
    sjt_dot276 = m;
#line 31
    sjt_math319 = (sjt_dot276)->m21;
#line 19
    sjt_dot277 = _parent;
#line 31
    sjt_math320 = (sjt_dot277)->m12;
#line 31
...
#line 19
    sjt_dot278 = m;
#line 31
    sjt_math321 = (sjt_dot278)->m22;
#line 19
    sjt_dot279 = _parent;
#line 31
    sjt_math322 = (sjt_dot279)->m22;
#line 31
...
#line 19
    sjt_dot280 = m;
#line 31
    sjt_math323 = (sjt_dot280)->m23;
#line 19
    sjt_dot281 = _parent;
#line 31
    sjt_math324 = (sjt_dot281)->m32;
#line 31
...
#line 19
    sjt_dot282 = m;
#line 32
    sjt_math331 = (sjt_dot282)->m20;
#line 19
    sjt_dot283 = _parent;
#line 32
    sjt_math332 = (sjt_dot283)->m03;
#line 32
    sjt_math329 = sjt_math331 * sjt_math332;
#line 19
    sjt_dot284 = m;
#line 32
    sjt_math333 = (sjt_dot284)->m21;
#line 19
    sjt_dot285 = _parent;
#line 32
    sjt_math334 = (sjt_dot285)->m13;
#line 32
...
#line 19
    sjt_dot286 = m;
#line 32
    sjt_math335 = (sjt_dot286)->m22;
#line 19
    sjt_dot287 = _parent;
#line 32
    sjt_math336 = (sjt_dot287)->m23;
#line 32
...
#line 19
    sjt_dot288 = m;
#line 32
    sjt_math337 = (sjt_dot288)->m23;
#line 19
    sjt_dot289 = _parent;
#line 32
    sjt_math338 = (sjt_dot289)->m33;
#line 32
...
#line 19
    sjt_dot290 = m;
#line 33
    sjt_math345 = (sjt_dot290)->m30;
#line 19
    sjt_dot291 = _parent;
#line 33
    sjt_math346 = (sjt_dot291)->m00;
#line 33
    sjt_math343 = sjt_math345 * sjt_math346;
#line 19
    sjt_dot292 = m;
#line 33
    sjt_math347 = (sjt_dot292)->m31;
#line 19
    sjt_dot293 = _parent;
#line 33
    sjt_math348 = (sjt_dot293)->m10;
#line 33
...
#line 19
    sjt_dot294 = m;
#line 33
    sjt_math349 = (sjt_dot294)->m32;
#line 19
    sjt_dot295 = _parent;
#line 33
    sjt_math350 = (sjt_dot295)->m20;
#line 33
...
#line 19
    sjt_dot296 = m;
#line 33
    sjt_math351 = (sjt_dot296)->m33;
#line 19
    sjt_dot297 = _parent;
#line 33
    sjt_math352 = (sjt_dot297)->m30;
#line 33
...
#line 19
    sjt_dot298 = m;
#line 34
    sjt_math359 = (sjt_dot298)->m30;
#line 19
    sjt_dot299 = _parent;
#line 34
    sjt_math360 = (sjt_dot299)->m01;
#line 34
    sjt_math357 = sjt_math359 * sjt_math360;
#line 19
    sjt_dot300 = m;
#line 34
    sjt_math361 = (sjt_dot300)->m31;
#line 19
    sjt_dot301 = _parent;
#line 34
    sjt_math362 = (sjt_dot301)->m11;
#line 34
...
#line 19
    sjt_dot302 = m;
#line 34
    sjt_math363 = (sjt_dot302)->m32;
#line 19
    sjt_dot303 = _parent;
#line 34
    sjt_math364 = (sjt_dot303)->m21;
#line 34
...
#line 19
    sjt_dot304 = m;
#line 34
    sjt_math365 = (sjt_dot304)->m33;
#line 19
    sjt_dot305 = _parent;
#line 34
    sjt_math366 = (sjt_dot305)->m31;
#line 34
...
#line 19
    sjt_dot306 = m;
#line 35
    sjt_math373 = (sjt_dot306)->m30;
#line 19
    sjt_dot307 = _parent;
#line 35
    sjt_math374 = (sjt_dot307)->m02;
#line 35
    sjt_math371 = sjt_math373 * sjt_math374;
#line 19
    sjt_dot308 = m;
#line 35
    sjt_math375 = (sjt_dot308)->m31;
#line 19
    sjt_dot309 = _parent;
#line 35
    sjt_math376 = (sjt_dot309)->m12;
#line 35
...
#line 19
    sjt_dot310 = m;
#line 35
    sjt_math377 = (sjt_dot310)->m32;
#line 19
    sjt_dot311 = _parent;
#line 35
    sjt_math378 = (sjt_dot311)->m22;
#line 35
...
#line 19
    sjt_dot312 = m;
#line 35
    sjt_math379 = (sjt_dot312)->m33;
#line 19
    sjt_dot313 = _parent;
#line 35
    sjt_math380 = (sjt_dot313)->m32;
#line 35
...
#line 19
    sjt_dot314 = m;
#line 36
    sjt_math387 = (sjt_dot314)->m30;
#line 19
    sjt_dot315 = _parent;
#line 36
    sjt_math388 = (sjt_dot315)->m03;
#line 36
    sjt_math385 = sjt_math387 * sjt_math388;
#line 19
    sjt_dot316 = m;
#line 36
    sjt_math389 = (sjt_dot316)->m31;
#line 19
    sjt_dot317 = _parent;
#line 36
    sjt_math390 = (sjt_dot317)->m13;
#line 36
...
#line 19
    sjt_dot318 = m;
#line 36
    sjt_math391 = (sjt_dot318)->m32;
#line 19
    sjt_dot319 = _parent;
#line 36
    sjt_math392 = (sjt_dot319)->m23;
#line 36
...
#line 19
    sjt_dot320 = m;
#line 36
    sjt_math393 = (sjt_dot320)->m33;
#line 19
    sjt_dot321 = _parent;
#line 36
    sjt_math394 = (sjt_dot321)->m33;
#line 36
...
#line 19 "lib/ui/mat4.sj"
    sjt_dot322 = m;
#line 21
    sjt_math401 = (sjt_dot322)->m00;
#line 19
    sjt_dot323 = _parent;
#line 21
    sjt_math402 = (sjt_dot323)->m00;
#line 21
    sjt_math399 = sjt_math401 * sjt_math402;
#line 19
    sjt_dot324 = m;
#line 21
    sjt_math403 = (sjt_dot324)->m01;
#line 19
    sjt_dot325 = _parent;
#line 21
    sjt_math404 = (sjt_dot325)->m10;
#line 21
...
#line 19
    sjt_dot326 = m;
#line 21
    sjt_math405 = (sjt_dot326)->m02;
#line 19
    sjt_dot327 = _parent;
#line 21
    sjt_math406 = (sjt_dot327)->m20;
#line 21
...
#line 19
    sjt_dot328 = m;
#line 21
    sjt_math407 = (sjt_dot328)->m03;
#line 19
    sjt_dot329 = _parent;
#line 21
    sjt_math408 = (sjt_dot329)->m30;
#line 21
...
#line 19
    sjt_dot330 = m;
#line 22
    sjt_math415 = (sjt_dot330)->m00;
#line 19
    sjt_dot331 = _parent;
#line 22
    sjt_math416 = (sjt_dot331)->m01;
#line 22
    sjt_math413 = sjt_math415 * sjt_math416;
#line 19
    sjt_dot332 = m;
#line 22
    sjt_math417 = (sjt_dot332)->m01;
#line 19
    sjt_dot333 = _parent;
#line 22
    sjt_math418 = (sjt_dot333)->m11;
#line 22
...
#line 19
    sjt_dot334 = m;
#line 22
    sjt_math419 = (sjt_dot334)->m02;
#line 19
    sjt_dot335 = _parent;
#line 22
    sjt_math420 = (sjt_dot335)->m21;
#line 22
...
#line 19
    sjt_dot336 = m;
#line 22
    sjt_math421 = (sjt_dot336)->m03;
#line 19
    sjt_dot337 = _parent;
#line 22
    sjt_math422 = (sjt_dot337)->m31;
#line 22
...
#line 19
    sjt_dot338 = m;
#line 23
    sjt_math429 = (sjt_dot338)->m00;
#line 19
    sjt_dot339 = _parent;
#line 23
    sjt_math430 = (sjt_dot339)->m02;
#line 23
    sjt_math427 = sjt_math429 * sjt_math430;
#line 19
    sjt_dot340 = m;
#line 23
    sjt_math431 = (sjt_dot340)->m01;
#line 19
    sjt_dot341 = _parent;
#line 23
    sjt_math432 = (sjt_dot341)->m12;
#line 23
...
#line 19
    sjt_dot342 = m;
#line 23
    sjt_math433 = (sjt_dot342)->m02;
#line 19
    sjt_dot343 = _parent;
#line 23
    sjt_math434 = (sjt_dot343)->m22;
#line 23
...
#line 19
    sjt_dot344 = m;
#line 23
    sjt_math435 = (sjt_dot344)->m03;
#line 19
    sjt_dot345 = _parent;
#line 23
    sjt_math436 = (sjt_dot345)->m32;
#line 23
...
#line 19
    sjt_dot346 = m;
#line 24
    sjt_math443 = (sjt_dot346)->m00;
#line 19
    sjt_dot347 = _parent;
#line 24
    sjt_math444 = (sjt_dot347)->m03;
#line 24
    sjt_math441 = sjt_math443 * sjt_math444;
#line 19
    sjt_dot348 = m;
#line 24
    sjt_math445 = (sjt_dot348)->m01;
#line 19
    sjt_dot349 = _parent;
#line 24
    sjt_math446 = (sjt_dot349)->m13;
#line 24
...
#line 19
    sjt_dot350 = m;
#line 24
    sjt_math447 = (sjt_dot350)->m02;
#line 19
    sjt_dot351 = _parent;
#line 24
    sjt_math448 = (sjt_dot351)->m23;
#line 24
...
#line 19
    sjt_dot352 = m;
#line 24
    sjt_math449 = (sjt_dot352)->m03;
#line 19
    sjt_dot353 = _parent;
#line 24
    sjt_math450 = (sjt_dot353)->m33;
#line 24
...
#line 19
    sjt_dot354 = m;
#line 25
    sjt_math457 = (sjt_dot354)->m10;
#line 19
    sjt_dot355 = _parent;
#line 25
    sjt_math458 = (sjt_dot355)->m00;
#line 25
    sjt_math455 = sjt_math457 * sjt_math458;
#line 19
    sjt_dot356 = m;
#line 25
    sjt_math459 = (sjt_dot356)->m11;
#line 19
    sjt_dot357 = _parent;
#line 25
    sjt_math460 = (sjt_dot357)->m10;
#line 25
...
#line 19
    sjt_dot358 = m;
#line 25
    sjt_math461 = (sjt_dot358)->m12;
#line 19
    sjt_dot359 = _parent;
#line 25
    sjt_math462 = (sjt_dot359)->m20;
#line 25
...
#line 19
    sjt_dot360 = m;
#line 25
    sjt_math463 = (sjt_dot360)->m13;
#line 19
    sjt_dot361 = _parent;
#line 25
    sjt_math464 = (sjt_dot361)->m30;
#line 25
...
#line 19
    sjt_dot362 = m;
#line 26
    sjt_math471 = (sjt_dot362)->m10;
#line 19
    sjt_dot363 = _parent;
#line 26
    sjt_math472 = (sjt_dot363)->m01;
#line 26
    sjt_math469 = sjt_math471 * sjt_math472;
#line 19
    sjt_dot364 = m;
#line 26
    sjt_math473 = (sjt_dot364)->m11;
#line 19
    sjt_dot365 = _parent;
#line 26
    sjt_math474 = (sjt_dot365)->m11;
#line 26
...
#line 19
    sjt_dot366 = m;
#line 26
    sjt_math475 = (sjt_dot366)->m12;
#line 19
    sjt_dot367 = _parent;
#line 26
    sjt_math476 = (sjt_dot367)->m21;
#line 26
...
#line 19
    sjt_dot368 = m;
#line 26
    sjt_math477 = (sjt_dot368)->m13;
#line 19
    sjt_dot369 = _parent;
#line 26
    sjt_math478 = (sjt_dot369)->m31;
#line 26
...
#line 19
    sjt_dot370 = m;
#line 27
    sjt_math485 = (sjt_dot370)->m10;
#line 19
    sjt_dot371 = _parent;
#line 27
    sjt_math486 = (sjt_dot371)->m02;
#line 27
    sjt_math483 = sjt_math485 * sjt_math486;
#line 19
    sjt_dot372 = m;
#line 27
    sjt_math487 = (sjt_dot372)->m11;
#line 19
    sjt_dot373 = _parent;
#line 27
    sjt_math488 = (sjt_dot373)->m12;
#line 27
...
#line 19
    sjt_dot374 = m;
#line 27
    sjt_math489 = (sjt_dot374)->m12;
#line 19
    sjt_dot375 = _parent;
#line 27
    sjt_math490 = (sjt_dot375)->m22;
#line 27
...
#line 19
    sjt_dot376 = m;
#line 27
    sjt_math491 = (sjt_dot376)->m13;
#line 19
    sjt_dot377 = _parent;
#line 27
    sjt_math492 = (sjt_dot377)->m32;
#line 27
...
#line 19
    sjt_dot378 = m;
#line 28
    sjt_math499 = (sjt_dot378)->m10;
#line 19
    sjt_dot379 = _parent;
#line 28
    sjt_math500 = (sjt_dot379)->m03;
#line 28
    sjt_math497 = sjt_math499 * sjt_math500;
#line 19
    sjt_dot380 = m;
#line 28
    sjt_math501 = (sjt_dot380)->m11;
#line 19
    sjt_dot381 = _parent;
#line 28
    sjt_math502 = (sjt_dot381)->m13;
#line 28
...
#line 19
    sjt_dot382 = m;
#line 28
    sjt_math503 = (sjt_dot382)->m12;
#line 19
    sjt_dot383 = _parent;
#line 28
    sjt_math504 = (sjt_dot383)->m23;
#line 28
...
#line 19
    sjt_dot384 = m;
#line 28
    sjt_math505 = (sjt_dot384)->m13;
#line 19
    sjt_dot385 = _parent;
#line 28
    sjt_math506 = (sjt_dot385)->m33;
#line 28
...
#line 19
    sjt_dot386 = m;
#line 29
    sjt_math513 = (sjt_dot386)->m20;
#line 19
    sjt_dot387 = _parent;
#line 29
    sjt_math514 = (sjt_dot387)->m00;
#line 29
    sjt_math511 = sjt_math513 * sjt_math514;
#line 19
    sjt_dot388 = m;
#line 29
    sjt_math515 = (sjt_dot388)->m21;
#line 19
    sjt_dot389 = _parent;
#line 29
    sjt_math516 = (sjt_dot389)->m10;
#line 29
...
#line 19
    sjt_dot390 = m;
#line 29
    sjt_math517 = (sjt_dot390)->m22;
#line 19
    sjt_dot391 = _parent;
#line 29
    sjt_math518 = (sjt_dot391)->m20;
#line 29
...
#line 19
    sjt_dot392 = m;
#line 29
    sjt_math519 = (sjt_dot392)->m23;
#line 19
    sjt_dot393 = _parent;
#line 29
    sjt_math520 = (sjt_dot393)->m30;
#line 29
...
#line 19
    sjt_dot394 = m;
#line 30
    sjt_math527 = (sjt_dot394)->m20;
#line 19
    sjt_dot395 = _parent;
#line 30
    sjt_math528 = (sjt_dot395)->m01;
#line 30
    sjt_math525 = sjt_math527 * sjt_math528;
#line 19
    sjt_dot396 = m;
#line 30
    sjt_math529 = (sjt_dot396)->m21;
#line 19
    sjt_dot397 = _parent;
#line 30
    sjt_math530 = (sjt_dot397)->m11;
#line 30
...
#line 19
    sjt_dot398 = m;
#line 30
    sjt_math531 = (sjt_dot398)->m22;
#line 19
    sjt_dot399 = _parent;
#line 30
    sjt_math532 = (sjt_dot399)->m21;
#line 30
...
#line 19
    sjt_dot400 = m;
#line 30
    sjt_math533 = (sjt_dot400)->m23;
#line 19
    sjt_dot401 = _parent;
#line 30
    sjt_math534 = (sjt_dot401)->m31;
#line 30
...
#line 19
    sjt_dot402 = m;
#line 31
    sjt_math541 = (sjt_dot402)->m20;
#line 19
    sjt_dot403 = _parent;
#line 31
    sjt_math542 = (sjt_dot403)->m02;
#line 31
    sjt_math539 = sjt_math541 * sjt_math542;
#line 19
    sjt_dot404 = m;
#line 31
    sjt_math543 = (sjt_dot404)->m21;
#line 19
    sjt_dot405 = _parent;
#line 31
    sjt_math544 = (sjt_dot405)->m12;
#line 31
...
#line 19
    sjt_dot406 = m;
#line 31
    sjt_math545 = (sjt_dot406)->m22;
#line 19
    sjt_dot407 = _parent;
#line 31
    sjt_math546 = (sjt_dot407)->m22;
#line 31
...
#line 19
    sjt_dot408 = m;
#line 31
    sjt_math547 = (sjt_dot408)->m23;
#line 19
    sjt_dot409 = _parent;
#line 31
    sjt_math548 = (sjt_dot409)->m32;
#line 31
...
#line 19
    sjt_dot410 = m;
#line 32
    sjt_math555 = (sjt_dot410)->m20;
#line 19
    sjt_dot411 = _parent;
#line 32
    sjt_math556 = (sjt_dot411)->m03;
#line 32
    sjt_math553 = sjt_math555 * sjt_math556;
#line 19
    sjt_dot412 = m;
#line 32
    sjt_math557 = (sjt_dot412)->m21;
#line 19
    sjt_dot413 = _parent;
#line 32
    sjt_math558 = (sjt_dot413)->m13;
#line 32
...
#line 19
    sjt_dot414 = m;
#line 32
    sjt_math559 = (sjt_dot414)->m22;
#line 19
    sjt_dot415 = _parent;
#line 32
    sjt_math560 = (sjt_dot415)->m23;
#line 32
...
#line 19
    sjt_dot416 = m;
#line 32
    sjt_math561 = (sjt_dot416)->m23;
#line 19
    sjt_dot417 = _parent;
#line 32
    sjt_math562 = (sjt_dot417)->m33;
#line 32
...
#line 19
    sjt_dot418 = m;
#line 33
    sjt_math569 = (sjt_dot418)->m30;
#line 19
    sjt_dot419 = _parent;
#line 33
    sjt_math570 = (sjt_dot419)->m00;
#line 33
    sjt_math567 = sjt_math569 * sjt_math570;
#line 19
    sjt_dot420 = m;
#line 33
    sjt_math571 = (sjt_dot420)->m31;
#line 19
    sjt_dot421 = _parent;
#line 33
    sjt_math572 = (sjt_dot421)->m10;
#line 33
...
#line 19
    sjt_dot422 = m;
#line 33
    sjt_math573 = (sjt_dot422)->m32;
#line 19
    sjt_dot423 = _parent;
#line 33
    sjt_math574 = (sjt_dot423)->m20;
#line 33
...
#line 19
    sjt_dot424 = m;
#line 33
    sjt_math575 = (sjt_dot424)->m33;
#line 19
    sjt_dot425 = _parent;
#line 33
    sjt_math576 = (sjt_dot425)->m30;
#line 33
...
#line 19
    sjt_dot426 = m;
#line 34
    sjt_math583 = (sjt_dot426)->m30;
#line 19
    sjt_dot427 = _parent;
#line 34
    sjt_math584 = (sjt_dot427)->m01;
#line 34
    sjt_math581 = sjt_math583 * sjt_math584;
#line 19
    sjt_dot428 = m;
#line 34
    sjt_math585 = (sjt_dot428)->m31;
#line 19
    sjt_dot429 = _parent;
#line 34
    sjt_math586 = (sjt_dot429)->m11;
#line 34
...
#line 19
    sjt_dot430 = m;
#line 34
    sjt_math587 = (sjt_dot430)->m32;
#line 19
    sjt_dot431 = _parent;
#line 34
    sjt_math588 = (sjt_dot431)->m21;
#line 34
...
#line 19
    sjt_dot432 = m;
#line 34
    sjt_math589 = (sjt_dot432)->m33;
#line 19
    sjt_dot433 = _parent;
#line 34
    sjt_math590 = (sjt_dot433)->m31;
#line 34
...
#line 19
    sjt_dot434 = m;
#line 35
    sjt_math597 = (sjt_dot434)->m30;
#line 19
    sjt_dot435 = _parent;
#line 35
    sjt_math598 = (sjt_dot435)->m02;
#line 35
    sjt_math595 = sjt_math597 * sjt_math598;
#line 19
    sjt_dot436 = m;
#line 35
    sjt_math599 = (sjt_dot436)->m31;
#line 19
    sjt_dot437 = _parent;
#line 35
    sjt_math600 = (sjt_dot437)->m12;
#line 35
...
#line 19
    sjt_dot438 = m;
#line 35
    sjt_math601 = (sjt_dot438)->m32;
#line 19
    sjt_dot439 = _parent;
#line 35
    sjt_math602 = (sjt_dot439)->m22;
#line 35
...
#line 19
    sjt_dot440 = m;
#line 35
    sjt_math603 = (sjt_dot440)->m33;
#line 19
    sjt_dot441 = _parent;
#line 35
    sjt_math604 = (sjt_dot441)->m32;
#line 35
...
#line 19
    sjt_dot442 = m;
#line 36
    sjt_math611 = (sjt_dot442)->m30;
#line 19
    sjt_dot443 = _parent;
#line 36
    sjt_math612 = (sjt_dot443)->m03;
#line 36
    sjt_math609 = sjt_math611 * sjt_math612;
#line 19
    sjt_dot444 = m;
#line 36
    sjt_math613 = (sjt_dot444)->m31;
#line 19
    sjt_dot445 = _parent;
#line 36
    sjt_math614 = (sjt_dot445)->m13;
#line 36
...
#line 19
    sjt_dot446 = m;
#line 36
    sjt_math615 = (sjt_dot446)->m32;
#line 19
    sjt_dot447 = _parent;
#line 36
    sjt_math616 = (sjt_dot447)->m23;
#line 36
...
#line 19
    sjt_dot448 = m;
#line 36
    sjt_math617 = (sjt_dot448)->m33;
#line 19
    sjt_dot449 = _parent;
#line 36
    sjt_math618 = (sjt_dot449)->m33;
#line 36
...
#line 88 "lib/ui/mat4.sj"
    sjt_dot452 = _parent;
#line 89
    _return->m00 = (sjt_dot452)->m00;
#line 88
    sjt_dot453 = _parent;
#line 89
    _return->m01 = (sjt_dot453)->m10;
#line 88
    sjt_dot454 = _parent;
#line 89
    _return->m02 = (sjt_dot454)->m20;
#line 88
    sjt_dot455 = _parent;
#line 89
    _return->m03 = (sjt_dot455)->m30;
#line 88
    sjt_dot456 = _parent;
#line 89
    _return->m10 = (sjt_dot456)->m01;
#line 88
    sjt_dot457 = _parent;
#line 89
    _return->m11 = (sjt_dot457)->m11;
#line 88
    sjt_dot458 = _parent;
#line 89
    _return->m12 = (sjt_dot458)->m21;
#line 88
    sjt_dot459 = _parent;
#line 89
    _return->m13 = (sjt_dot459)->m31;
#line 88
    sjt_dot460 = _parent;
#line 89
    _return->m20 = (sjt_dot460)->m02;
#line 88
    sjt_dot461 = _parent;
#line 89
    _return->m21 = (sjt_dot461)->m12;
#line 88
    sjt_dot462 = _parent;
#line 89
    _return->m22 = (sjt_dot462)->m22;
#line 88
    sjt_dot463 = _parent;
#line 89
    _return->m23 = (sjt_dot463)->m32;
#line 88
    sjt_dot464 = _parent;
#line 89
    _return->m30 = (sjt_dot464)->m03;
#line 88
    sjt_dot465 = _parent;
#line 89
    _return->m31 = (sjt_dot465)->m13;
#line 88
    sjt_dot466 = _parent;
#line 89
    _return->m32 = (sjt_dot466)->m23;
#line 88
    sjt_dot467 = _parent;
#line 89
    _return->m33 = (sjt_dot467)->m33;
#line 89
    sjf_mat4(_return);
}
...
#line 88 "lib/ui/mat4.sj"
    sjt_dot468 = _parent;
#line 89
    (*_return)->m00 = (sjt_dot468)->m00;
#line 88
    sjt_dot469 = _parent;
#line 89
    (*_return)->m01 = (sjt_dot469)->m10;
#line 88
    sjt_dot470 = _parent;
#line 89
    (*_return)->m02 = (sjt_dot470)->m20;
#line 88
    sjt_dot471 = _parent;
#line 89
    (*_return)->m03 = (sjt_dot471)->m30;
#line 88
    sjt_dot472 = _parent;
#line 89
    (*_return)->m10 = (sjt_dot472)->m01;
#line 88
    sjt_dot473 = _parent;
#line 89
    (*_return)->m11 = (sjt_dot473)->m11;
#line 88
    sjt_dot474 = _parent;
#line 89
    (*_return)->m12 = (sjt_dot474)->m21;
#line 88
    sjt_dot475 = _parent;
#line 89
    (*_return)->m13 = (sjt_dot475)->m31;
#line 88
    sjt_dot476 = _parent;
#line 89
    (*_return)->m20 = (sjt_dot476)->m02;
#line 88
    sjt_dot477 = _parent;
#line 89
    (*_return)->m21 = (sjt_dot477)->m12;
#line 88
    sjt_dot478 = _parent;
#line 89
    (*_return)->m22 = (sjt_dot478)->m22;
#line 88
    sjt_dot479 = _parent;
#line 89
    (*_return)->m23 = (sjt_dot479)->m32;
#line 88
    sjt_dot480 = _parent;
#line 89
    (*_return)->m30 = (sjt_dot480)->m03;
#line 88
    sjt_dot481 = _parent;
#line 89
    (*_return)->m31 = (sjt_dot481)->m13;
#line 88
    sjt_dot482 = _parent;
#line 89
    (*_return)->m32 = (sjt_dot482)->m23;
#line 88
    sjt_dot483 = _parent;
#line 89
    (*_return)->m33 = (sjt_dot483)->m33;
#line 89
    sjf_mat4_heap((*_return));
}
...
sji_nauScene3dElement_model* sjf_model_as_sji_nauScene3dElement_model(sjs_model* _this) {
    ...
    _interface->render = (void(*)(void*,sjs_mat4*,sjs_mat4*,sjs_light*))sjf_model_render;
...
void sjf_model_render(sjs_model* _parent, sjs_mat4* projection, sjs_mat4* view, sjs_light* light) {
    sjs_mat4 sjt_call8;
    sjs_model* sjt_dot1188;
    sjs_model* sjt_dot450;
...
#line 21 "lib/ui/model.sj"
    sjt_dot450 = _parent;
#line 19 "lib/ui/mat4.sj"
    sjt_parent34 = &(sjt_dot450)->_parentWorld;
#line 21 "lib/ui/model.sj"
    sjt_dot451 = _parent;
#line 22
    sjt_functionParam65 = &(sjt_dot451)->world;
#line 22
...
#line 88 "lib/ui/vertexBuffer.sj"
    sjt_parent40 = &(sjt_dot1188)->vertexBuffer;
#line 88
...
void sjf_model_setWorld(sjs_model* _parent, sjs_mat4* world) {
    sjs_model* sjt_dot193;

#line 16 "lib/ui/model.sj"
    sjt_dot193 = _parent;
#line 16
    sjf_mat4_copy(&sjt_dot193->_parentWorld, world);
}
...
void sjf_nauScene3dElement_fireMouseEvent(sjs_nauScene3dElement* _parent, sjs_point* point, int32_t eventId) {
    ...
    sjs_nauScene3dElement* sjt_dot188;
...
#line 53 "nau/nauScene3dElement.sj"
        sjt_dot50 = _parent;
#line 55
        sjt_dot50->_isDragging = true;
#line 53
        sjt_dot51 = _parent;
#line 53
        sjf_point_copy(&sjt_dot51->_startDrag, point);
#line 53
        sjt_dot52 = _parent;
#line 53
        sjt_dot53 = _parent;
#line 57
        sjf_vec3_copy(&sjt_dot52->_lookAtDrag, &(sjt_dot53)->_lookAt);
    }
...
#line 53
    sjt_dot54 = _parent;
#line 60
    sjt_and8 = (sjt_dot54)->_isDragging;
#line 60
    ...
    if (sjt_ifElse3) {
        ...
        int32_t sjt_cast8;
        int32_t sjt_cast9;
        sjs_point* sjt_dot100;
        sjs_point* sjt_dot101;
        sjs_nauScene3dElement* sjt_dot102;
        sjs_rect* sjt_dot103;
        sjs_nauScene3dElement* sjt_dot104;
        sjs_nauScene3dElement* sjt_dot117;
        sjs_nauScene3dElement* sjt_dot118;
        sjs_nauScene3dElement* sjt_dot185;
        sjs_nauScene3dElement* sjt_dot55;
        sjs_nauScene3dElement* sjt_dot68;
        sjs_nauScene3dElement* sjt_dot81;
        sjs_nauScene3dElement* sjt_dot94;
        sjs_point* sjt_dot95;
        sjs_nauScene3dElement* sjt_dot96;
        sjs_point* sjt_dot97;
        sjs_rect* sjt_dot98;
        sjs_nauScene3dElement* sjt_dot99;
...
#line 53
        sjt_dot68 = _parent;
#line 61
        sjt_functionParam27 = &(sjt_dot68)->lookAtMax;
#line 53
        sjt_dot81 = _parent;
#line 61
        sjt_functionParam41 = &(sjt_dot81)->lookAtMin;
#line 53
        sjt_dot94 = _parent;
#line 21 "lib/ui/vec3.sj"
        sjt_parent13 = &(sjt_dot94)->_lookAtDrag;
#line 53 "nau/nauScene3dElement.sj"
        sjt_dot96 = _parent;
#line 1 "lib/ui/point.sj"
        sjt_dot95 = &(sjt_dot96)->_startDrag;
#line 62 "nau/nauScene3dElement.sj"
        sjt_math61 = (sjt_dot95)->x;
#line 53
        sjt_dot97 = point;
#line 62
        sjt_math62 = (sjt_dot97)->x;
#line 62
        sjt_cast7 = sjt_math61 - sjt_math62;
#line 62
        sjt_math59 = (float)sjt_cast7;
#line 53
        sjt_dot99 = _parent;
#line 1 "lib/ui/rect.sj"
        sjt_dot98 = &(sjt_dot99)->_rect;
#line 62 "nau/nauScene3dElement.sj"
        sjt_cast8 = (sjt_dot98)->w;
#line 62
        sjt_math60 = (float)sjt_cast8;
#line 62
...
#line 53
        sjt_dot102 = _parent;
#line 1 "lib/ui/point.sj"
        sjt_dot101 = &(sjt_dot102)->_startDrag;
#line 63 "nau/nauScene3dElement.sj"
        sjt_math68 = (sjt_dot101)->y;
#line 63
        sjt_cast9 = sjt_math67 - sjt_math68;
#line 63
        sjt_math65 = (float)sjt_cast9;
#line 53
        sjt_dot104 = _parent;
#line 1 "lib/ui/rect.sj"
        sjt_dot103 = &(sjt_dot104)->_rect;
#line 63 "nau/nauScene3dElement.sj"
        sjt_cast10 = (sjt_dot103)->h;
#line 63
        sjt_math66 = (float)sjt_cast10;
#line 63
...
#line 61
        sjf_vec3_min(sjt_functionParam27, sjt_functionParam28, &sjt_dot55->_lookAt);
#line 53
        sjt_dot117 = _parent;
#line 29 "lib/ui/vec3.sj"
        sjt_parent14 = &(sjt_dot117)->_lookAt;
...
#line 53
        sjt_dot185 = _parent;
#line 67
        sjt_functionParam60 = &(sjt_dot185)->_lookAt;
#line 67
        sjt_call7.x = 0.0f;
#line 67
        sjt_call7.y = 1.0f;
...
#line 67
        sjf_mat4_lookAtLH(sjt_functionParam59, sjt_functionParam60, sjt_functionParam61, &sjt_dot118->view);
...
#line 53 "nau/nauScene3dElement.sj"
        sjt_dot189 = _parent;
#line 7 "lib/common/array.sj"
        sjt_parent31 = &(sjt_dot189)->children;
#line 74 "nau/nauScene3dElement.sj"
...
#line 53 "nau/nauScene3dElement.sj"
        sjt_dot190 = _parent;
#line 4 "lib/ui/model.sj"
        sjt_interfaceParam9 = &(sjt_dot190)->_rect;
#line 53 "nau/nauScene3dElement.sj"
        sjt_dot191 = _parent;
#line 4 "lib/ui/model.sj"
        sjt_interfaceParam10 = &(sjt_dot191)->projection;
#line 53 "nau/nauScene3dElement.sj"
        sjt_dot192 = _parent;
#line 4 "lib/ui/model.sj"
        sjt_interfaceParam11 = &(sjt_dot192)->view;
#line 53 "nau/nauScene3dElement.sj"
        sjt_interfaceParam12 = point;
#line 53
        sjt_interfaceParam13 = eventId;
#line 76
        sjt_parent32->fireMouseEvent((void*)(((char*)sjt_parent32->_parent) + sizeof(intptr_t)), sjt_interfaceParam9, sjt_interfaceParam10, sjt_interfaceParam11, sjt_interfaceParam12, sjt_interfaceParam13);
#line 74
        i++;
...
#line 28 "nau/nauScene3dElement.sj"
        sjt_dot47 = _parent;
#line 3 "lib/ui/model.sj"
        sjt_interfaceParam6 = &(sjt_dot47)->projection;
#line 28 "nau/nauScene3dElement.sj"
        sjt_dot48 = _parent;
#line 3 "lib/ui/model.sj"
        sjt_interfaceParam7 = &(sjt_dot48)->view;
#line 28 "nau/nauScene3dElement.sj"
        sjt_dot49 = _parent;
#line 3 "lib/ui/model.sj"
        sjt_interfaceParam8 = &(sjt_dot49)->light;
#line 40 "nau/nauScene3dElement.sj"
        sjt_parent12->render((void*)(((char*)sjt_parent12->_parent) + sizeof(intptr_t)), sjt_interfaceParam6, sjt_interfaceParam7, sjt_interfaceParam8);
#line 38
        i++;
...
#line 20 "nau/nauScene3dElement.sj"
        sjt_dot31 = _parent;
#line 20
        sjf_rect_copy(&sjt_dot31->_rect, rect_);
#line 20
        sjt_dot32 = _parent;
#line 20
        sjt_dot33 = _parent;
...
#line 23 "nau/nauScene3dElement.sj"
        sjt_cast5 = (sjt_dot34)->h;
#line 23
        sjt_math43 = (float)sjt_cast5;
#line 20
        sjt_dot37 = _parent;
#line 1 "lib/ui/rect.sj"
        sjt_dot36 = &(sjt_dot37)->_rect;
#line 23 "nau/nauScene3dElement.sj"
        sjt_cast6 = (sjt_dot36)->w;
#line 23
        sjt_math44 = (float)sjt_cast6;
#line 23
...
sji_nauScene3dElement_model* sjf_panel3d_as_sji_nauScene3dElement_model(sjs_panel3d* _this) {
    ...
    _interface->render = (void(*)(void*,sjs_mat4*,sjs_mat4*,sjs_light*))sjf_panel3d_render;
...
void sjf_panel3d_fireMouseEvent(sjs_panel3d* _parent, sjs_rect* sceneRect, sjs_mat4* projection, sjs_mat4* view, sjs_point* point, int32_t eventId) {
    int32_t i;
    sjs_array_heap_model* sjt_dot1217;
    sjs_panel3d* sjt_dot1218;
...
#line 21
    sjt_dot1218 = _parent;
#line 1 "lib/common/array.sj"
    sjt_dot1217 = &(sjt_dot1218)->children;
#line 22 "lib/ui/panel3d.sj"
    sjt_forEnd14 = (sjt_dot1217)->count;
#line 22
    i = sjt_forStart14;
    while (i < sjt_forEnd14) {
        sjs_panel3d* sjt_dot1219;
        int32_t sjt_functionParam179;
        sjs_rect* sjt_interfaceParam27;
        sjs_mat4* sjt_interfaceParam28;
        sjs_mat4* sjt_interfaceParam29;
        sjs_point* sjt_interfaceParam30;
        int32_t sjt_interfaceParam31;
...
#line 21 "lib/ui/panel3d.sj"
        sjt_dot1219 = _parent;
#line 7 "lib/common/array.sj"
        sjt_parent85 = &(sjt_dot1219)->children;
#line 22 "lib/ui/panel3d.sj"
...
#line 4 "lib/ui/model.sj"
        sjt_parent86 = sjv_c;
#line 21 "lib/ui/panel3d.sj"
        sjt_interfaceParam27 = sceneRect;
#line 21
        sjt_interfaceParam28 = projection;
#line 21
        sjt_interfaceParam29 = view;
#line 21
        sjt_interfaceParam30 = point;
#line 21
        sjt_interfaceParam31 = eventId;
#line 24
        sjt_parent86->fireMouseEvent((void*)(((char*)sjt_parent86->_parent) + sizeof(intptr_t)), sjt_interfaceParam27, sjt_interfaceParam28, sjt_interfaceParam29, sjt_interfaceParam30, sjt_interfaceParam31);
#line 22
        i++;
...
void sjf_panel3d_render(sjs_panel3d* _parent, sjs_mat4* projection, sjs_mat4* view, sjs_light* light) {
    int32_t i;
    sjs_array_heap_model* sjt_dot1214;
    sjs_panel3d* sjt_dot1215;
...
#line 14
    sjt_dot1215 = _parent;
#line 1 "lib/common/array.sj"
    sjt_dot1214 = &(sjt_dot1215)->children;
#line 15 "lib/ui/panel3d.sj"
    sjt_forEnd13 = (sjt_dot1214)->count;
#line 15
    i = sjt_forStart13;
    while (i < sjt_forEnd13) {
        ...
        sjs_light* sjt_interfaceParam26;
...
#line 14 "lib/ui/panel3d.sj"
        sjt_dot1216 = _parent;
#line 7 "lib/common/array.sj"
        sjt_parent83 = &(sjt_dot1216)->children;
#line 15 "lib/ui/panel3d.sj"
...
#line 3 "lib/ui/model.sj"
        sjt_parent84 = sjv_c;
#line 14 "lib/ui/panel3d.sj"
        sjt_interfaceParam24 = projection;
#line 14
        sjt_interfaceParam25 = view;
#line 14
        sjt_interfaceParam26 = light;
#line 17
        sjt_parent84->render((void*)(((char*)sjt_parent84->_parent) + sizeof(intptr_t)), sjt_interfaceParam24, sjt_interfaceParam25, sjt_interfaceParam26);
#line 15
        i++;
...
void sjf_panel3d_setWorld(sjs_panel3d* _parent, sjs_mat4* world_) {
    int32_t i;
    sjs_panel3d* sjt_dot1210;
    sjs_array_heap_model* sjt_dot1211;
    sjs_panel3d* sjt_dot1212;
...
#line 5
    sjt_dot1210 = _parent;
#line 6
    sjt_functionParam176 = &(sjt_dot1210)->world;
#line 6
...
#line 5
    sjt_dot1212 = _parent;
#line 1 "lib/common/array.sj"
    sjt_dot1211 = &(sjt_dot1212)->children;
#line 7 "lib/ui/panel3d.sj"
    sjt_forEnd12 = (sjt_dot1211)->count;
#line 7
    i = sjt_forStart12;
...
#line 5 "lib/ui/panel3d.sj"
        sjt_dot1213 = _parent;
#line 7 "lib/common/array.sj"
        sjt_parent81 = &(sjt_dot1213)->children;
#line 7 "lib/ui/panel3d.sj"
...
#line 2 "lib/ui/model.sj"
        sjt_parent82 = sjv_c;
#line 2
        sjt_interfaceParam23 = &sjv_totalWorld;
#line 9 "lib/ui/panel3d.sj"
        sjt_parent82->setWorld((void*)(((char*)sjt_parent82->_parent) + sizeof(intptr_t)), sjt_interfaceParam23);
#line 7
        i++;
...
#line 3 "lib/common/array.sj"
    sjt_cast15 = 0;
#line 3
    (*_return)->indices.data = (uintptr_t)sjt_cast15;
#line 4
    (*_return)->indices._isGlobal = false;
#line 5
    (*_return)->indices.count = 0;
...
#line 3 "lib/common/array.sj"
    sjt_cast16 = 0;
#line 3
    (*_return)->vertices.data = (uintptr_t)sjt_cast16;
#line 4
    (*_return)->vertices._isGlobal = false;
#line 5
    (*_return)->vertices.count = 0;
...
void sjf_rect_containsPoint(sjs_rect* _parent, sjs_point* point, bool* _return) {
    ...
    sjs_rect* sjt_dot1251;
    sjs_point* sjt_dot1252;
    sjs_rect* sjt_dot1253;
    sjs_point* sjt_dot1254;
    sjs_point* sjt_dot1255;
    sjs_rect* sjt_dot1256;
    sjs_rect* sjt_dot1257;
    sjs_point* sjt_dot1258;
    sjs_rect* sjt_dot1259;
...
#line 11 "lib/ui/rect.sj"
    sjt_dot1251 = _parent;
#line 12
    sjt_compare19 = (sjt_dot1251)->x;
#line 11
    sjt_dot1252 = point;
#line 12
    sjt_compare20 = (sjt_dot1252)->x;
#line 12
    sjt_and9 = sjt_compare19 <= sjt_compare20;
#line 11
    sjt_dot1253 = _parent;
#line 12
    sjt_compare21 = (sjt_dot1253)->y;
#line 11
    sjt_dot1254 = point;
#line 12
    sjt_compare22 = (sjt_dot1254)->x;
#line 12
    sjt_and11 = sjt_compare21 <= sjt_compare22;
#line 11
    sjt_dot1255 = point;
#line 12
    sjt_compare23 = (sjt_dot1255)->x;
#line 11
    sjt_dot1256 = _parent;
#line 12
    sjt_math1991 = (sjt_dot1256)->x;
#line 11
    sjt_dot1257 = _parent;
#line 12
    sjt_math1992 = (sjt_dot1257)->w;
#line 12
...
#line 11
    sjt_dot1258 = point;
#line 12
    sjt_compare25 = (sjt_dot1258)->y;
#line 11
    sjt_dot1259 = _parent;
#line 12
    sjt_math1993 = (sjt_dot1259)->y;
#line 11
    sjt_dot1260 = _parent;
#line 12
    sjt_math1994 = (sjt_dot1260)->h;
#line 12
...
#line 16 "lib/ui/size.sj"
    sjt_parent122 = &(sjt_dot1278)->_size;
#line 27 "lib/ui/scene2d.sj"
...
#line 28
    ...
    if (sjt_ifElse16) {
        ...
        sjs_scene2d* sjt_dot1282;
        sjs_size* sjt_dot1283;
        sjs_scene2d* sjt_dot1284;
...
#line 27 "lib/ui/scene2d.sj"
        sjt_dot1279 = _parent;
#line 27
        sjf_size_copy(&sjt_dot1279->_size, size);
#line 27
        sjt_dot1280 = _parent;
#line 30
...
#line 27
        sjt_dot1282 = _parent;
#line 1 "lib/ui/size.sj"
        sjt_dot1281 = &(sjt_dot1282)->_size;
#line 30 "lib/ui/scene2d.sj"
        sjt_cast38 = (sjt_dot1281)->w;
#line 30
        sjt_functionParam388 = (float)sjt_cast38;
#line 30
        sjt_math2071 = 0;
#line 27
        sjt_dot1284 = _parent;
#line 1 "lib/ui/size.sj"
        sjt_dot1283 = &(sjt_dot1284)->_size;
#line 30 "lib/ui/scene2d.sj"
        sjt_math2072 = (sjt_dot1283)->h;
#line 30
        sjt_cast39 = sjt_math2071 - sjt_math2072;
#line 30
        sjt_functionParam389 = (float)sjt_cast39;
#line 30
...
#line 30
        sjf_mat4_orthographic(sjt_functionParam387, sjt_functionParam388, sjt_functionParam389, sjt_functionParam390, sjt_functionParam391, sjt_functionParam392, &sjt_dot1280->projection);
#line 27
        sjt_dot1285 = _parent;
#line 31
...
#line 31
        sjf_mat4_scale(sjt_functionParam393, sjt_functionParam394, sjt_functionParam395, &sjt_dot1285->model);
#line 27
        sjt_dot1286 = _parent;
#line 27
        sjf_mat4_identity(&sjt_dot1286->view);
    }
}
...
#line 16 "lib/ui/size.sj"
    sjt_dot1274 = _parent;
#line 17
    sjt_compare31 = (sjt_dot1274)->w;
#line 16
    sjt_dot1275 = size;
#line 17
    sjt_compare32 = (sjt_dot1275)->w;
#line 17
    sjt_and15 = sjt_compare31 == sjt_compare32;
#line 16
    sjt_dot1276 = _parent;
#line 17
    sjt_compare33 = (sjt_dot1276)->h;
#line 16
    sjt_dot1277 = size;
#line 17
    sjt_compare34 = (sjt_dot1277)->h;
#line 17
...
#line 21 "lib/ui/vec3.sj"
    sjt_dot82 = _parent;
#line 23
    sjt_math45 = (sjt_dot82)->x;
#line 21
    sjt_dot83 = v;
#line 23
    sjt_math46 = (sjt_dot83)->x;
#line 23
    _return->x = sjt_math45 + sjt_math46;
#line 21
    sjt_dot84 = _parent;
#line 24
    sjt_math47 = (sjt_dot84)->y;
#line 21
    sjt_dot85 = v;
#line 24
    sjt_math48 = (sjt_dot85)->y;
#line 24
    _return->y = sjt_math47 + sjt_math48;
#line 21
    sjt_dot86 = _parent;
#line 25
    sjt_math49 = (sjt_dot86)->z;
#line 21
    sjt_dot87 = v;
#line 25
    sjt_math50 = (sjt_dot87)->z;
#line 25
...
#line 21 "lib/ui/vec3.sj"
    sjt_dot88 = _parent;
#line 23
    sjt_math51 = (sjt_dot88)->x;
#line 21
    sjt_dot89 = v;
#line 23
    sjt_math52 = (sjt_dot89)->x;
#line 23
    (*_return)->x = sjt_math51 + sjt_math52;
#line 21
    sjt_dot90 = _parent;
#line 24
    sjt_math53 = (sjt_dot90)->y;
#line 21
    sjt_dot91 = v;
#line 24
    sjt_math54 = (sjt_dot91)->y;
#line 24
    (*_return)->y = sjt_math53 + sjt_math54;
#line 21
    sjt_dot92 = _parent;
#line 25
    sjt_math55 = (sjt_dot92)->z;
#line 21
    sjt_dot93 = v;
#line 25
    sjt_math56 = (sjt_dot93)->z;
#line 25
...
#line 46 "lib/ui/vec3.sj"
    sjt_dot137 = _parent;
#line 48
    sjt_math115 = (sjt_dot137)->y;
#line 46
    sjt_dot138 = v;
#line 48
    sjt_math116 = (sjt_dot138)->z;
#line 48
    sjt_math113 = sjt_math115 * sjt_math116;
#line 46
    sjt_dot139 = _parent;
#line 48
    sjt_math117 = (sjt_dot139)->z;
#line 46
    sjt_dot140 = v;
#line 48
    sjt_math118 = (sjt_dot140)->y;
#line 48
...
#line 46
    sjt_dot141 = _parent;
#line 49
    sjt_math121 = (sjt_dot141)->z;
#line 46
    sjt_dot142 = v;
#line 49
    sjt_math122 = (sjt_dot142)->x;
#line 49
    sjt_math119 = sjt_math121 * sjt_math122;
#line 46
    sjt_dot143 = _parent;
#line 49
    sjt_math123 = (sjt_dot143)->x;
#line 46
    sjt_dot144 = v;
#line 49
    sjt_math124 = (sjt_dot144)->z;
#line 49
...
#line 46
    sjt_dot145 = _parent;
#line 50
    sjt_math127 = (sjt_dot145)->x;
#line 46
    sjt_dot146 = v;
#line 50
    sjt_math128 = (sjt_dot146)->y;
#line 50
    sjt_math125 = sjt_math127 * sjt_math128;
#line 46
    sjt_dot147 = _parent;
#line 50
    sjt_math129 = (sjt_dot147)->y;
#line 46
    sjt_dot148 = v;
#line 50
    sjt_math130 = (sjt_dot148)->x;
#line 50
...
#line 46 "lib/ui/vec3.sj"
    sjt_dot149 = _parent;
#line 48
    sjt_math133 = (sjt_dot149)->y;
#line 46
    sjt_dot150 = v;
#line 48
    sjt_math134 = (sjt_dot150)->z;
#line 48
    sjt_math131 = sjt_math133 * sjt_math134;
#line 46
    sjt_dot151 = _parent;
#line 48
    sjt_math135 = (sjt_dot151)->z;
#line 46
    sjt_dot152 = v;
#line 48
    sjt_math136 = (sjt_dot152)->y;
#line 48
...
#line 46
    sjt_dot153 = _parent;
#line 49
    sjt_math139 = (sjt_dot153)->z;
#line 46
    sjt_dot154 = v;
#line 49
    sjt_math140 = (sjt_dot154)->x;
#line 49
    sjt_math137 = sjt_math139 * sjt_math140;
#line 46
    sjt_dot155 = _parent;
#line 49
    sjt_math141 = (sjt_dot155)->x;
#line 46
    sjt_dot156 = v;
#line 49
    sjt_math142 = (sjt_dot156)->z;
#line 49
...
#line 46
    sjt_dot157 = _parent;
#line 50
    sjt_math145 = (sjt_dot157)->x;
#line 46
    sjt_dot158 = v;
#line 50
    sjt_math146 = (sjt_dot158)->y;
#line 50
    sjt_math143 = sjt_math145 * sjt_math146;
#line 46
    sjt_dot159 = _parent;
#line 50
    sjt_math147 = (sjt_dot159)->y;
#line 46
    sjt_dot160 = v;
#line 50
    sjt_math148 = (sjt_dot160)->x;
#line 50
...
#line 54
    sjt_dot171 = v;
#line 55
    sjt_math156 = (sjt_dot171)->x;
#line 55
    sjt_math153 = sjt_math155 * sjt_math156;
#line 54
    sjt_dot172 = _parent;
#line 55
    sjt_math157 = (sjt_dot172)->y;
#line 54
    sjt_dot173 = v;
#line 55
    sjt_math158 = (sjt_dot173)->y;
#line 55
...
#line 54
    sjt_dot174 = _parent;
#line 55
    sjt_math159 = (sjt_dot174)->z;
#line 54
    sjt_dot175 = v;
#line 55
    sjt_math160 = (sjt_dot175)->z;
#line 55
...
#line 67 "lib/ui/vec3.sj"
    sjt_dot69 = a;
#line 69
    sjt_functionParam29 = (sjt_dot69)->x;
#line 67
    sjt_dot70 = b;
#line 69
    sjt_functionParam30 = (sjt_dot70)->x;
#line 69
    sjf_f32_max(sjt_functionParam29, sjt_functionParam30, &_return->x);
#line 67
    sjt_dot71 = a;
#line 70
    sjt_functionParam31 = (sjt_dot71)->y;
#line 67
    sjt_dot72 = b;
#line 70
    sjt_functionParam32 = (sjt_dot72)->y;
#line 70
    sjf_f32_max(sjt_functionParam31, sjt_functionParam32, &_return->y);
#line 67
    sjt_dot73 = a;
#line 71
    sjt_functionParam33 = (sjt_dot73)->z;
#line 67
    sjt_dot74 = b;
#line 71
    sjt_functionParam34 = (sjt_dot74)->z;
#line 71
...
#line 67 "lib/ui/vec3.sj"
    sjt_dot75 = a;
#line 69
    sjt_functionParam35 = (sjt_dot75)->x;
#line 67
    sjt_dot76 = b;
#line 69
    sjt_functionParam36 = (sjt_dot76)->x;
#line 69
    sjf_f32_max(sjt_functionParam35, sjt_functionParam36, &(*_return)->x);
#line 67
    sjt_dot77 = a;
#line 70
    sjt_functionParam37 = (sjt_dot77)->y;
#line 67
    sjt_dot78 = b;
#line 70
    sjt_functionParam38 = (sjt_dot78)->y;
#line 70
    sjf_f32_max(sjt_functionParam37, sjt_functionParam38, &(*_return)->y);
#line 67
    sjt_dot79 = a;
#line 71
    sjt_functionParam39 = (sjt_dot79)->z;
#line 67
    sjt_dot80 = b;
#line 71
    sjt_functionParam40 = (sjt_dot80)->z;
#line 71
...
#line 59 "lib/ui/vec3.sj"
    sjt_dot56 = a;
#line 61
    sjt_functionParam15 = (sjt_dot56)->x;
#line 59
    sjt_dot57 = b;
#line 61
    sjt_functionParam16 = (sjt_dot57)->x;
#line 61
    sjf_f32_min(sjt_functionParam15, sjt_functionParam16, &_return->x);
#line 59
    sjt_dot58 = a;
#line 62
    sjt_functionParam17 = (sjt_dot58)->y;
#line 59
    sjt_dot59 = b;
#line 62
    sjt_functionParam18 = (sjt_dot59)->y;
#line 62
    sjf_f32_min(sjt_functionParam17, sjt_functionParam18, &_return->y);
#line 59
    sjt_dot60 = a;
#line 63
    sjt_functionParam19 = (sjt_dot60)->z;
#line 59
    sjt_dot61 = b;
#line 63
    sjt_functionParam20 = (sjt_dot61)->z;
#line 63
...
#line 59 "lib/ui/vec3.sj"
    sjt_dot62 = a;
#line 61
    sjt_functionParam21 = (sjt_dot62)->x;
#line 59
    sjt_dot63 = b;
#line 61
    sjt_functionParam22 = (sjt_dot63)->x;
#line 61
    sjf_f32_min(sjt_functionParam21, sjt_functionParam22, &(*_return)->x);
#line 59
    sjt_dot64 = a;
#line 62
    sjt_functionParam23 = (sjt_dot64)->y;
#line 59
    sjt_dot65 = b;
#line 62
    sjt_functionParam24 = (sjt_dot65)->y;
#line 62
    sjf_f32_min(sjt_functionParam23, sjt_functionParam24, &(*_return)->y);
#line 59
    sjt_dot66 = a;
#line 63
    sjt_functionParam25 = (sjt_dot66)->z;
#line 59
    sjt_dot67 = b;
#line 63
    sjt_functionParam26 = (sjt_dot67)->z;
#line 63
...
#line 37 "lib/ui/vec3.sj"
    sjt_dot119 = _parent;
#line 38
    sjt_math85 = (sjt_dot119)->x;
#line 37
    sjt_dot120 = _parent;
#line 38
    sjt_math86 = (sjt_dot120)->x;
#line 38
    sjt_math83 = sjt_math85 * sjt_math86;
#line 37
    sjt_dot121 = _parent;
#line 38
    sjt_math87 = (sjt_dot121)->y;
#line 37
    sjt_dot122 = _parent;
#line 38
    sjt_math88 = (sjt_dot122)->y;
#line 38
...
#line 37
    sjt_dot123 = _parent;
#line 38
    sjt_math89 = (sjt_dot123)->z;
#line 37
    sjt_dot124 = _parent;
#line 38
    sjt_math90 = (sjt_dot124)->z;
#line 38
...
#line 37 "lib/ui/vec3.sj"
    sjt_dot128 = _parent;
#line 38
    sjt_math101 = (sjt_dot128)->x;
#line 37
    sjt_dot129 = _parent;
#line 38
    sjt_math102 = (sjt_dot129)->x;
#line 38
    sjt_math99 = sjt_math101 * sjt_math102;
#line 37
    sjt_dot130 = _parent;
#line 38
    sjt_math103 = (sjt_dot130)->y;
#line 37
    sjt_dot131 = _parent;
#line 38
    sjt_math104 = (sjt_dot131)->y;
#line 38
...
#line 37
    sjt_dot132 = _parent;
#line 38
    sjt_math105 = (sjt_dot132)->z;
#line 37
    sjt_dot133 = _parent;
#line 38
    sjt_math106 = (sjt_dot133)->z;
#line 38
...
#line 29 "lib/ui/vec3.sj"
    sjt_dot105 = _parent;
#line 31
    sjt_math69 = (sjt_dot105)->x;
#line 29
    sjt_dot106 = v;
#line 31
    sjt_math70 = (sjt_dot106)->x;
#line 31
    _return->x = sjt_math69 - sjt_math70;
#line 29
    sjt_dot107 = _parent;
#line 32
    sjt_math71 = (sjt_dot107)->y;
#line 29
    sjt_dot108 = v;
#line 32
    sjt_math72 = (sjt_dot108)->y;
#line 32
    _return->y = sjt_math71 - sjt_math72;
#line 29
    sjt_dot109 = _parent;
#line 33
    sjt_math73 = (sjt_dot109)->z;
#line 29
    sjt_dot110 = v;
#line 33
    sjt_math74 = (sjt_dot110)->z;
#line 33
...
#line 29 "lib/ui/vec3.sj"
    sjt_dot111 = _parent;
#line 31
    sjt_math75 = (sjt_dot111)->x;
#line 29
    sjt_dot112 = v;
#line 31
    sjt_math76 = (sjt_dot112)->x;
#line 31
    (*_return)->x = sjt_math75 - sjt_math76;
#line 29
    sjt_dot113 = _parent;
#line 32
    sjt_math77 = (sjt_dot113)->y;
#line 29
    sjt_dot114 = v;
#line 32
    sjt_math78 = (sjt_dot114)->y;
#line 32
    (*_return)->y = sjt_math77 - sjt_math78;
#line 29
    sjt_dot115 = _parent;
#line 33
    sjt_math79 = (sjt_dot115)->z;
#line 29
    sjt_dot116 = v;
#line 33
    sjt_math80 = (sjt_dot116)->z;
#line 33
...
#line 7
    array8 = &sjt_cast2->children;
#line 7
    sjt_parent7 = array8;
#line 7
    sjt_functionParam4 = 0;
#line 7
    sjt_cast4 = (sjs_nauScene3dElement_heap*)malloc(sizeof(sjs_nauScene3dElement_heap));
#line 7
    sjt_cast4->_refCount = 1;
#line 11
    sjt_cast4->children.dataSize = 3;
#line 3 "lib/common/array.sj"
    sjt_cast11 = 0;
#line 3
    sjt_cast4->children.data = (uintptr_t)sjt_cast11;
#line 4
...
#line 11
    array5 = &sjt_cast4->children;
#line 11
    sjt_parent33 = array5;
#line 11
    sjt_functionParam63 = 0;
#line 11
    sjt_cast12 = (sjs_model_heap*)malloc(sizeof(sjs_model_heap));
#line 11
...
#line 74
    sjf_planeVertexBuffer(sjt_functionParam109, sjt_functionParam110, sjt_functionParam111, sjt_functionParam112, sjt_functionParam113, sjt_functionParam114, sjt_functionParam115, sjt_functionParam116, sjt_functionParam117, &sjt_cast12->vertexBuffer);
#line 12 "nau.sj"
    sjf_shader_copy(&sjt_cast12->shader, &sjv_phongTextureShader);
#line 13
    sjt_call17.count = 17;
#line 13
...
#line 13
    sjf_textureFromPng(sjt_functionParam118, &sjt_cast12->texture);
#line 11 "lib/ui/model.sj"
    sjt_cast12->scale = 1.0f;
#line 2 "lib/ui/vec3.sj"
    sjt_cast12->center.x = 0.0f;
#line 3
    sjt_cast12->center.y = 0.0f;
#line 4
    sjt_cast12->center.z = 0.0f;
#line 4
    sjf_vec3(&sjt_cast12->center);
#line 15 "nau.sj"
...
#line 15
    sjf_mat4_multiply(sjt_parent61, sjt_functionParam122, &sjt_cast12->world);
#line 2 "lib/ui/mat4.sj"
    sjt_cast12->_parentWorld.m00 = 0.0f;
#line 3
    sjt_cast12->_parentWorld.m01 = 0.0f;
#line 4
    sjt_cast12->_parentWorld.m02 = 0.0f;
#line 5
    sjt_cast12->_parentWorld.m03 = 0.0f;
#line 6
    sjt_cast12->_parentWorld.m10 = 0.0f;
#line 7
    sjt_cast12->_parentWorld.m11 = 0.0f;
#line 8
    sjt_cast12->_parentWorld.m12 = 0.0f;
#line 9
    sjt_cast12->_parentWorld.m13 = 0.0f;
#line 10
    sjt_cast12->_parentWorld.m20 = 0.0f;
#line 11
    sjt_cast12->_parentWorld.m21 = 0.0f;
#line 12
    sjt_cast12->_parentWorld.m22 = 0.0f;
#line 13
    sjt_cast12->_parentWorld.m23 = 0.0f;
#line 14
    sjt_cast12->_parentWorld.m30 = 0.0f;
#line 15
    sjt_cast12->_parentWorld.m31 = 0.0f;
#line 16
    sjt_cast12->_parentWorld.m32 = 0.0f;
#line 17
    sjt_cast12->_parentWorld.m33 = 0.0f;
#line 17
    sjf_mat4(&sjt_cast12->_parentWorld);
#line 17
    sjf_model_heap(sjt_cast12);
#line 1 "lib/ui/model.sj"
    sjt_functionParam64 = (sji_nauScene3dElement_model*)sjf_model_heap_as_sji_nauScene3dElement_model(sjt_cast12);
#line 1
...
#line 11
    sjt_cast17 = (sjs_leafPanel_heap*)malloc(sizeof(sjs_leafPanel_heap));
#line 11
    sjt_cast17->_refCount = 1;
#line 20
    sjt_cast17->textures.dataSize = 8;
#line 3 "lib/common/array.sj"
    sjt_cast23 = 0;
#line 3
    sjt_cast17->textures.data = (uintptr_t)sjt_cast23;
#line 4
    sjt_cast17->textures._isGlobal = false;
#line 5
    sjt_cast17->textures.count = 0;
#line 5
    sjf_array_texture(&sjt_cast17->textures);
#line 20 "nau.sj"
    sjs_array_texture* array6;
#line 20
    array6 = &sjt_cast17->textures;
#line 20
    sjt_parent71 = array6;
#line 20
...
#line 2 "lib/common/array.sj"
    sjt_cast17->children.dataSize = 0;
#line 3
    sjt_cast24 = 0;
#line 3
    sjt_cast17->children.data = (uintptr_t)sjt_cast24;
#line 4
...
#line 27 "nau/leafPanel.sj"
    sjt_cast17->_angle = 0.1f;
#line 27
    sjf_leafPanel_heap(sjt_cast17);
#line 1 "lib/ui/model.sj"
    sjt_functionParam127 = (sji_nauScene3dElement_model*)sjf_leafPanel_heap_as_sji_nauScene3dElement_model(sjt_cast17);
#line 1
...
#line 11
    sjt_cast25 = (sjs_panel3d_heap*)malloc(sizeof(sjs_panel3d_heap));
#line 11
...
#line 33
    sjf_mat4_translate(sjt_functionParam180, sjt_functionParam181, sjt_functionParam182, &sjt_cast25->world);
#line 34
    sjt_cast25->children.dataSize = 10;
#line 3 "lib/common/array.sj"
    sjt_cast26 = 0;
#line 3
    sjt_cast25->children.data = (uintptr_t)sjt_cast26;
#line 4
    sjt_cast25->children._isGlobal = false;
#line 5
    sjt_cast25->children.count = 0;
#line 5
    sjf_array_heap_model(&sjt_cast25->children);
#line 34 "nau.sj"
    sjs_array_heap_model* array7;
#line 34
    array7 = &sjt_cast25->children;
#line 34
    sjt_parent87 = array7;
#line 34
...
#line 74
    sjf_planeVertexBuffer(sjt_functionParam185, sjt_functionParam186, sjt_functionParam187, sjt_functionParam188, sjt_functionParam189, sjt_functionParam190, sjt_functionParam191, sjt_functionParam192, sjt_functionParam193, &sjt_cast27->vertexBuffer);
#line 35 "nau.sj"
    sjf_shader_copy(&sjt_cast27->shader, &sjv_phongTextureShader);
#line 36
    sjt_call38.count = 16;
#line 36
...
#line 36
    sjf_textureFromPng(sjt_functionParam194, &sjt_cast27->texture);
#line 11 "lib/ui/model.sj"
    sjt_cast27->scale = 1.0f;
#line 2 "lib/ui/vec3.sj"
...
#line 38
    sjf_mat4_multiply(sjt_parent88, sjt_functionParam198, &sjt_cast27->world);
#line 2 "lib/ui/mat4.sj"
    sjt_cast27->_parentWorld.m00 = 0.0f;
#line 3
    sjt_cast27->_parentWorld.m01 = 0.0f;
#line 4
    sjt_cast27->_parentWorld.m02 = 0.0f;
#line 5
    sjt_cast27->_parentWorld.m03 = 0.0f;
#line 6
    sjt_cast27->_parentWorld.m10 = 0.0f;
#line 7
    sjt_cast27->_parentWorld.m11 = 0.0f;
#line 8
    sjt_cast27->_parentWorld.m12 = 0.0f;
#line 9
    sjt_cast27->_parentWorld.m13 = 0.0f;
#line 10
    sjt_cast27->_parentWorld.m20 = 0.0f;
#line 11
    sjt_cast27->_parentWorld.m21 = 0.0f;
#line 12
    sjt_cast27->_parentWorld.m22 = 0.0f;
#line 13
    sjt_cast27->_parentWorld.m23 = 0.0f;
#line 14
    sjt_cast27->_parentWorld.m30 = 0.0f;
#line 15
    sjt_cast27->_parentWorld.m31 = 0.0f;
#line 16
    sjt_cast27->_parentWorld.m32 = 0.0f;
#line 17
    sjt_cast27->_parentWorld.m33 = 0.0f;
#line 17
    sjf_mat4(&sjt_cast27->_parentWorld);
#line 17
    sjf_model_heap(sjt_cast27);
#line 1 "lib/ui/model.sj"
    sjt_functionParam184 = (sji_nauScene3dElement_model*)sjf_model_heap_as_sji_nauScene3dElement_model(sjt_cast27);
#line 1
...
#line 74
    sjf_planeVertexBuffer(sjt_functionParam204, sjt_functionParam205, sjt_functionParam206, sjt_functionParam207, sjt_functionParam208, sjt_functionParam209, sjt_functionParam210, sjt_functionParam211, sjt_functionParam212, &sjt_cast28->vertexBuffer);
#line 43 "nau.sj"
    sjf_shader_copy(&sjt_cast28->shader, &sjv_phongTextureShader);
#line 44
    sjt_call41.count = 16;
#line 44
...
#line 44
    sjf_textureFromPng(sjt_functionParam213, &sjt_cast28->texture);
#line 11 "lib/ui/model.sj"
...
#line 46
    sjf_mat4_multiply(sjt_parent90, sjt_functionParam217, &sjt_cast28->world);
#line 2 "lib/ui/mat4.sj"
...
#line 1 "lib/ui/model.sj"
    sjt_functionParam203 = (sji_nauScene3dElement_model*)sjf_model_heap_as_sji_nauScene3dElement_model(sjt_cast28);
#line 1
...
#line 74
    sjf_planeVertexBuffer(sjt_functionParam223, sjt_functionParam224, sjt_functionParam225, sjt_functionParam226, sjt_functionParam227, sjt_functionParam228, sjt_functionParam229, sjt_functionParam230, sjt_functionParam231, &sjt_cast29->vertexBuffer);
#line 51 "nau.sj"
    sjf_shader_copy(&sjt_cast29->shader, &sjv_phongTextureShader);
#line 52
    sjt_call44.count = 16;
#line 52
...
#line 52
    sjf_textureFromPng(sjt_functionParam232, &sjt_cast29->texture);
#line 11 "lib/ui/model.sj"
...
#line 54
    sjf_mat4_multiply(sjt_parent92, sjt_functionParam236, &sjt_cast29->world);
#line 2 "lib/ui/mat4.sj"
...
#line 1 "lib/ui/model.sj"
    sjt_functionParam222 = (sji_nauScene3dElement_model*)sjf_model_heap_as_sji_nauScene3dElement_model(sjt_cast29);
#line 1
...
#line 74
    sjf_planeVertexBuffer(sjt_functionParam242, sjt_functionParam243, sjt_functionParam244, sjt_functionParam245, sjt_functionParam246, sjt_functionParam247, sjt_functionParam248, sjt_functionParam249, sjt_functionParam250, &sjt_cast30->vertexBuffer);
#line 59 "nau.sj"
    sjf_shader_copy(&sjt_cast30->shader, &sjv_phongTextureShader);
#line 60
    sjt_call47.count = 16;
#line 60
...
#line 60
    sjf_textureFromPng(sjt_functionParam251, &sjt_cast30->texture);
#line 11 "lib/ui/model.sj"
...
#line 62
    sjf_mat4_multiply(sjt_parent94, sjt_functionParam255, &sjt_cast30->world);
#line 2 "lib/ui/mat4.sj"
...
#line 1 "lib/ui/model.sj"
    sjt_functionParam241 = (sji_nauScene3dElement_model*)sjf_model_heap_as_sji_nauScene3dElement_model(sjt_cast30);
#line 1
...
#line 74
    sjf_planeVertexBuffer(sjt_functionParam261, sjt_functionParam262, sjt_functionParam263, sjt_functionParam264, sjt_functionParam265, sjt_functionParam266, sjt_functionParam267, sjt_functionParam268, sjt_functionParam269, &sjt_cast31->vertexBuffer);
#line 66 "nau.sj"
    sjf_shader_copy(&sjt_cast31->shader, &sjv_phongTextureShader);
#line 67
    sjt_call50.count = 16;
#line 67
...
#line 67
    sjf_textureFromPng(sjt_functionParam270, &sjt_cast31->texture);
#line 11 "lib/ui/model.sj"
...
#line 69
    sjf_mat4_multiply(sjt_parent96, sjt_functionParam274, &sjt_cast31->world);
#line 2 "lib/ui/mat4.sj"
...
#line 1 "lib/ui/model.sj"
    sjt_functionParam260 = (sji_nauScene3dElement_model*)sjf_model_heap_as_sji_nauScene3dElement_model(sjt_cast31);
#line 1
...
#line 74
    sjf_planeVertexBuffer(sjt_functionParam280, sjt_functionParam281, sjt_functionParam282, sjt_functionParam283, sjt_functionParam284, sjt_functionParam285, sjt_functionParam286, sjt_functionParam287, sjt_functionParam288, &sjt_cast32->vertexBuffer);
#line 73 "nau.sj"
    sjf_shader_copy(&sjt_cast32->shader, &sjv_phongTextureShader);
#line 74
    sjt_call53.count = 16;
#line 74
...
#line 74
    sjf_textureFromPng(sjt_functionParam289, &sjt_cast32->texture);
#line 11 "lib/ui/model.sj"
...
#line 76
    sjf_mat4_multiply(sjt_parent98, sjt_functionParam293, &sjt_cast32->world);
#line 2 "lib/ui/mat4.sj"
...
#line 1 "lib/ui/model.sj"
    sjt_functionParam279 = (sji_nauScene3dElement_model*)sjf_model_heap_as_sji_nauScene3dElement_model(sjt_cast32);
#line 1
...
#line 74
    sjf_planeVertexBuffer(sjt_functionParam299, sjt_functionParam300, sjt_functionParam301, sjt_functionParam302, sjt_functionParam303, sjt_functionParam304, sjt_functionParam305, sjt_functionParam306, sjt_functionParam307, &sjt_cast33->vertexBuffer);
#line 80 "nau.sj"
    sjf_shader_copy(&sjt_cast33->shader, &sjv_phongTextureShader);
#line 81
    sjt_call56.count = 16;
#line 81
...
#line 81
    sjf_textureFromPng(sjt_functionParam308, &sjt_cast33->texture);
#line 11 "lib/ui/model.sj"
...
#line 83
    sjf_mat4_multiply(sjt_parent100, sjt_functionParam312, &sjt_cast33->world);
#line 2 "lib/ui/mat4.sj"
...
#line 1 "lib/ui/model.sj"
    sjt_functionParam298 = (sji_nauScene3dElement_model*)sjf_model_heap_as_sji_nauScene3dElement_model(sjt_cast33);
#line 1
...
#line 74
    sjf_planeVertexBuffer(sjt_functionParam318, sjt_functionParam319, sjt_functionParam320, sjt_functionParam321, sjt_functionParam322, sjt_functionParam323, sjt_functionParam324, sjt_functionParam325, sjt_functionParam326, &sjt_cast34->vertexBuffer);
#line 87 "nau.sj"
    sjf_shader_copy(&sjt_cast34->shader, &sjv_phongTextureShader);
#line 88
    sjt_call59.count = 16;
#line 88
...
#line 88
    sjf_textureFromPng(sjt_functionParam327, &sjt_cast34->texture);
#line 11 "lib/ui/model.sj"
...
#line 90
    sjf_mat4_multiply(sjt_parent102, sjt_functionParam331, &sjt_cast34->world);
#line 2 "lib/ui/mat4.sj"
...
#line 1 "lib/ui/model.sj"
    sjt_functionParam317 = (sji_nauScene3dElement_model*)sjf_model_heap_as_sji_nauScene3dElement_model(sjt_cast34);
#line 1
...
#line 74
    sjf_planeVertexBuffer(sjt_functionParam337, sjt_functionParam338, sjt_functionParam339, sjt_functionParam340, sjt_functionParam341, sjt_functionParam342, sjt_functionParam343, sjt_functionParam344, sjt_functionParam345, &sjt_cast35->vertexBuffer);
#line 94 "nau.sj"
    sjf_shader_copy(&sjt_cast35->shader, &sjv_phongTextureShader);
#line 95
    sjt_call62.count = 16;
#line 95
...
#line 95
    sjf_textureFromPng(sjt_functionParam346, &sjt_cast35->texture);
#line 11 "lib/ui/model.sj"
...
#line 97
    sjf_mat4_multiply(sjt_parent104, sjt_functionParam350, &sjt_cast35->world);
#line 2 "lib/ui/mat4.sj"
...
#line 1 "lib/ui/model.sj"
    sjt_functionParam336 = (sji_nauScene3dElement_model*)sjf_model_heap_as_sji_nauScene3dElement_model(sjt_cast35);
#line 1
...
#line 74
    sjf_planeVertexBuffer(sjt_functionParam356, sjt_functionParam357, sjt_functionParam358, sjt_functionParam359, sjt_functionParam360, sjt_functionParam361, sjt_functionParam362, sjt_functionParam363, sjt_functionParam364, &sjt_cast36->vertexBuffer);
#line 101 "nau.sj"
    sjf_shader_copy(&sjt_cast36->shader, &sjv_phongTextureShader);
#line 102
    sjt_call65.count = 16;
#line 102
...
#line 102
    sjf_textureFromPng(sjt_functionParam365, &sjt_cast36->texture);
#line 11 "lib/ui/model.sj"
...
#line 104
    sjf_mat4_multiply(sjt_parent106, sjt_functionParam369, &sjt_cast36->world);
#line 2 "lib/ui/mat4.sj"
...
#line 1 "lib/ui/model.sj"
    sjt_functionParam355 = (sji_nauScene3dElement_model*)sjf_model_heap_as_sji_nauScene3dElement_model(sjt_cast36);
#line 1
    sjf_array_heap_model_initAt(sjt_parent105, sjt_functionParam354, sjt_functionParam355);
#line 1
    sjf_panel3d_heap(sjt_cast25);
#line 1
    sjt_functionParam175 = (sji_nauScene3dElement_model*)sjf_panel3d_heap_as_sji_nauScene3dElement_model(sjt_cast25);
#line 1
...
#line 9
    sjt_cast4->lookAtMin.x = result43;
#line 9
    sjt_negate43 = 1.0f;
#line 9
    result44 = -sjt_negate43;
#line 9
    sjt_cast4->lookAtMin.y = result44;
#line 9
    sjt_cast4->lookAtMin.z = 0.0f;
#line 9
    sjf_vec3(&sjt_cast4->lookAtMin);
#line 10
    sjt_cast4->lookAtMax.x = 16.0f;
#line 10
    sjt_cast4->lookAtMax.y = 1.0f;
#line 10
    sjt_cast4->lookAtMax.z = 6.0f;
#line 10
    sjf_vec3(&sjt_cast4->lookAtMax);
...
#line 2 "lib/ui/scene3dElement.sj"
    sjt_cast4->light.pos.x = 1.0f;
#line 2
    sjt_cast4->light.pos.y = 1.0f;
#line 2
    sjt_cast4->light.pos.z = 1.0f;
#line 2
    sjf_vec3(&sjt_cast4->light.pos);
#line 3
    sjt_cast4->light.diffuseColor.r = 0.5f;
#line 3
    sjt_cast4->light.diffuseColor.g = 0.5f;
#line 3
    sjt_cast4->light.diffuseColor.b = 0.0f;
#line 3
    sjt_cast4->light.diffuseColor.a = 1.0f;
#line 3
    sjf_color(&sjt_cast4->light.diffuseColor);
#line 4
    sjt_cast4->light.specColor.r = 1.0f;
#line 4
    sjt_cast4->light.specColor.g = 1.0f;
#line 4
    sjt_cast4->light.specColor.b = 1.0f;
#line 4
    sjt_cast4->light.specColor.a = 1.0f;
#line 4
    sjf_color(&sjt_cast4->light.specColor);
#line 4
    sjf_light(&sjt_cast4->light);
#line 2 "lib/ui/mat4.sj"
...
#line 10
    sjf_mat4_lookAtLH(sjt_functionParam373, sjt_functionParam374, sjt_functionParam375, &sjt_cast4->view);
#line 10
    sjf_mat4_identity(&sjt_cast4->world);
...
#line 48 "nau/nauScene3dElement.sj"
    sjt_cast4->_isDragging = false;
#line 2 "lib/ui/point.sj"
    sjt_cast4->_startDrag.x = 0;
#line 3
    sjt_cast4->_startDrag.y = 0;
#line 3
    sjf_point(&sjt_cast4->_startDrag);
#line 50 "nau/nauScene3dElement.sj"
    sjt_cast4->_lookAt.x = 0.0f;
#line 50
    sjt_cast4->_lookAt.y = 0.0f;
#line 50
    sjt_cast4->_lookAt.z = 0.0f;
#line 50
    sjf_vec3(&sjt_cast4->_lookAt);
#line 2 "lib/ui/vec3.sj"
    sjt_cast4->_lookAtDrag.x = 0.0f;
#line 3
    sjt_cast4->_lookAtDrag.y = 0.0f;
#line 4
    sjt_cast4->_lookAtDrag.z = 0.0f;
#line 4
    sjf_vec3(&sjt_cast4->_lookAtDrag);
#line 4
    sjf_nauScene3dElement_heap(sjt_cast4);
#line 1 "lib/ui/element.sj"
    sjt_functionParam5 = (sji_element*)sjf_nauScene3dElement_heap_as_sji_element(sjt_cast4);
#line 1
...
#line 7
    sjt_cast37 = (sjs_crossHairsElement_heap*)malloc(sizeof(sjs_crossHairsElement_heap));
#line 7
    sjt_cast37->_refCount = 1;
#line 2 "lib/ui/color.sj"
    sjt_parent112 = &sjv_colors;
#line 2
    sjf_anon8_red(sjt_parent112, &sjt_cast37->color);
#line 2 "lib/ui/rect.sj"
...
#line 4 "lib/ui/crossHairsElement.sj"
    sjt_cast37->_topDownRenderer = 0;
    if (sjt_cast37->_topDownRenderer != 0) {
        sjt_cast37->_topDownRenderer->_refCount++;
    }

#line 5
    sjt_cast37->_leftRightRenderer = 0;
    if (sjt_cast37->_leftRightRenderer != 0) {
        sjt_cast37->_leftRightRenderer->_refCount++;
    }

#line 2 "lib/ui/point.sj"
    sjt_cast37->_point.x = 0;
#line 3
    sjt_cast37->_point.y = 0;
#line 3
    sjf_point(&sjt_cast37->_point);
#line 3
    sjf_crossHairsElement_heap(sjt_cast37);
#line 1 "lib/ui/element.sj"
    sjt_functionParam377 = (sji_element*)sjf_crossHairsElement_heap_as_sji_element(sjt_cast37);
#line 1
...
void main_destroy() {
    ...
    if (sjt_cast17->_refCount <= 0) {
        sjf_leafPanel_destroy((sjs_leafPanel*)(((char*)sjt_cast17) + sizeof(intptr_t)));
    }
    sjt_cast2->_refCount--;
    ...
    if (sjt_cast25->_refCount <= 0) {
        sjf_panel3d_destroy((sjs_panel3d*)(((char*)sjt_cast25) + sizeof(intptr_t)));
    }
    ...
    if (sjt_cast37->_refCount <= 0) {
        sjf_crossHairsElement_destroy((sjs_crossHairsElement*)(((char*)sjt_cast37) + sizeof(intptr_t)));
    }
    sjt_cast4->_refCount--;
    if (sjt_cast4->_refCount <= 0) {
        sjf_nauScene3dElement_destroy((sjs_nauScene3dElement*)(((char*)sjt_cast4) + sizeof(intptr_t)));
    }
