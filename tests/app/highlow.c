...
const char* sjg_string2 = "Too Low\n";
const char* sjg_string3 = "Too high\n";
...
int main() {
    ...
    while (sjt_while1) {
        ...
        sjt_dot3 = &console;
        sjf_anon1_readLine(&str);
        sjt_dot4 = &parse;
        sjt_functionParam2 = &str;
        sjf_anon2_toInt(sjt_functionParam2, &guess);
        sjt_compare1 = guess;
        sjt_compare2 = num;
        ...
        if (sjt_ifElse1) {
            ...
            sjt_call2.data.data = (uintptr_t)sjg_string2;
            ...
            if (sjt_ifElse2) {
                ...
                sjt_call3.data.data = (uintptr_t)sjg_string3;
