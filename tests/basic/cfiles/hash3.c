...
#line 12
    sjf_hash_string_heap_iface_interface_getat_heap(sjt_parent3, sjt_functionParam4, &g_b);
    if (g_b._parent != 0) {
...
#line 3 "hash3.sj"
        sjt_parent7 = g_b;
#line 13
        sjt_parent7._vtbl->bob(sjt_parent7._parent, &sjt_call4);
#line 13
...
#line 3 "hash3.sj"
            sjt_parent8 = g_b;
#line 13
            sjt_parent8._vtbl->bob(sjt_parent8._parent, &sjt_call5);
#line 13
            sjt_value3 = &sjt_call5;
#line 13
            sjt_functionParam8 = sjt_value3;
        } else {
#line 13 "hash3.sj"
...
#line 13
        sjt_call6.data.datasize = 9;
#line 13
        sjt_call6.data.data = (void*)sjg_string3;
#line 13
        sjt_call6.data.isglobal = true;
#line 13
        sjt_call6.data.count = 9;
#line 13
