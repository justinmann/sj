...
#define sjs_func_typeId 27
#define sji_bar_typeId 26
...
void sjf_func_heap(sjs_func* _this) {
    sjs_func* sjt_cast2 = 0;

#line 6 "function27.sj"
    sjt_cast2 = _this;
#line 6
    delete_cb weakptrcb1 = { &g_c._parent, weakptr_clear };
#line 6
    if (g_c._parent != 0) { weakptr_cb_remove(g_c._parent, weakptrcb1); }
#line 4
    sjf_func_as_sji_bar(sjt_cast2, &g_c);
#line 4
    delete_cb weakptrcb2 = { &g_c._parent, weakptr_clear };
#line 4
    if (g_c._parent != 0) { weakptr_cb_add(g_c._parent, weakptrcb2); }
}
...
#line 2 "function27.sj"
    g_c._parent = 0;
#line 2
    g_a = (sjs_func*)malloc(sizeof(sjs_func));
#line 2
    g_a->_refCount = 1;
#line 2
    sjf_func_heap(g_a);
...
void main_destroy() {
    ...
    if (g_a->_refCount <= 0) {
        weakptr_release(g_a);
        sjf_func_destroy(g_a);
        free(g_a);
    }
    delete_cb weakptrcb3 = { &g_c._parent, weakptr_clear };
    if (g_c._parent != 0) { weakptr_cb_remove(g_c._parent, weakptrcb3); }
