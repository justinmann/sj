...
#line 8
    sjf_string_getat(sjt_parent5, sjt_functionParam5, &g_h);
#line 9
    g_i = g_h == 'h';
...
#line 10
    sjf_string_isequal(sjt_parent6, sjt_functionParam6, &g_j);
#line 110 "lib/sj-lib-common/string.sj"
    sjt_parent7 = &g_f;
#line 11 "string1.sj"
    sjt_functionParam7 = &g_a;
#line 11
    sjf_string_islessorequal(sjt_parent7, sjt_functionParam7, &g_k);
#line 12
    g_l = (&g_f) == (&g_a);
    main_destroy();
    return 0;
