...
int main(int argc, char** argv) {
    ...
    sjv_stack_x4._refCount = 1;
    sjf_foo_copy(&sjv_stack_x4, sjv_local_y);
    main_destroy();
    return 0;
}
...
;
    if (sjv_stack_x4._refCount == 1) { sjf_foo_destroy(&sjv_stack_x4); }
;
