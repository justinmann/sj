...
#define sjs_bob_typeId 26
#define sji_foo_typeId 29
#define cb_bob_heap_bob_typeId 30
#define cb_bob_heap_bob_heap_typeId 30
...
#line 13
    sjt_cast2 = &sjt_call1;
#line 4
    sjf_class_as_sji_foo(sjt_cast2, &g_f);
#line 4
    delete_cb weakptrcb1 = { &g_f._parent, weakptr_clear };
#line 4
    if (g_f._parent != 0) { weakptr_cb_add(g_f._parent, weakptrcb1); }
    if (g_f._parent != 0) {
        sji_foo sjt_capture2 = { 0 };
        cb_bob_heap_bob sjt_value2;

#line 14 "callback5.sj"
        sjt_capture2 = g_f;
#line 14
        sjt_value2._parent = sjt_capture2._parent;
#line 14
        sjt_value2._cb = sjt_capture2._vtbl->getbar;
#line 14
        sjt_value2._cb_heap = sjt_capture2._vtbl->getbar_heap;
#line 14
        g_cb = sjt_value2;
    } else {
#line 14 "callback5.sj"
    ...
    if ((g_cb._parent != 0)) {
        sjs_bob g_a = { -1 };
        sjs_bob* g_b = 0;
        cb_bob_heap_bob ifValue1;
        cb_bob_heap_bob sjt_getValue1;

#line 15 "callback5.sj"
        sjt_getValue1 = g_cb;
#line 15
        ifValue1 = sjt_getValue1;
#line 15
        ifValue1._cb(ifValue1._parent, &g_a);
#line 15
        ifValue1._cb_heap(ifValue1._parent, &g_b);
        ...
        if (g_a._refCount == 1) { sjf_bob_destroy(&g_a); }
;
    }
    main_destroy();
    return 0;
...
void main_destroy() {
    ...
    delete_cb weakptrcb2 = { &g_f._parent, weakptr_clear };
    if (g_f._parent != 0) { weakptr_cb_remove(g_f._parent, weakptrcb2); }
