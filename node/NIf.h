...
public:
    static shared_ptr<CIfElseVar> create(const CLoc& loc, shared_ptr<CFunction> thisFunction, shared_ptr<CVar> thisVar, shared_ptr<NBase> condition, shared_ptr<NBase> ifBlock, shared_ptr<NBase> elseBlock);
