...
#line 167 "lib/sj-lib-common/array.sj"
    i = left;
#line 167
    j = right;
#line 171
...
#line 173 "lib/sj-lib-common/array.sj"
...
#line 174 "lib/sj-lib-common/array.sj"
            i = i + 1;
#line 173
...
#line 178 "lib/sj-lib-common/array.sj"
            j = j - 1;
#line 177
...
#line 182 "lib/sj-lib-common/array.sj"
...
#line 194 "lib/sj-lib-common/array.sj"
...
void sjf_i32_compare(int32_t l, int32_t r, int32_t* _return) {
    if (l == r) {
#line 70 "lib/sj-lib-common/i32.sj"
        (*_return) = 0;
    } else {
        if (l < r) {
            int32_t result4;

#line 72 "lib/sj-lib-common/i32.sj"
            result4 = -1;
#line 72
            (*_return) = result4;
        } else {
#line 74 "lib/sj-lib-common/i32.sj"
            (*_return) = 1;
        }
    }
}
