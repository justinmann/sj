...
#line 18
    sjf_class_foo(_parent, sjt_functionParam4, _return);
}
...
#line 13
        sjf_math_sub(sjt_parent3, sjt_functionParam6, sjt_functionParam7, &sjt_functionParam5);
#line 13
        sjf_class_bar(_parent, sjt_functionParam5, _return);
    } else {
#line 15 "class15.sj"
        (*_return) = 0;
    }
...
#line 11
    sjt_parent4 = &g_c;
#line 24
    sjt_functionParam8 = 4;
#line 24
    sjf_class_foo(sjt_parent4, sjt_functionParam8, &sjt_void1);
    main_destroy();
    return 0;
}
...
;
    if (g_math._refCount == 1) { sjf_math_destroy(&g_math); }
;
