...
sjs_array sjg_string2 = { 1, 10, 10, " kaka pipi"};
sjs_array sjg_string3 = { 1, 18, 18, "timetocalc(msec): "};
...
#line 30
        sjf_array_char_getsize(sjt_parent3, &sjt_capture3);
...
#line 30
        sjf_array_char_getsize(sjt_parent12, &sjt_capture6);
...
#line 18 "lib/sj-lib-common/string.sj"
            sjf_string_copy(&sjt_funcold3, &g_str);
#line 18
            sjt_parent26 = &g_str;
#line 4 "perf1.sj"
