...
#define sjs_namespace1_class_typeId 28
#define sji_namespace1_foo_typeId 29
#define sjs_namespace2_class_typeId 31
#define sji_namespace2_foo_typeId 32
...
sji_namespace1_foo g_a = { 0 };
sji_namespace2_foo g_b = { 0 };
...
#line 22 "interface1.sj"
    sjt_cast2 = &sjt_call1;
#line 3
    sjf_namespace1_class_as_sji_namespace1_foo(sjt_cast2, &g_a);
#line 3
...
#line 23
    sjt_cast3 = &sjt_call2;
#line 13
    sjf_namespace2_class_as_sji_namespace2_foo(sjt_cast3, &g_b);
    main_destroy();
    return 0;
}
