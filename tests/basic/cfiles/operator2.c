...
#define sjs_class_i32_char_typeId 22
...
#line 9
    sjf_i32_addclass_bang_i32_char(sjt_functionParam1, sjt_functionParam2, &g_a);
#line 10
...
#line 10
    sjf_i32_addclass_bang_i32_char(sjt_functionParam3, sjt_functionParam4, &g_b);
    main_destroy();
    return 0;
}
