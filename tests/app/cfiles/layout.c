...
void sjf_borderchild_copy(sjs_borderchild* _this, sjs_borderchild* _from) {
#line 13 "lib/ui/borderLayout.sj"
...
#line 36 "lib/ui/borderLayout.sj"
...
void sjf_borderchild_getposition(sjs_borderchild* _parent, int32_t* _return) {
#line 18 "lib/ui/borderLayout.sj"
    (*_return) = _parent->position;
}

void sjf_borderchild_getrect(sjs_borderchild* _parent, sjs_rect* _return) {
    _return->_refCount = 1;
#line 24 "lib/ui/borderLayout.sj"
...
#line 20 "lib/ui/borderLayout.sj"
...
#line 32 "lib/ui/borderLayout.sj"
...
#line 41 "lib/ui/borderLayout.sj"
...
#line 101 "lib/ui/borderLayout.sj"
...
void sjf_borderlayout_getrect(sjs_borderlayout* _parent, sjs_rect* _return) {
    _return->_refCount = 1;
#line 50 "lib/ui/borderLayout.sj"
    sjf_rect_copy(_return, &_parent->_rect);
}
...
void sjf_borderlayout_getsize(sjs_borderlayout* _parent, sjs_size* maxsize, sjs_size* _return) {
    _return->_refCount = 1;
#line 47 "lib/ui/borderLayout.sj"
    _return->w = maxsize->w;
#line 47
    _return->h = maxsize->h;
#line 47
...
#line 95 "lib/ui/borderLayout.sj"
    sjt_forStart14 = 0;
#line 95
...
#line 94 "lib/ui/borderLayout.sj"
...
void sjf_borderlayout_setrect(sjs_borderlayout* _parent, sjs_rect* rect_) {
    ...
    if (_parent->_rect._refCount == 1) { sjf_rect_destroy(&_parent->_rect); }
;
#line 52 "lib/ui/borderLayout.sj"
    sjf_rect_copy(&_parent->_rect, rect_);
#line 52
    sjt_parent78 = rect_;
#line 54
...
#line 55 "lib/ui/borderLayout.sj"
...
#line 10 "lib/ui/borderLayout.sj"
            sjt_parent80 = sjv_borderchild;
#line 58
            sjt_parent80._vtbl->getposition(sjt_parent80._parent, &sjt_value4);
#line 58
            sjt_capture14.isvalid = true;
#line 58
            sjt_capture14.value = sjt_value4;
        } else {
#line 58 "lib/ui/borderLayout.sj"
...
#line 61 "lib/ui/borderLayout.sj"
            sjt_call27.w = (&sjv_remaining)->w;
#line 61
            sjt_call27.h = (&sjv_remaining)->h;
#line 61
            sjf_size(&sjt_call27);
#line 61
...
#line 63 "lib/ui/borderLayout.sj"
                sjt_call28.x = (&sjv_remaining)->x;
#line 63
                sjt_call28.y = (&sjv_remaining)->y;
#line 63
                sjt_call28.w = (&sjv_childsize)->w;
#line 63
                sjt_call28.h = (&sjv_remaining)->h;
#line 63
                sjf_rect(&sjt_call28);
#line 63
...
#line 1 "lib/ui/rect.sj"
                sjf_rect_copy(&sjt_funcold3, &sjv_remaining);
#line 1
                sjt_funcold3._refCount = 1;
#line 64 "lib/ui/borderLayout.sj"
                sjt_funcold3.x = (&sjv_remaining)->x + (&sjv_childsize)->w;
#line 64
                sjt_funcold3.y = (&sjv_remaining)->y;
#line 64
                sjt_funcold3.w = (&sjv_remaining)->w - (&sjv_childsize)->w;
#line 64
                sjt_funcold3.h = (&sjv_remaining)->h;
#line 64
...
;
#line 1 "lib/ui/rect.sj"
                sjf_rect_copy(&sjv_remaining, &sjt_funcold3);
            } else {
...
#line 67 "lib/ui/borderLayout.sj"
                    sjt_call29.x = ((&sjv_remaining)->x + (&sjv_remaining)->w) - (&sjv_childsize)->w;
#line 67
                    sjt_call29.y = (&sjv_remaining)->y;
#line 67
                    sjt_call29.w = (&sjv_childsize)->w;
#line 67
...
#line 1 "lib/ui/rect.sj"
                    sjf_rect_copy(&sjt_funcold4, &sjv_remaining);
#line 1
                    sjt_funcold4._refCount = 1;
#line 68 "lib/ui/borderLayout.sj"
                    sjt_funcold4.x = (&sjv_remaining)->x;
#line 68
                    sjt_funcold4.y = (&sjv_remaining)->y;
#line 68
                    sjt_funcold4.w = (&sjv_remaining)->w - (&sjv_childsize)->w;
#line 68
                    sjt_funcold4.h = (&sjv_remaining)->h;
#line 68
                    sjf_rect(&sjt_funcold4);
#line 68
                    if (sjv_remaining._refCount == 1) { sjf_rect_destroy(&sjv_remaining); }
;
#line 1 "lib/ui/rect.sj"
                    sjf_rect_copy(&sjv_remaining, &sjt_funcold4);
                } else {
...
#line 71 "lib/ui/borderLayout.sj"
                        sjt_call30.x = (&sjv_remaining)->x;
#line 71
                        sjt_call30.y = (&sjv_remaining)->y;
#line 71
                        sjt_call30.w = (&sjv_remaining)->w;
#line 71
                        sjt_call30.h = (&sjv_childsize)->h;
#line 71
                        sjf_rect(&sjt_call30);
#line 71
...
#line 1
                        sjt_funcold5._refCount = 1;
#line 72 "lib/ui/borderLayout.sj"
                        sjt_funcold5.x = (&sjv_remaining)->x;
#line 72
                        sjt_funcold5.y = (&sjv_remaining)->y + (&sjv_childsize)->h;
#line 72
                        sjt_funcold5.w = (&sjv_remaining)->w;
#line 72
                        sjt_funcold5.h = (&sjv_remaining)->h - (&sjv_childsize)->h;
#line 72
...
#line 75 "lib/ui/borderLayout.sj"
                            sjt_call31.x = (&sjv_remaining)->x;
#line 75
                            sjt_call31.y = ((&sjv_remaining)->y + (&sjv_remaining)->h) - (&sjv_childsize)->h;
#line 75
                            sjt_call31.w = (&sjv_remaining)->w;
#line 75
                            sjt_call31.h = (&sjv_childsize)->h;
#line 75
                            sjf_rect(&sjt_call31);
#line 75
...
#line 1
                            sjt_funcold6._refCount = 1;
#line 76 "lib/ui/borderLayout.sj"
                            sjt_funcold6.x = (&sjv_remaining)->x;
#line 76
                            sjt_funcold6.y = (&sjv_remaining)->y;
#line 76
                            sjt_funcold6.w = (&sjv_remaining)->w;
#line 76
                            sjt_funcold6.h = (&sjv_remaining)->h - (&sjv_childsize)->h;
#line 76
...
;
        if (sjt_funcold4._refCount == 1) { sjf_rect_destroy(&sjt_funcold4); }
;
...
#line 82 "lib/ui/borderLayout.sj"
...
#line 85
            sjt_capture15.isvalid = true;
#line 85
            sjt_capture15.value = sjt_value6;
        } else {
#line 85 "lib/ui/borderLayout.sj"
...
#line 87 "lib/ui/borderLayout.sj"
...
#line 53 "lib/ui/centerLayout.sj"
...
void sjf_centerlayout_getrect(sjs_centerlayout* _parent, sjs_rect* _return) {
    _return->_refCount = 1;
#line 18 "lib/ui/centerLayout.sj"
    sjf_rect_copy(_return, &_parent->_rect);
}
...
#line 11 "lib/ui/centerLayout.sj"
...
#line 12 "lib/ui/size.sj"
        sjf_size_copy(&sjt_funcold11, &sjv_size);
#line 12
        sjt_parent159 = &sjv_size;
#line 2 "lib/ui/element.sj"
        sjt_parent160 = sjv_child;
#line 13 "lib/ui/centerLayout.sj"
...
#line 13
        sjf_size_max(sjt_parent159, sjt_functionParam239, &sjt_funcold11);
#line 13
        if (sjv_size._refCount == 1) { sjf_size_destroy(&sjv_size); }
;
#line 12 "lib/ui/size.sj"
        sjf_size_copy(&sjv_size, &sjt_funcold11);
#line 11 "lib/ui/centerLayout.sj"
        i++;
...
;
        if (sjt_funcold11._refCount == 1) { sjf_size_destroy(&sjt_funcold11); }
;
    }

#line 19 "lib/ui/size.sj"
    sjt_parent161 = &sjv_size;
#line 15 "lib/ui/centerLayout.sj"
...
#line 12 "lib/ui/size.sj"
        sjf_size_copy(&sjt_funcold12, &sjv_size);
#line 12
...
#line 13
        sjf_size_max(sjt_parent164, sjt_functionParam243, &sjt_funcold12);
#line 13
        if (sjv_size._refCount == 1) { sjf_size_destroy(&sjv_size); }
;
#line 12 "lib/ui/size.sj"
        sjf_size_copy(&sjv_size, &sjt_funcold12);
#line 11 "lib/ui/centerLayout.sj"
        i++;
...
;
        if (sjt_funcold12._refCount == 1) { sjf_size_destroy(&sjt_funcold12); }
;
    }
...
#line 47 "lib/ui/centerLayout.sj"
    sjt_forStart22 = 0;
#line 47
...
#line 46 "lib/ui/centerLayout.sj"
...
void sjf_centerlayout_setrect(sjs_centerlayout* _parent, sjs_rect* rect_) {
    ...
    if (_parent->_rect._refCount == 1) { sjf_rect_destroy(&_parent->_rect); }
;
#line 20 "lib/ui/centerLayout.sj"
    sjf_rect_copy(&_parent->_rect, rect_);
#line 7 "lib/ui/rect.sj"
    sjt_parent167 = &_parent->_rect;
#line 22 "lib/ui/centerLayout.sj"
...
#line 23 "lib/ui/centerLayout.sj"
...
#line 25 "lib/ui/centerLayout.sj"
        sjt_call87.w = (&sjv_innerrect)->w;
#line 25
        sjt_call87.h = (&sjv_innerrect)->h;
#line 25
        sjf_size(&sjt_call87);
#line 25
...
#line 29 "lib/ui/centerLayout.sj"
...
#line 36 "lib/ui/centerLayout.sj"
...
#line 41 "lib/ui/centerLayout.sj"
        sjt_call88.x = sjv_x;
#line 41
        sjt_call88.y = sjv_y;
#line 41
...
#line 31 "lib/ui/flowLayout.sj"
            sjt_call56.w = (&sjv_innerrect)->w;
#line 31
...
#line 6 "lib/common/i32.sj"
            sjt_funcold7 = sjv_valmax;
#line 32 "lib/ui/flowLayout.sj"
            sjt_functionParam165 = sjv_valmax;
#line 32
            sjt_functionParam166 = (&sjv_childsize)->w;
#line 32
            sjf_i32_max(sjt_functionParam165, sjt_functionParam166, &sjt_funcold7);
#line 6 "lib/common/i32.sj"
            sjv_valmax = sjt_funcold7;
            if ((sjv_val1 + (&sjv_childsize)->h) > (&sjv_innerrect)->h) {
#line 34 "lib/ui/flowLayout.sj"
                sjv_val1 = 0;
#line 35
...
#line 39 "lib/ui/flowLayout.sj"
            sjt_call57.x = (&sjv_innerrect)->x + sjv_val2;
#line 39
            sjt_call57.y = (&sjv_innerrect)->y + sjv_val1;
#line 39
            sjt_call57.w = (&sjv_childsize)->w;
#line 39
            sjt_call57.h = (&sjv_childsize)->h;
#line 39
            sjf_rect(&sjt_call57);
#line 39
...
#line 6 "lib/common/i32.sj"
                sjt_funcold8 = sjv_valmax;
#line 44 "lib/ui/flowLayout.sj"
                sjt_functionParam167 = sjv_valmax;
#line 44
                sjt_functionParam168 = (&sjv_childsize)->w;
#line 44
                sjf_i32_max(sjt_functionParam167, sjt_functionParam168, &sjt_funcold8);
#line 6 "lib/common/i32.sj"
                sjv_valmax = sjt_funcold8;
                if ((sjv_val1 + (&sjv_childsize)->h) >= (&sjv_innerrect)->h) {
#line 46 "lib/ui/flowLayout.sj"
                    sjv_val1 = 0;
#line 47
                    sjv_val2 = sjv_val2 + sjv_valmax;
#line 48
...
#line 51 "lib/ui/flowLayout.sj"
                sjt_call59.x = (&sjv_innerrect)->x + sjv_val2;
#line 51
                sjt_call59.y = (((&sjv_innerrect)->y + (&sjv_innerrect)->h) - sjv_val1) - (&sjv_childsize)->h;
#line 51
...
#line 63 "lib/ui/flowLayout.sj"
                    sjt_call61.x = (&sjv_innerrect)->x + sjv_val1;
#line 63
                    sjt_call61.y = (&sjv_innerrect)->y + sjv_val2;
#line 63
...
#line 68 "lib/ui/flowLayout.sj"
                        sjt_functionParam171 = sjv_valmax;
#line 68
                        sjt_functionParam172 = (&sjv_childsize)->h;
#line 68
                        sjf_i32_max(sjt_functionParam171, sjt_functionParam172, &sjt_funcold10);
#line 6 "lib/common/i32.sj"
                        sjv_valmax = sjt_funcold10;
                        if ((sjv_val1 + (&sjv_childsize)->w) > (&sjv_innerrect)->w) {
#line 70 "lib/ui/flowLayout.sj"
                            sjv_val1 = 0;
#line 71
                            sjv_val2 = sjv_val2 + sjv_valmax;
#line 72
...
#line 75 "lib/ui/flowLayout.sj"
                        sjt_call63.x = (((&sjv_innerrect)->x + (&sjv_innerrect)->w) - sjv_val1) - (&sjv_childsize)->w;
#line 75
...
#line 135 "lib/ui/gl.sj"
    sjt_functionParam303 = sjt_capture20 - 1;
#line 135
    sjf_list_rect_getat(sjt_parent211, sjt_functionParam303, &sjt_call98);
#line 135
    sjt_parent208 = &sjt_call98;
#line 135
    sjt_functionParam304 = &sjv_oldrect;
#line 135
    sjf_rect_isequal(sjt_parent208, sjt_functionParam304, &sjt_capture21);
#line 135
...
#line 138 "lib/ui/gl.sj"
    sjt_functionParam306 = sjt_capture22 - 1;
#line 138
...
#line 139 "lib/ui/gl.sj"
        sjt_functionParam307 = sjt_capture24 - 1;
#line 139
        sjf_list_rect_getat(sjt_parent217, sjt_functionParam307, &sjv_newrect);
    } else {
...
void sjf_list_rect_add(sjs_list_rect* _parent, sjs_rect* item) {
    sjs_array_rect sjt_funcold18 = { -1 };
...
#line 134 "lib/common/array.sj"
        sjf_array_rect_copy(&sjt_funcold18, &_parent->array);
#line 134
...
#line 46
        sjf_array_rect_grow(sjt_parent201, sjt_functionParam292, &sjt_funcold18);
#line 46
        if (_parent->array._refCount == 1) { sjf_array_rect_destroy(&_parent->array); }
;
#line 134 "lib/common/array.sj"
        sjf_array_rect_copy(&_parent->array, &sjt_funcold18);
    }
...
#line 44
    ...
    if (sjt_funcold18._refCount == 1) { sjf_array_rect_destroy(&sjt_funcold18); }
;
}
...
#line 29 "lib/ui/listLayout.sj"
            sjt_call43.w = (&sjv_innerrect)->w;
#line 29
            sjt_call43.h = (&sjv_innerrect)->h - sjv_val;
#line 29
            sjf_size(&sjt_call43);
#line 29
...
#line 30 "lib/ui/listLayout.sj"
            sjt_call44.x = (&sjv_innerrect)->x;
#line 30
            sjt_call44.y = (&sjv_innerrect)->y + sjv_val;
#line 30
            sjt_call44.w = (&sjv_innerrect)->w;
#line 30
            sjt_call44.h = (&sjv_childsize)->h;
#line 30
            sjf_rect(&sjt_call44);
#line 30
...
#line 35 "lib/ui/listLayout.sj"
                sjt_call46.x = (&sjv_innerrect)->x;
#line 35
                sjt_call46.y = (((&sjv_innerrect)->y + (&sjv_innerrect)->h) - sjv_val) - (&sjv_childsize)->h;
#line 35
...
#line 39 "lib/ui/listLayout.sj"
                    sjt_call47.w = (&sjv_innerrect)->w - sjv_val;
#line 39
                    sjt_call47.h = (&sjv_innerrect)->h;
#line 39
                    sjf_size(&sjt_call47);
#line 39
...
#line 40 "lib/ui/listLayout.sj"
                    sjt_call48.x = (&sjv_innerrect)->x + sjv_val;
#line 40
                    sjt_call48.y = (&sjv_innerrect)->y;
#line 40
                    sjt_call48.w = (&sjv_childsize)->w;
#line 40
                    sjt_call48.h = (&sjv_innerrect)->h;
#line 40
                    sjf_rect(&sjt_call48);
#line 40
...
#line 45 "lib/ui/listLayout.sj"
                        sjt_call50.x = (((&sjv_innerrect)->x + (&sjv_innerrect)->w) - sjv_val) - (&sjv_childsize)->w;
#line 45
...
#line 80
                sjt_call100.point.x = sjv_mouse_x;
#line 80
                sjt_call100.point.y = sjv_mouse_y;
#line 80
                sjf_point(&sjt_call100.point);
#line 81
                sjt_call100.iscaptured = true;
#line 78
                sjt_call100.isleftdown = sjv_mouse_isleftdown;
#line 78
...
#line 88
                sjt_call101.point.x = sjv_mouse_x;
#line 88
                sjt_call101.point.y = sjv_mouse_y;
#line 88
                sjf_point(&sjt_call101.point);
#line 89
                sjt_call101.iscaptured = false;
#line 86
                sjt_call101.isleftdown = sjv_mouse_isleftdown;
#line 86
...
#line 170 "lib/ui/mat4.sj"
        sjf_mat4_copy(&sjt_funcold14, &_parent->projection);
...
#line 30
        sjf_mat4_orthographic(sjt_functionParam282, sjt_functionParam283, sjt_functionParam284, sjt_functionParam285, sjt_functionParam286, sjt_functionParam287, &sjt_funcold14);
#line 30
        if (_parent->projection._refCount == 1) { sjf_mat4_destroy(&_parent->projection); }
;
#line 170 "lib/ui/mat4.sj"
        sjf_mat4_copy(&_parent->projection, &sjt_funcold14);
#line 170
        sjt_funcold15._refCount = 1;
#line 213
        sjf_mat4_copy(&sjt_funcold15, &_parent->model);
...
#line 31
        sjf_mat4_scale(sjt_functionParam288, sjt_functionParam289, sjt_functionParam290, &sjt_funcold15);
#line 31
        if (_parent->model._refCount == 1) { sjf_mat4_destroy(&_parent->model); }
;
#line 213 "lib/ui/mat4.sj"
        sjf_mat4_copy(&_parent->model, &sjt_funcold15);
#line 213
        sjt_funcold16._refCount = 1;
#line 124
        sjf_mat4_copy(&sjt_funcold16, &_parent->view);
#line 124
        sjf_mat4_identity(&sjt_funcold16);
#line 124
        if (_parent->view._refCount == 1) { sjf_mat4_destroy(&_parent->view); }
;
#line 124
        sjf_mat4_copy(&_parent->view, &sjt_funcold16);
    }

    if (sjt_funcold14._refCount == 1) { sjf_mat4_destroy(&sjt_funcold14); }
;
    if (sjt_funcold15._refCount == 1) { sjf_mat4_destroy(&sjt_funcold15); }
;
...
#line 9
    sjt_funcold17.y = 0;
#line 9
    sjt_funcold17.w = (&_parent->_size)->w;
#line 9
    sjt_funcold17.h = (&_parent->_size)->h;
#line 9
    sjf_rect(&sjt_funcold17);
#line 9
    if (_parent->windowrect._refCount == 1) { sjf_rect_destroy(&_parent->windowrect); }
;
#line 1 "lib/ui/rect.sj"
    sjf_rect_copy(&_parent->windowrect, &sjt_funcold17);
...
#line 14
    ...
    if (sjt_funcold17._refCount == 1) { sjf_rect_destroy(&sjt_funcold17); }
;
}
...
void sjf_string_nullterminate(sjs_string* _parent) {
    bool result4;
    bool result5;
    sjs_array_char sjt_funcold13 = { -1 };
...
#line 134 "lib/common/array.sj"
            sjf_array_char_copy(&sjt_funcold13, &_parent->data);
#line 134
            sjt_parent187 = &_parent->data;
#line 75 "lib/common/string.sj"
            sjt_functionParam266 = _parent->count + 1;
#line 75
            sjf_array_char_grow(sjt_parent187, sjt_functionParam266, &sjt_funcold13);
#line 75
            if (_parent->data._refCount == 1) { sjf_array_char_destroy(&_parent->data); }
;
#line 134 "lib/common/array.sj"
            sjf_array_char_copy(&_parent->data, &sjt_funcold13);
        }
...
#line 78
    ...
    if (sjt_funcold13._refCount == 1) { sjf_array_char_destroy(&sjt_funcold13); }
;
}
...
#line 39
    sjt_call22.amount = 1;
#line 39
    sjt_call22.unittype = sjv_gridunittype_star;
#line 39
...
#line 40
    sjt_call23.unittype = sjv_gridunittype_fixed;
#line 40
...
#line 35
    sjt_call24.unittype = sjv_gridunittype_fixed;
#line 35
...
#line 36
    sjt_call25.amount = 1;
#line 36
    sjt_call25.unittype = sjv_gridunittype_star;
#line 36
...
#line 23
    sjt_call90.amount = 1;
#line 23
    sjt_call90.unittype = sjv_gridunittype_star;
#line 23
...
#line 24
    sjt_call91.amount = 1;
#line 24
    sjt_call91.unittype = sjv_gridunittype_star;
#line 24
