...
int32_t sjt_cast2;
sjs_crossHairsElement_heap* sjt_cast20;
...
sji_element* sjt_functionParam366;
...
void sjf_crossHairsElement_fireMouseEvent(sjs_crossHairsElement* _parent, sjs_point* point, int32_t eventId) {
    sjs_rect* sjt_dot290;
    sjs_point* sjt_functionParam370;
    bool sjt_ifElse13;

    sjt_dot290 = &(_parent)->_rect;
    sjt_functionParam370 = point;
    sjf_rect_containsPoint(sjt_dot290, sjt_functionParam370, &sjt_ifElse13);
    if (sjt_ifElse13) {
...
void sjf_crossHairsElement_render(sjs_crossHairsElement* _parent, sjs_scene2d* scene) {
    ...
    if (sjt_ifElse11) {
        ...
        sjs_scene2d* sjt_functionParam368;
        ...
        sjt_functionParam368 = scene;
        sjf_boxRenderer_render(sjt_dot288, sjt_functionParam368);
    ...
    if (sjt_ifElse12) {
        ...
        sjs_scene2d* sjt_functionParam369;
        ...
        sjt_functionParam369 = scene;
        sjf_boxRenderer_render(sjt_dot289, sjt_functionParam369);
...
void sjf_crossHairsElement_setRect(sjs_crossHairsElement* _parent, sjs_rect* rect_) {
    bool result5;
    sjs_rect* sjt_dot281;
    sjs_rect* sjt_functionParam367;
    bool sjt_ifElse8;
    bool sjt_not5;

    sjt_dot281 = &(_parent)->_rect;
    sjt_functionParam367 = rect_;
    sjf_rect_isEqual(sjt_dot281, sjt_functionParam367, &sjt_not5);
    result5 = !sjt_not5;
    sjt_ifElse8 = result5;
    if (sjt_ifElse8) {
...
void sjf_cubeVertexBuffer(float x0, float x1, float y0, float y1, float z0, float z1, float s0, float s1, float t0, float t1, sjs_vertexBuffer_vertex_location_texture_normal* _return) {
    ...
    sjs_vertex_location_texture_normal* sjt_functionParam192;
    ...
    sjt_functionParam188 = &sjt_call13;
    sjf_array_vertex_location_texture_normal_initAt(&_return->vertices, sjt_functionParam187, sjt_functionParam188);
    ...
    sjt_functionParam190 = &sjt_call14;
    sjf_array_vertex_location_texture_normal_initAt(&_return->vertices, sjt_functionParam189, sjt_functionParam190);
    sjt_functionParam191 = 2;
    ...
    sjt_functionParam192 = &sjt_call15;
    sjf_array_vertex_location_texture_normal_initAt(&_return->vertices, sjt_functionParam191, sjt_functionParam192);
    sjt_functionParam193 = 3;
...
void sjf_cubeVertexBuffer_heap(float x0, float x1, float y0, float y1, float z0, float z1, float s0, float s1, float t0, float t1, sjs_vertexBuffer_vertex_location_texture_normal_heap** _return) {
    ...
    sjs_vertex_location_texture_normal* sjt_functionParam308;
    int32_t sjt_functionParam309;
    sjs_vertex_location_texture_normal* sjt_functionParam310;
    int32_t sjt_functionParam311;
    sjs_vertex_location_texture_normal* sjt_functionParam312;
    ...
    sjt_functionParam308 = &sjt_call37;
    sjf_array_vertex_location_texture_normal_initAt(&(*_return)->vertices, sjt_functionParam307, sjt_functionParam308);
    ...
    sjt_functionParam310 = &sjt_call38;
    sjf_array_vertex_location_texture_normal_initAt(&(*_return)->vertices, sjt_functionParam309, sjt_functionParam310);
    sjt_functionParam311 = 2;
    ...
    sjt_functionParam312 = &sjt_call39;
    sjf_array_vertex_location_texture_normal_initAt(&(*_return)->vertices, sjt_functionParam311, sjt_functionParam312);
    sjt_functionParam313 = 3;
...
void sjf_mainLoop(void) {
    ...
    sjs_windowRenderer* sjt_dot296;
    sjs_scene2d* sjt_dot297;
    sjs_scene2d* sjt_dot298;
    sjs_size* sjt_dot299;
    sjs_size* sjt_dot300;
    sji_element* sjt_dot301;
    sji_element* sjt_dot302;
    sjs_windowRenderer* sjt_dot303;
    sjs_size* sjt_functionParam371;
    bool sjt_ifElse15;
    ...
    sjt_dot296 = &sjv_rootWindowRenderer;
    sjf_windowRenderer_getSize(sjt_dot296, &sjv_size);
    sjt_dot297 = &sjv_rootScene;
    sjt_functionParam371 = &sjv_size;
    sjf_scene2d_setSize(sjt_dot297, sjt_functionParam371);
    sjt_dot298 = &sjv_rootScene;
    sjf_scene2d_clear(sjt_dot298);
    sjv_rect.x = 0;
    sjv_rect.y = 0;
    sjt_dot299 = &sjv_size;
    sjv_rect.w = (sjt_dot299)->w;
    sjt_dot300 = &sjv_size;
    sjv_rect.h = (sjt_dot300)->h;
    sjf_rect(&sjv_rect);
    sjt_dot301 = sjv_root;
    sjt_interfaceParam10 = &sjv_rect;
    sjt_dot301->setRect((void*)(((char*)sjt_dot301->_parent) + sizeof(intptr_t)), sjt_interfaceParam10);
    sjt_dot302 = sjv_root;
    sjt_interfaceParam11 = &sjv_rootScene;
    sjt_dot302->render((void*)(((char*)sjt_dot302->_parent) + sizeof(intptr_t)), sjt_interfaceParam11);
    sjt_dot303 = &sjv_rootWindowRenderer;
    sjf_windowRenderer_present(sjt_dot303);
    sjv_mouseEvent = -1;
    sjv_x = 0;
    sjv_y = 0;
    SDL_Event e;
    ...
    if (sjt_ifElse15) {
        ...
        sjt_dot304->fireMouseEvent((void*)(((char*)sjt_dot304->_parent) + sizeof(intptr_t)), sjt_interfaceParam12, sjt_interfaceParam13);
...
int main(int argc, char** argv) {
    ...
    sjt_functionParam355 = -1.0f;
    sjt_functionParam356 = 1.0f;
    sjt_functionParam357 = -1.0f;
    sjt_functionParam358 = 1.0f;
    ...
    sjf_cubeVertexBuffer(sjt_functionParam355, sjt_functionParam356, sjt_functionParam357, sjt_functionParam358, sjt_functionParam359, sjt_functionParam360, sjt_functionParam361, sjt_functionParam362, sjt_functionParam363, sjt_functionParam364, &sjt_cast3->_cube);
    ...
    sjt_cast20 = (sjs_crossHairsElement_heap*)malloc(sizeof(sjs_crossHairsElement_heap));
    sjt_cast20->_refCount = 1;
    sjt_dot295 = &sjv_colors;
    sjf_anon7_red(sjt_dot295, &sjt_cast20->color);
    sjt_cast20->_rect.x = 0;
    sjt_cast20->_rect.y = 0;
    sjt_cast20->_rect.w = 0;
    sjt_cast20->_rect.h = 0;
    sjf_rect(&sjt_cast20->_rect);
    sjt_cast20->_topDownRenderer = 0;
    if (sjt_cast20->_topDownRenderer != 0) {
        sjt_cast20->_topDownRenderer->_refCount++;
    }

    sjt_cast20->_leftRightRenderer = 0;
    if (sjt_cast20->_leftRightRenderer != 0) {
        sjt_cast20->_leftRightRenderer->_refCount++;
    }

    sjt_cast20->_point.x = 0;
    sjt_cast20->_point.y = 0;
    sjf_point(&sjt_cast20->_point);
    sjf_crossHairsElement_heap(sjt_cast20);
    sjt_functionParam366 = (sji_element*)sjf_crossHairsElement_heap_as_sji_element(sjt_cast20);
    sjf_array_heap_element_initAt(&sjt_cast1->children, sjt_functionParam365, sjt_functionParam366);
    sjt_cast1->_rect.x = 0;
    sjt_cast1->_rect.y = 0;
    sjt_cast1->_rect.w = 0;
    sjt_cast1->_rect.h = 0;
...
void main_destroy() {
    ...
    if (sjt_cast20->_refCount <= 0) {
        sjf_crossHairsElement_destroy((sjs_crossHairsElement*)(((char*)sjt_cast20) + sizeof(intptr_t)));
    }
    sjt_cast3->_refCount--;
    ...
    sjt_functionParam366->_refCount--;
    if (sjt_functionParam366->_refCount <= 0) {
        sji_element_destroy(sjt_functionParam366);
    }
