...
#define sjs_hash_i32i32_typeId 27
...
#line 3
    sjf_hash_i32i32_setat(sjt_parent4, sjt_functionParam4, sjt_functionParam5);
#line 21 "lib/sj-lib-common/hash.sj"
    sjt_parent5 = &g_a;
#line 4 "hash1.sj"
    sjt_functionParam6 = 1;
#line 4
    sjf_hash_i32i32_getat(sjt_parent5, sjt_functionParam6, &g_b);
    if (g_b.isvalid) {
