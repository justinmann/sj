...
#define sjs_namespace1_class_typeId 4
#define sji_namespace1_foo_vtbl_typeId 5
#define sji_namespace1_foo_typeId 6
#define sjs_namespace2_class_typeId 7
#define sji_namespace2_foo_vtbl_typeId 8
#define sji_namespace2_foo_typeId 9
