...
#line 3 "option2.sj"
        sjt_capture5 = c;
#line 4
        sjt_value5 = sjt_capture5->x;
#line 4
        sjt_capture4.isvalid = true;
#line 4
        sjt_capture4.value = sjt_value5;
    } else {
#line 4 "option2.sj"
...
#line 3 "option2.sj"
            sjt_capture6 = c;
#line 4
            sjt_value6 = sjt_capture6->x;
#line 4
            sjt_getValue2.isvalid = true;
#line 4
            sjt_getValue2.value = sjt_value6;
        } else {
#line 4 "option2.sj"
...
#line 7
    sjs_class* copyoption14 = &sjt_value2;
    if (copyoption14 != 0) {
        g_c._refCount = 1;
#line 7 "option2.sj"
        sjf_class_copy(&g_c, copyoption14);
    } else {
        g_c._refCount = -1;
    }
...
#line 2 "option2.sj"
        sjt_capture2 = (g_c._refCount != -1 ? &g_c : 0);
#line 8
        sjt_value3 = sjt_capture2->x;
#line 8
        sjt_capture1.isvalid = true;
#line 8
        sjt_capture1.value = sjt_value3;
    } else {
#line 8 "option2.sj"
...
#line 2 "option2.sj"
            sjt_capture3 = (g_c._refCount != -1 ? &g_c : 0);
#line 8
            sjt_value4 = sjt_capture3->x;
#line 8
            sjt_getValue1.isvalid = true;
#line 8
            sjt_getValue1.value = sjt_value4;
        } else {
#line 8 "option2.sj"
...
#line 8 "option2.sj"
    ...
    if ((g_c._refCount != -1 ? &g_c : 0) != 0) {
#line 9 "option2.sj"
        sjs_class* copyoption15 = (g_c._refCount != -1 ? &g_c : 0);
        if (copyoption15 != 0) {
            g_e._refCount = 1;
#line 9 "option2.sj"
            sjf_class_copy(&g_e, copyoption15);
        } else {
            g_e._refCount = -1;
        }
    } else {
...
#line 10
    sjt_functionParam1 = (g_c._refCount != -1 ? &g_c : 0);
#line 10
...
;
    if (g_e._refCount == 1) { sjf_class_destroy(&g_e); }
;
