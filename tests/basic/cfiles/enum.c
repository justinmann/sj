...
sjs_array sjg_string1 = { 1, 1, 1, "a"};
sjs_array sjg_string2 = { 1, 1, 1, "b"};
sjs_array sjg_string3 = { 1, 1, 1, "c"};
sjs_array sjg_string4 = { 1, 0, 0, ""};
...
#line 20
        sjf_bar_asstring(sjt_functionParam4, &sjt_value3);
#line 20
...
#line 22 "enum.sj"
    sjt_functionParam5 = (g_c._refCount != -1 ? &g_c : 0);
#line 22
