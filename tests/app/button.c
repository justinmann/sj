...
void sjf_mainloop(void) {
    ...
    sjf_anon1_nextframe(sjt_parent96, sjt_functionParam166);
...
int main(int argc, char** argv) {
    ...
    sjf_anon2_getfont_heap(sjt_parent83, &sjt_call32->font);
