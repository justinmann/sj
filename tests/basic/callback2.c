...
#define sjs_sum_heap_typeId 5
#define sjs_class_i32_typeId 6
#define sjs_class_i32_heap_typeId 7
#define cb_i32_void_typeId 8
#define cb_i32_void_heap_typeId 9
