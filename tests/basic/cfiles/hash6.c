...
#define sjs_hash_weak_class_i32_typeId 27
...
#line 257
        kh_destroy(weak_class_i32_hash_type, (khash_t(weak_class_i32_hash_type)*)_this->_hash);
#line 258
    }
}
...
#if false
#line 54
k = kh_put(weak_class_i32_hash_type, p, *key, &ret);
#line 55
#else
#line 56
k = kh_put(weak_class_i32_hash_type, p, key, &ret);
...
#line 38 "lib/sj-lib-common/hash.sj"
    sjt_parent3 = &g_a;
#line 11 "hash6.sj"
    sjt_functionParam4 = g_c;
#line 11
    delete_cb weakptrcb5 = { &sjt_functionParam4, weakptr_clear };
#line 11
    if (sjt_functionParam4 != 0) { weakptr_cb_add(sjt_functionParam4, weakptrcb5); }
#line 11
    sjt_functionParam5 = 1;
#line 11
    sjf_hash_weak_class_i32_setat(sjt_parent3, sjt_functionParam4, sjt_functionParam5);
#line 21 "lib/sj-lib-common/hash.sj"
    sjt_parent4 = &g_a;
#line 12 "hash6.sj"
    sjt_functionParam8 = g_c;
#line 12
...
#line 12
    sjf_hash_weak_class_i32_getat(sjt_parent4, sjt_functionParam8, &sjt_capture2);
...
#line 12
        sjf_hash_weak_class_i32_getat(sjt_parent5, sjt_functionParam9, &sjt_getValue1);
#line 12
...
#line 14
    sjf_hash_weak_class_i32_getat(sjt_parent6, sjt_functionParam13, &sjt_capture3);
...
#line 14
        sjf_hash_weak_class_i32_getat(sjt_parent7, sjt_functionParam14, &sjt_getValue2);
#line 14
...
void main_destroy() {
    ...
    delete_cb weakptrcb12 = { &sjt_functionParam13, weakptr_clear };
    if (sjt_functionParam13 != 0) { weakptr_cb_remove(sjt_functionParam13, weakptrcb12); }
    delete_cb weakptrcb13 = { &sjt_functionParam4, weakptr_clear };
    if (sjt_functionParam4 != 0) { weakptr_cb_remove(sjt_functionParam4, weakptrcb13); }
    ...
    if (g_a._refCount == 1) { sjf_hash_weak_class_i32_destroy(&g_a); }
;
