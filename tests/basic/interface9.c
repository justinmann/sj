...
struct td_sji_foo {
    ...
    void (*test)(sjs_object* _parent, int32_t , sjs_bar* _return);
    void (*test_heap)(sjs_object* _parent, int32_t , sjs_bar_heap** _return);
};
...
void sjf_bar_heap(sjs_bar_heap** _return);
...
sji_foo* sjf_class_heap_as_sji_foo(sjs_class_heap* _this) {
    ...
    _interface->test = (void(*)(sjs_object*,int32_t, sjs_bar*))sjf_class_test;
    _interface->test_heap = (void(*)(sjs_object*,int32_t, sjs_bar_heap**))sjf_class_test_heap;
...
int main() {
    ...
    sjt_dot1->test_heap(sjt_dot1->_parent, sjt_interfaceParam1, &c);
