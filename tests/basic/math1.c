...
int main(int argc, char** argv) {
    ...
    sjt_math3 = 4;
    sjt_math4 = 5;
    sjv_a = sjt_math3 + sjt_math4;
    sjt_math5 = (uint32_t)4u;
    sjt_math6 = (uint32_t)5u;
    sjv_b = sjt_math5 + sjt_math6;
    sjt_math7 = 4ull;
    sjt_math8 = 5ull;
    sjv_c = sjt_math7 + sjt_math8;
    sjt_math9 = 4ll;
    sjt_math10 = 5ll;
    sjv_d = sjt_math9 + sjt_math10;
    sjt_math11 = 4.0f;
    sjt_math12 = 5.0f;
    sjv_e = sjt_math11 + sjt_math12;
    sjt_math13 = 4.0;
    sjt_math14 = 5.0;
    sjv_f = sjt_math13 + sjt_math14;
    main_destroy();
    #ifdef _DEBUG
    printf("\npress return to end\n");
    getchar();
